package package_21
{
   ...
   public class class_977 extends GridItemRenderer
   {
      ...
      public function class_977()
      {
         super();
         mx_internal::_document = this;
         this.clipAndEnableScrolling = true;
         this.percentWidth = 100;
         this.mxmlContent = [this.method_841()];
         this.addEventListener("creationComplete",this.method_5073);
      }
      ...
      protected function get vo() : class_787
      {
         return data as class_787;
      }
      ...
      private function method_841() : VGroup
      {
         ...
         _loc1_.mxmlContent = [this.method_3644()];
      ...
      private function method_3644() : MultilineMxLabel
      {
      ...
      public function method_5073(param1:FlexEvent) : void
      {
