package package_310
{
   ...
   public class class_2247 extends class_1780
   {
      ...
      public function class_2247(param1:class_2116, param2:Boolean = false)
      {
         super();
      ...
      public function set method_5253(param1:Boolean) : void
      {
         if(this.var_1769 == param1)
         {
            return;
         }
      ...
      override arcane function getFragmentCode(param1:class_2252, param2:class_2237, param3:class_2251) : String
      {
         ...
         var _loc6_:class_2251 = !!this.var_1769 ? var_1283.var_1121 : var_1283.var_443;
         param1.var_2852 = _loc4_.index;
         return getTex2DSampleCode(param1,_loc5_,_loc4_,this._texture,_loc6_) + "mul " + param3 + ", " + param3 + ", " + _loc5_ + ".x\n";
      }
   }
}
