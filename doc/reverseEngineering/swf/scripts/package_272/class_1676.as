package package_272
{
   ...
   public class class_1676 implements class_320
   {
      ...
      public function method_2367(param1:XML) : void
      {
         ...
         {
            _loc3_ = _loc10_.attribute(const_2501) || false;
            ...
            for each(_loc15_ in _loc4_)
            {
               ...
               {
                  _loc7_ = _loc15_.text();
                  class_88.method_1639(_loc3_,_loc5_,this.method_1179(_loc7_));
               }
               else
               {
                  ...
                  else
                  {
                     ...
                     for each(_loc19_ in _loc8_)
                     {
                        ...
                        _loc17_ = int(_loc16_);
                        class_88.method_1639(_loc3_,_loc5_,this.method_1179(_loc7_),_loc17_,_loc18_);
                     }
                  }
               }
            }
      ...
      private function method_1179(param1:String) : String
      {
