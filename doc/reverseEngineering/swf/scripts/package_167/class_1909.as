package package_167
{
   ...
   public class class_1909 extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function class_1909()
      {
         ...
         bindings = this.method_6068();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_settings_view_skins_DOTabButtonSkinWatcherSetupUtil");
         ...
         {
            return class_1909[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this.method_2771(),this.method_4177()];
         this.currentState = "up";
         this.addEventListener("creationComplete",this.method_2690);
         states = [new State({
            "name":"up",
      ...
      {
         class_1909._watcherSetupUtil = param1;
      }
      ...
      {
         this.btnBitmap = ResourceManager.getBitmapData("ui","button1_normal.png");
         this.scale9Graphic.scale9Grid = new Rectangle(1,0,75,25);
         this.scale9Graphic.width = this.labelDisplay.width + 20;
      }
      
      private function method_2771() : Scale9GridImage
      {
      ...
      private function method_4177() : Label
      {
      ...
      public function method_2690(param1:FlexEvent) : void
      {
         this.method_5996();
      }
      
      private function method_6068() : Array
      {
         var var_5:Array = [];
