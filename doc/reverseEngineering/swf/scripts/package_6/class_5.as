...
public class class_5 extends SparkSkin implements IBindingClient, IStateClient2 {
    ...
    public function class_5() {
        ...
        bindings = this.method_4349();
        watchers = [];
        target = this;
        if (_watcherSetupUtil == null) {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_tdm_lobbyWindow_view_skins_TeamDeathMatchLobbyWindowMatchoverviewSkinWatcherSetupUtil");
            watcherSetupUtilClass["init"](null);
        }
        _watcherSetupUtil.setup(this, function (param1: String): * {
            return target[param1];
        }, function (param1: String): * {
            return class_5[param1];
        }, bindings, watchers);
        mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
        mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
        this.minWidth = 89;
        this.minHeight = 84;
        this.mxmlContent = [this.method_5346(), this.method_6366()];
        ...
        this.method_4261();
        this.method_5494();
        this.addEventListener("preinitialize", this.method_2635);
        states = [new State({
            "name": "normal",
            "overrides": []
        }), new State({
    ...
    public static function set watcherSetupUtil(param1: IWatcherSetupUtil2): void {
        class_5._watcherSetupUtil = param1;
    }
    ...
    private function method_4387(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_30;
    ...
    private function method_4291(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_31;
        _loc1_.properties = {"outerDocument": this};
    ...
    private function method_6059(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_34;
        _loc1_.properties = {"outerDocument": this};
    ...
    private function method_5460(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_37;
        _loc1_.properties = {"outerDocument": this};
    ...
    private function method_1152(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_35;
        _loc1_.properties = {"outerDocument": this};
    ...
    private function method_186(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_32;
        _loc1_.properties = {"outerDocument": this};
    ...
    private function method_4261(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_33;
        _loc1_.properties = {"outerDocument": this};
    ...
    private function method_5494(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = class_36;
        _loc1_.properties = {"outerDocument": this};
    ...
    private function method_5346(): SkinnableContainer {
    ...
    private function method_6366(): VGroup {
        ...
        _loc1_.top = 0;
        _loc1_.bottom = 1;
        _loc1_.mxmlContent = [this.method_2163(), this.method_3719()];
        if (!_loc1_.document) {
            _loc1_.document = this;
        }
        return _loc1_;
    ...
    private function method_2163(): GridColumnHeaderGroup {
    ...
    private function method_3719(): Group {
        var _loc1_: Group = new Group();
        _loc1_.percentHeight = 100;
        _loc1_.mxmlContent = [this.method_4367(), this.method_5684()];
        if (!_loc1_.document) {
            _loc1_.document = this;
        }
        return _loc1_;
    ...
    private function method_4367(): Rect {
        var _loc1_: Rect = new Rect();
        _loc1_.left = 1;
        _loc1_.right = 1;
        _loc1_.top = 1;
        _loc1_.bottom = 1;
        _loc1_.fill = this.method_4044();
    ...
    private function method_4044(): SolidColor {
    ...
    private function method_5684(): VGroup {
        var _loc1_: VGroup = new VGroup();
        _loc1_.horizontalAlign = "justify";
        _loc1_.percentHeight = 100;
        _loc1_.percentWidth = 100;
        _loc1_.gap = -1;
        _loc1_.mxmlContent = [this.method_1218(), this.method_2103()];
        if (!_loc1_.document) {
            _loc1_.document = this;
        }
        return _loc1_;
    ...
    private function method_1218(): Line {
        var _loc1_: Line = new Line();
        _loc1_.stroke = this.method_5204();
    ...
    private function method_5204(): SolidColorStroke {
    ...
    private function method_114(): Grid {
        var _loc1_: Grid = new Grid();
        _loc1_.itemRenderer = this.method_6415();
        _loc1_.mxmlContent = [this.method_4699(), this.method_359(), this.method_4531(), this.method_4870(), this.method_3902()];
        _loc1_.id = "grid";
        if (!_loc1_.document) {
            _loc1_.document = this;
        }
    ...
    private function method_6415(): ClassFactory {
        var _loc1_: ClassFactory = new ClassFactory();
        _loc1_.generator = DefaultGridItemRenderer;
        return _loc1_;
    }

    private function method_4699(): GridLayer {
    ...
    private function method_359(): GridLayer {
        var _loc1_: GridLayer = new GridLayer();
    ...
    private function method_4531(): GridLayer {
        var _loc1_: GridLayer = new GridLayer();
    ...
    private function method_4870(): GridLayer {
        var _loc1_: GridLayer = new GridLayer();
    ...
    private function method_3902(): GridLayer {
        var _loc1_: GridLayer = new GridLayer();
    ...
    public function method_2635(param1: FlexEvent): void {
        this.method_1320();
    }

    private function method_4349(): Array {
        var _loc1_: * = [];
