...
public class class_63 extends GridItemRenderer implements IBindingClient {
    ...
    public function class_63() {
        ...
        bindings = this.method_6258();
        watchers = [];
        target = this;
        if (_watcherSetupUtil == null) {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_tdm_matchresultWindow_view_window_components_tooltip_TDMToolTipGridHeadRendererWatcherSetupUtil");
            watcherSetupUtilClass["init"](null);
        }
        _watcherSetupUtil.setup(this, function (param1: String): * {
            return target[param1];
        }, function (param1: String): * {
            return class_63[param1];
        }, bindings, watchers);
        mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
        mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
        this.clipAndEnableScrolling = true;
        this.percentWidth = 100;
        this.mxmlContent = [this.method_1646()];
        var_1 = 0;
    ...
    public static function set watcherSetupUtil(param1: IWatcherSetupUtil2): void {
        class_63._watcherSetupUtil = param1;
    }
    ...
    private function method_1646(): VGroup {
        var _loc1_: VGroup = new VGroup();
        _loc1_.height = 24;
        _loc1_.percentWidth = 100;
        _loc1_.verticalCenter = -1;
        _loc1_.mxmlContent = [this.method_4364()];
    ...
    private function method_4364(): Text {
    ...
    private function method_6258(): Array {
        var var_5: Array = [];
