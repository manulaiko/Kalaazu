...
public class ScrubBarSkin extends Skin implements IStateClient2 {
    ...
    private function _ScrubBarSkin_Group2_c(): Group {
        ...
        _loc1_.bottom = 0;
        _loc1_.minWidth = 0;
        _loc1_.mxmlContent = [this._ScrubBarSkin_Rect1_c(), this._ScrubBarSkin_Rect2_c()];
        if (!_loc1_.document) {
            _loc1_.document = this;
        }
        return _loc1_;
    ...
    private function _ScrubBarSkin_Group4_c(): Group {
        ...
        _loc1_.bottom = 0;
        _loc1_.minWidth = 0;
        _loc1_.mxmlContent = [this._ScrubBarSkin_Rect3_c(), this._ScrubBarSkin_Rect4_c()];
        if (!_loc1_.document) {
            _loc1_.document = this;
        }
        return _loc1_;
