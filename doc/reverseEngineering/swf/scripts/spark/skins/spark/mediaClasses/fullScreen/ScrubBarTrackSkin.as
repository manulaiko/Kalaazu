package spark.skins.spark.mediaClasses.fullScreen
{
   ...
   public class ScrubBarTrackSkin extends Skin implements IStateClient2
   {
      ...
      private function _ScrubBarTrackSkin_Group1_c() : Group
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.mxmlContent = [this._ScrubBarTrackSkin_Rect1_c(),this._ScrubBarTrackSkin_Rect2_c(),this._ScrubBarTrackSkin_Rect3_c(),this._ScrubBarTrackSkin_Rect4_c(),this._ScrubBarTrackSkin_Rect5_c()];
         if(!_loc1_.document)
         {
