...
public class VolumeBarTrackSkin extends SparkSkin implements IStateClient2 {
    ...
    public function VolumeBarTrackSkin() {
        ...
        this.mxmlContent = [this._VolumeBarTrackSkin_Rect1_c(), this._VolumeBarTrackSkin_Rect2_c(), this._VolumeBarTrackSkin_Rect3_c(), this._VolumeBarTrackSkin_Rect4_c()];
    ...
    private function _VolumeBarTrackSkin_Rect3_c(): Rect {
        ...
        _loc1_.left = 4;
        _loc1_.width = 1;
        _loc1_.fill = this._VolumeBarTrackSkin_SolidColor2_c();
        _loc1_.initialized(this, null);
        return _loc1_;
    }

    private function _VolumeBarTrackSkin_SolidColor2_c(): SolidColor {
        var _loc1_: SolidColor = new SolidColor();
        _loc1_.color = 10395294;
        return _loc1_;
    }

    private function _VolumeBarTrackSkin_Rect4_c(): Rect {
        var _loc1_: Rect = new Rect();
        _loc1_.left = 0;
        _loc1_.right = 0;
        _loc1_.top = 0;
        _loc1_.bottom = 0;
        _loc1_.fill = this._VolumeBarTrackSkin_SolidColor3_c();
        _loc1_.initialized(this, null);
        return _loc1_;
    }

    private function _VolumeBarTrackSkin_SolidColor3_c(): SolidColor {
        var _loc1_: SolidColor = new SolidColor();
        _loc1_.alpha = 0;
        return _loc1_;
    }
