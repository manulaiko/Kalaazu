...
public class VolumeBarSkin extends Skin implements IStateClient2 {
    ...
    public function VolumeBarSkin() {
        ...
        var _loc1_: DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._VolumeBarSkin_PopUpAnchor1_i);
        states = [new State({
            "name": "normal",
    ...
    private function _VolumeBarSkin_Rect2_c(): Rect {
        ...
        _loc1_.top = 0;
        _loc1_.bottom = 0;
        _loc1_.fill = this._VolumeBarSkin_SolidColor2_c();
        _loc1_.stroke = this._VolumeBarSkin_SolidColorStroke1_c();
        _loc1_.initialized(this, null);
        return _loc1_;
    }

    private function _VolumeBarSkin_SolidColor2_c(): SolidColor {
        var _loc1_: SolidColor = new SolidColor();
