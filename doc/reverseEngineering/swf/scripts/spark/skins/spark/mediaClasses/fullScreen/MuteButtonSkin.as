...
public class MuteButtonSkin extends Skin implements IStateClient2 {
    ...
    public function MuteButtonSkin() {
        ...
        this.mxmlContent = [this._MuteButtonSkin_Rect1_c(), this._MuteButtonSkin_Rect2_c(), this._MuteButtonSkin_Rect3_c(), this._MuteButtonSkin_Group1_i()];
        this.currentState = "up";
        this.addEventListener("creationComplete", this.___MuteButtonSkin_Skin1_creationComplete);
        states = [new State({
            "name": "up",
            "overrides": []
        }), new State({
    ...
    public function set volume(param1: Number): void {
        ...
        this._volume = param1;
        var _loc2_: Array = [this.bar1_1, this.bar1_2];
        var _loc3_: Array = [this.bar2_1, this.bar2_2];
        var _loc4_: Array = [this.bar3_1, this.bar3_2];
        var _loc5_: Array = [this.bar4_1, this.bar4_2];
    ...
    private function setAlphaTo(param1: Array, param2: Number): void {
        ...
        while (_loc3_ < param1.length) {
            param1[_loc3_].alpha = param2 * 0.75;
            _loc3_++;
        }
    }

    private function _MuteButtonSkin_Rect1_c(): Rect {
    ...
    private function _MuteButtonSkin_Rect2_c(): Rect {
        var _loc1_: Rect = new Rect();
        _loc1_.left = 1;
        _loc1_.right = 1;
        _loc1_.top = 1;
    ...
    private function _MuteButtonSkin_LinearGradientStroke1_c(): LinearGradientStroke {
        ...
        _loc1_.weight = 1;
        _loc1_.rotation = 90;
        _loc1_.entries = [this._MuteButtonSkin_GradientEntry3_c(), this._MuteButtonSkin_GradientEntry4_c()];
        return _loc1_;
    }

    private function _MuteButtonSkin_GradientEntry3_c(): GradientEntry {
        var _loc1_: GradientEntry = new GradientEntry();
    ...
    private function _MuteButtonSkin_GradientEntry4_c(): GradientEntry {
        var _loc1_: GradientEntry = new GradientEntry();
        _loc1_.color = 16777215;
        _loc1_.alpha = 0.09;
        return _loc1_;
    ...
    private function _MuteButtonSkin_Rect3_c(): Rect {
        var _loc1_: Rect = new Rect();
        _loc1_.left = 0;
        _loc1_.right = 0;
        _loc1_.top = 0;
    ...
    private function _MuteButtonSkin_Path1_c(): Path {
        ...
        _loc1_.fill = this._MuteButtonSkin_SolidColor1_c();
        _loc1_.initialized(this, null);
        return _loc1_;
    }

    private function _MuteButtonSkin_SolidColor1_c(): SolidColor {
    ...
    private function _MuteButtonSkin_LinearGradientStroke2_c(): LinearGradientStroke {
        var _loc1_: LinearGradientStroke = new LinearGradientStroke();
        _loc1_.rotation = 90;
        _loc1_.entries = [this._MuteButtonSkin_GradientEntry5_i(), this._MuteButtonSkin_GradientEntry6_i()];
        return _loc1_;
    }
    ...
    private function _MuteButtonSkin_LinearGradientStroke3_c(): LinearGradientStroke {
        var _loc1_: LinearGradientStroke = new LinearGradientStroke();
        _loc1_.rotation = 90;
        _loc1_.entries = [this._MuteButtonSkin_GradientEntry7_i(), this._MuteButtonSkin_GradientEntry8_i()];
        return _loc1_;
    }
    ...
    private function _MuteButtonSkin_LinearGradientStroke4_c(): LinearGradientStroke {
        var _loc1_: LinearGradientStroke = new LinearGradientStroke();
        _loc1_.rotation = 90;
        _loc1_.entries = [this._MuteButtonSkin_GradientEntry9_i(), this._MuteButtonSkin_GradientEntry10_i()];
        return _loc1_;
    }
    ...
    private function _MuteButtonSkin_LinearGradientStroke5_c(): LinearGradientStroke {
        var _loc1_: LinearGradientStroke = new LinearGradientStroke();
        _loc1_.rotation = 90;
        _loc1_.entries = [this._MuteButtonSkin_GradientEntry11_i(), this._MuteButtonSkin_GradientEntry12_i()];
        return _loc1_;
    }
    ...
    public function ___MuteButtonSkin_Skin1_creationComplete(param1: FlexEvent): void {
        this.init();
    }
