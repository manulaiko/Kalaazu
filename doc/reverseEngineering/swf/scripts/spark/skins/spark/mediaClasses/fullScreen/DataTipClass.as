package spark.skins.spark.mediaClasses.fullScreen
{
   ...
   public class DataTipClass extends DataRenderer implements IBindingClient
   {
      ...
      public function DataTipClass()
      {
         ...
         bindings = this._DataTipClass_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_spark_skins_spark_mediaClasses_fullScreen_DataTipClassWatcherSetupUtil");
         ...
         this.minWidth = 40;
         this.y = -34;
         this.mxmlContent = [this._DataTipClass_RectangularDropShadow1_i(),this._DataTipClass_Rect1_c(),this._DataTipClass_Label1_i()];
         var_1 = 0;
      ...
      {
         DataTipClass._watcherSetupUtil = param1;
      }
      ...
      private function _DataTipClass_RectangularDropShadow1_i() : RectangularDropShadow
      {
      ...
      private function _DataTipClass_Rect1_c() : Rect
      {
         ...
         _loc1_.right = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._DataTipClass_SolidColor1_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _DataTipClass_SolidColor1_c() : SolidColor
      {
      ...
      private function _DataTipClass_Label1_i() : Label
      {
      ...
      private function _DataTipClass_bindingsSetup() : Array
      {
         var _loc1_:* = [];
