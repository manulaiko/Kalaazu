package spark.skins.spark
{
   ...
   public class TitleWindowSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function TitleWindowSkin()
      {
         var bindings:Array;
         var watchers:Array;
         var _TitleWindowSkin_Group3_factory:DeferredInstanceFromFunction;
         var _TitleWindowSkin_Group8_factory:DeferredInstanceFromFunction;
         var var_1:uint;
         ...
         _TitleWindowSkin_Group3_factory = new DeferredInstanceFromFunction(this._TitleWindowSkin_Group3_i);
         _TitleWindowSkin_Group8_factory = new DeferredInstanceFromFunction(this._TitleWindowSkin_Group8_i);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
