   ...
   public class HScrollBar extends ScrollBarBase
   {
      ...
      override public function set viewport(param1:IViewport) : void
      {
         ...
         if(param1)
         {
            ...
            param1.addEventListener(MouseEvent.MOUSE_WHEEL,this.mx_internal::mouseWheelHandler,false,EventPriority.DEFAULT_HANDLER);
      ...
      override protected function updateSkinDisplayList() : void
      {
         ...
         {
            _loc10_ = isNaN(viewport.width) ? 0 : Number(viewport.width);
      ...
      override public function changeValueByPage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = pageSize;
            pageSize = Math.abs(viewport.getHorizontalScrollPositionDelta(param1 ? 0 : NavigationUnit.PAGE_LEFT));
         }
      ...
      override protected function animatePaging(param1:Number, param2:Number) : void
      {
         ...
         if(viewport)
         {
            _loc3_ = Math.abs(viewport.getHorizontalScrollPositionDelta(param1 > value ? 0 : NavigationUnit.PAGE_LEFT));
      ...
      override public function changeValueByStep(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = stepSize;
            stepSize = Math.abs(viewport.getHorizontalScrollPositionDelta(param1 ? 0 : NavigationUnit.LEFT));
         }
      ...
      mx_internal function mouseWheelHandler(param1:MouseEvent) : void
      {
         ...
         while(_loc8_ < _loc5_)
         {
            ...
            if(!isNaN(_loc9_))
            {
               _loc2_.horizontalScrollPosition += _loc9_;
               _loc7_ = true;
