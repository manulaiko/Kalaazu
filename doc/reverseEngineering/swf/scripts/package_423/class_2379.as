   ...
   public class class_2379 implements IDisposable
   {
      ...
      public function method_4635() : void
      {
         if(this.var_127.base.clip != null)
         {
            if(this.var_1085 == 0)
            {
               TweenLite.to(this.var_1646.clip,this.var_176.method_894,{"colorTransform":{
                  "tint":this.var_176.method_1353,
                  "tintAmount":this.var_176.tintAmount
               }});
               TweenLite.to(this.var_1646.clip,this.var_176.method_894,{"glowFilter":{
               ...
               TweenLite.to(this.var_3092.clip,this.var_176.method_894,{"colorTransform":{
                  "tint":this.var_176.method_6201,
                  "tintAmount":this.var_176.tintAmount
               }});
               TweenLite.to(this.var_3092.clip,this.var_176.method_894,{"glowFilter":{
