package package_247
{
   ...
   public class class_1903 extends SkinnableContainer implements IBindingClient
   {
      ...
      public function class_1903()
      {
         ...
         bindings = this.method_6282();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_sectorControlWindow_view_components_renderers_SectorControlLobbyWindowItemListHeaderRendererWatcherSetupUtil");
         ...
         {
            return class_1903[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.percentWidth = 100;
         this.mxmlContentFactory = new DeferredInstanceFromFunction(this.method_3064);
         this.addEventListener("creationComplete",this.method_4019);
         var_1 = 0;
      ...
      {
         class_1903._watcherSetupUtil = param1;
      }
      ...
      private function method_3064() : Array
      {
         return [this.method_3500()];
      }
      
      private function method_3500() : Label
      {
      ...
      public function method_4019(param1:FlexEvent) : void
      {
         this.creationCompleteHandler(param1);
      }
      
      private function method_6282() : Array
      {
         var var_5:Array = [];
