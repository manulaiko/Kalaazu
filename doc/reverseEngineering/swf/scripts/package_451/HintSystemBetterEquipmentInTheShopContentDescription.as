package package_451
{
   ...
   public class HintSystemBetterEquipmentInTheShopContentDescription extends class_2266 implements class_2265
   {
      
      private static const const_40:String = "HintSystemBetterEquipmentInTheShopContentDescription";
       
      
      public function HintSystemBetterEquipmentInTheShopContentDescription(param1:String)
      {
         super(param1);
      }
      ...
      override public function get content() : class_2514
      {
         ...
         if(_content == null)
         {
            ...
            _loc1_.title = class_88.getItem("gameentry_hintwindow_title_buyequipment");
            _loc1_.message = method_6274("gameentry_hintwindow_message_buyequipment");
            _loc1_.method_4859 = class_595.OPEN;
            _loc1_.method_6490 = method_2843();
            _loc2_ = new class_227("internalDock","seo_title_shop","internalDockShips");
            _loc2_.method_2070 = "ship_piranha";
