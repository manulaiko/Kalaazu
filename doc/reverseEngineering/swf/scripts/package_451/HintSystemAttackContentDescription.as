...
public class HintSystemAttackContentDescription extends class_2266 implements class_2265 {

    private static const const_40: String = "HintSystemAttackContentDescription";


    public function HintSystemAttackContentDescription(param1: String) {
        super(param1);
    }
    ...
    override public function get content(): class_2514 {
        ...
        if (_content == null) {
            ...
            _loc1_.title = class_88.getItem("gameentry_hintwindow_title_attack");
            _loc1_.message = method_6274("gameentry_hintwindow_message_attack");
