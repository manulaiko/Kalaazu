...
public class class_1696 extends class_270 {
    ...
    override protected function update(): void {
        ...
        var _loc11_: Point = new Point(Number(_loc2_.width) * Number(_scale), Number(_loc2_.height) * Number(_scale));
        if (_loc2_.name_149) {
            if (_loc2_.method_807 == class_431.const_2513) {
                _loc1_.graphics.drawRect(_loc3_.x - Math.round(_loc10_ / 2), _loc3_.y - Math.round(_loc10_ / 2), _loc11_.x + _loc10_, _loc11_.y + _loc10_);
                _loc1_.graphics.drawRect(_loc3_.x + _loc11_.x, _loc3_.y + _loc11_.y, -_loc11_.x, -_loc11_.y);
            } else {
                _loc1_.graphics.drawRect(0, 0, 1000, 1000);
                _loc1_.graphics.drawRect(_loc3_.x + _loc11_.x, _loc3_.y + _loc11_.y, -_loc11_.x, -_loc11_.y);
            }
        } else {
            _loc1_.graphics.drawRect(_loc3_.x, _loc3_.y, _loc11_.x, _loc11_.y);
        }
