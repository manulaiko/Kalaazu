package package_155
{
   ...
   public class class_998 extends Group
   {
      ...
      public function method_5378() : void
      {
         ...
         TweenLite.to(_loc2_,0,{"colorMatrixFilter":{
            "brightness":0,
            "saturation":0
         }});
      ...
      private function method_4404(param1:Event) : void
      {
         ...
         {
            TweenMax.to(this.installationProgressTimer,0,{"dropShadowFilter":{
               "blurX":2,
               "blurY":2,
               "distance":0,
               "alpha":1
            }});
            TweenMax.to(this.installationProgressTimer,0,{"glowFilter":{
               "color":0,
               "blurX":2,
               "blurY":2,
               "strength":5,
