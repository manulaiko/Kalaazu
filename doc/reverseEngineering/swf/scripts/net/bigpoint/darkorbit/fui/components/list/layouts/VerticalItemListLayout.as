package net.bigpoint.darkorbit.fui.components.list.layouts
{
   ...
   public class VerticalItemListLayout extends AbstractItemListLayout
   {
       
      
      public function VerticalItemListLayout(param1:Container = null, param2:Container = null)
      {
         super(param1,param2);
      }
      ...
      {
         var _loc1_:uint = 1 + Math.ceil(_target.getCalculatedHeight() / sigmaItemSize);
         if(false)
         {
      ...
      {
         return Math.floor(_target.getCalculatedHeight() / sigmaItemSize);
      }
      
      override public function assignItemSize(param1:Coreponent) : void
      {
         _itemSize = param1.getCalculatedHeight();
      }
      ...
      override public function set itemsContainer(param1:Container) : void
      {
         ...
         if(_itemsContainer)
         {
            _itemsContainer.autoSizeWidth = true;
         }
      }
   }
}
