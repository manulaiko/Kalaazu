package net.bigpoint.darkorbit.fui.components.buttons.button
{
   ...
   public class FadableButtonIconSkin extends ButtonIconSkin implements IButtonSkin
   {
       
      
      public function FadableButtonIconSkin()
      {
         super();
      }
      ...
      override protected function setCurrentSkinState(param1:String) : void
      {
         switch(param1)
         {
            case SkinLayerNames.NORMAL:
               ...
               this.alphaFadeStateOut(SkinLayerNames.ICON_OVER);
            ...
            case SkinLayerNames.OVER:
               ...
               this.alphaFadeStateIn(SkinLayerNames.ICON_OVER);
               hideState(SkinLayerNames.ICON_CLICKED);
               hideState(SkinLayerNames.ICON_DISABLED);
               break;
      ...
      protected function alphaFadeStateOut(param1:String) : void
      {
         ...
         if(_loc2_)
         {
            TweenLite.to(_loc2_,0.4,{"autoAlpha":0});
         }
      }
      ...
      override public function clone() : ISkin
      {
         ...
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc1_:FadableButtonIconSkin = new FadableButtonIconSkin();
