...
public class DOVScrollUpButtonSkin extends SparkSkin implements IBindingClient, IStateClient2 {

    private static var _watcherSetupUtil: IWatcherSetupUtil2;


    private var _264068138_DOVScrollUpButtonSkin_SetProperty1: SetProperty;
    ...
    public function DOVScrollUpButtonSkin() {
        var bindings: Array;
        var watchers: Array;
        var i: uint;
        ...
        bindings = this._DOVScrollUpButtonSkin_bindingsSetup();
        watchers = [];
        target = this;
        if (_watcherSetupUtil == null) {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_common_view_skins_scroller_vScroll_DOVScrollUpButtonSkinWatcherSetupUtil");
            watcherSetupUtilClass["init"](null);
        }
        _watcherSetupUtil.setup(this, function (param1: String): * {
            return target[param1];
        }, function (param1: String): * {
            return DOVScrollUpButtonSkin[param1];
        }, bindings, watchers);
        mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
        mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
        this.mxmlContent = [this._DOVScrollUpButtonSkin_Scale9GridImage1_i()];
        ...
        states = [new State({
            ...
            "name": "over",
            "overrides": [this._DOVScrollUpButtonSkin_SetProperty1 = SetProperty(new SetProperty().initializeFromObject({
        ...
        BindingManager.executeBindings(this, "_DOVScrollUpButtonSkin_SetProperty1", this._DOVScrollUpButtonSkin_SetProperty1);
        i = 0;
    ...
    public static function set watcherSetupUtil(param1: IWatcherSetupUtil2): void {
        DOVScrollUpButtonSkin._watcherSetupUtil = param1;
    }
    ...
    private function _DOVScrollUpButtonSkin_Scale9GridImage1_i(): Scale9GridImage {
    ...
    private function _DOVScrollUpButtonSkin_bindingsSetup(): Array {
        var result: Array = [];
        ...
        }, null, "_DOVScrollUpButtonSkin_SetProperty1.value");
        return result;
    }

    [Bindable(event="propertyChange")]
    public function get _DOVScrollUpButtonSkin_SetProperty1(): SetProperty {
        return this._264068138_DOVScrollUpButtonSkin_SetProperty1;
    }

    public function set _DOVScrollUpButtonSkin_SetProperty1(param1: SetProperty): void {
        var _loc2_: Object = this._264068138_DOVScrollUpButtonSkin_SetProperty1;
        if (_loc2_ !== param1) {
            this._264068138_DOVScrollUpButtonSkin_SetProperty1 = param1;
            if (this.hasEventListener("propertyChange")) {
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "_DOVScrollUpButtonSkin_SetProperty1", _loc2_, param1));
            }
        }
    }
