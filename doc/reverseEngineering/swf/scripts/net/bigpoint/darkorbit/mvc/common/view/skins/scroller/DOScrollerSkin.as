package net.bigpoint.darkorbit.mvc.common.view.skins.scroller
{
   ...
   public class DOScrollerSkin extends SparkSkin
   {
      ...
      public function DOScrollerSkin()
      {
         super();
         mx_internal::_document = this;
         this.left = 0;
         this.right = 0;
         this.mxmlContent = [this._DOScrollerSkin_VScrollBar1_i(),this._DOScrollerSkin_HScrollBar1_i()];
      }
      ...
      private function _DOScrollerSkin_VScrollBar1_i() : VScrollBar
      {
      ...
      private function _DOScrollerSkin_HScrollBar1_i() : HScrollBar
      {
