...
public class DOVScrollBarTrackSkin extends SparkSkin implements IBindingClient, IStateClient2 {
    ...
    public function DOVScrollBarTrackSkin() {
        var bindings: Array;
        var watchers: Array;
        var i: uint;
        ...
        bindings = this._DOVScrollBarTrackSkin_bindingsSetup();
        watchers = [];
        target = this;
        if (_watcherSetupUtil == null) {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_common_view_skins_scroller_vScroll_DOVScrollBarTrackSkinWatcherSetupUtil");
            watcherSetupUtilClass["init"](null);
        }
        _watcherSetupUtil.setup(this, function (param1: String): * {
            return target[param1];
        }, function (param1: String): * {
            return DOVScrollBarTrackSkin[param1];
        }, bindings, watchers);
        mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
        mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
        this.mxmlContent = [this._DOVScrollBarTrackSkin_Scale9GridImage1_i()];
    ...
    public static function set watcherSetupUtil(param1: IWatcherSetupUtil2): void {
        DOVScrollBarTrackSkin._watcherSetupUtil = param1;
    }
    ...
    private function _DOVScrollBarTrackSkin_Scale9GridImage1_i(): Scale9GridImage {
    ...
    private function _DOVScrollBarTrackSkin_bindingsSetup(): Array {
        var result: Array = [];
