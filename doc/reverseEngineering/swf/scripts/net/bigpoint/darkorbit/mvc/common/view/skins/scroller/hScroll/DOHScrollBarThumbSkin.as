...
public class DOHScrollBarThumbSkin extends SparkSkin implements IBindingClient, IStateClient2 {
    ...
    public function DOHScrollBarThumbSkin() {
        var bindings: Array;
        var watchers: Array;
        var i: uint;
        ...
        bindings = this._DOHScrollBarThumbSkin_bindingsSetup();
        watchers = [];
        target = this;
        if (_watcherSetupUtil == null) {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_common_view_skins_scroller_hScroll_DOHScrollBarThumbSkinWatcherSetupUtil");
            watcherSetupUtilClass["init"](null);
        }
        _watcherSetupUtil.setup(this, function (param1: String): * {
            return target[param1];
        }, function (param1: String): * {
            return DOHScrollBarThumbSkin[param1];
        }, bindings, watchers);
        mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
        mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
        this.mxmlContent = [this._DOHScrollBarThumbSkin_Scale9GridImage1_i()];
    ...
    public static function set watcherSetupUtil(param1: IWatcherSetupUtil2): void {
        DOHScrollBarThumbSkin._watcherSetupUtil = param1;
    }
    ...
    override protected function initializationComplete(): void {
        ...
        this.thumbImage.scale9Grid = new Rectangle(4, 10, 1, 1);
    ...
    private function _DOHScrollBarThumbSkin_Scale9GridImage1_i(): Scale9GridImage {
    ...
    private function _DOHScrollBarThumbSkin_bindingsSetup(): Array {
        var result: Array = [];
