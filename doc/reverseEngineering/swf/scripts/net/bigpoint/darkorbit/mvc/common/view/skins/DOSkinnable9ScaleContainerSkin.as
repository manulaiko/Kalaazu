package net.bigpoint.darkorbit.mvc.common.view.skins
{
   ...
   public class DOSkinnable9ScaleContainerSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function DOSkinnable9ScaleContainerSkin()
      {
         var watchers:Array;
         var i:uint;
         ...
         bindings = this._DOSkinnable9ScaleContainerSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_common_view_skins_DOSkinnable9ScaleContainerSkinWatcherSetupUtil");
         ...
         {
            return DOSkinnable9ScaleContainerSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._DOSkinnable9ScaleContainerSkin_Group1_c(),this._DOSkinnable9ScaleContainerSkin_Group2_i()];
         this.currentState = "normal";
         this.addEventListener("creationComplete",this.___DOSkinnable9ScaleContainerSkin_SparkSkin1_creationComplete);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      {
         DOSkinnable9ScaleContainerSkin._watcherSetupUtil = param1;
      }
      ...
      private function _DOSkinnable9ScaleContainerSkin_Group1_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._DOSkinnable9ScaleContainerSkin_Scale9GridImage1_i()];
         if(!_loc1_.document)
         {
      ...
      private function _DOSkinnable9ScaleContainerSkin_Scale9GridImage1_i() : Scale9GridImage
      {
      ...
      private function _DOSkinnable9ScaleContainerSkin_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.top = 5;
         _loc1_.bottom = 5;
      ...
      public function ___DOSkinnable9ScaleContainerSkin_SparkSkin1_creationComplete(param1:FlexEvent) : void
      {
         this.handleCreationComplete();
      }
      
      private function _DOSkinnable9ScaleContainerSkin_bindingsSetup() : Array
      {
         var result:Array = [];
