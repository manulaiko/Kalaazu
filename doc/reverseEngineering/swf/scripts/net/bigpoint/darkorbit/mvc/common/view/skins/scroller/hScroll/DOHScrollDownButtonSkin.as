package net.bigpoint.darkorbit.mvc.common.view.skins.scroller.hScroll
{
   ...
   public class DOHScrollDownButtonSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      private var _229069187_DOHScrollDownButtonSkin_SetProperty1:SetProperty;
      ...
      public function DOHScrollDownButtonSkin()
      {
         var bindings:Array;
         var watchers:Array;
         var i:uint;
         ...
         bindings = this._DOHScrollDownButtonSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_darkorbit_mvc_common_view_skins_scroller_hScroll_DOHScrollDownButtonSkinWatcherSetupUtil");
         ...
         {
            return DOHScrollDownButtonSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._DOHScrollDownButtonSkin_Scale9GridImage1_i()];
         ...
         states = [new State({
            ...
            "name":"over",
            "overrides":[this._DOHScrollDownButtonSkin_SetProperty1 = SetProperty(new SetProperty().initializeFromObject({
         ...
         BindingManager.executeBindings(this,"_DOHScrollDownButtonSkin_SetProperty1",this._DOHScrollDownButtonSkin_SetProperty1);
         i = 0;
      ...
      {
         DOHScrollDownButtonSkin._watcherSetupUtil = param1;
      }
      ...
      private function _DOHScrollDownButtonSkin_Scale9GridImage1_i() : Scale9GridImage
      {
      ...
      private function _DOHScrollDownButtonSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         },null,"_DOHScrollDownButtonSkin_SetProperty1.value");
         return result;
      }
      
      [Bindable(event="propertyChange")]
      public function get _DOHScrollDownButtonSkin_SetProperty1() : SetProperty
      {
         return this._229069187_DOHScrollDownButtonSkin_SetProperty1;
      }
      
      public function set _DOHScrollDownButtonSkin_SetProperty1(param1:SetProperty) : void
      {
         var _loc2_:Object = this._229069187_DOHScrollDownButtonSkin_SetProperty1;
         if(_loc2_ !== param1)
         {
            this._229069187_DOHScrollDownButtonSkin_SetProperty1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_DOHScrollDownButtonSkin_SetProperty1",_loc2_,param1));
            }
         }
      }
