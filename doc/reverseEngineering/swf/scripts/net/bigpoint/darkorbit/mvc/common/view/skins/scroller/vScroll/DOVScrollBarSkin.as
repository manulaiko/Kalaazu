...
public class DOVScrollBarSkin extends SparkSkin implements IStateClient2 {
    ...
    public function DOVScrollBarSkin() {
        super();
        mx_internal::_document = this;
        this.minWidth = 15;
        this.minHeight = 35;
        this.mxmlContent = [this._DOVScrollBarSkin_Button1_i(), this._DOVScrollBarSkin_Button2_i(), this._DOVScrollBarSkin_Button3_i(), this._DOVScrollBarSkin_Button4_i()];
    ...
    private function _DOVScrollBarSkin_Button1_i(): Button {
        var _loc1_: Button = new Button();
        _loc1_.styleName = "skinnedVScrollBarTrack";
        _loc1_.top = 13;
        _loc1_.bottom = 13;
        _loc1_.height = 54;
    ...
    private function _DOVScrollBarSkin_Button2_i(): Button {
        var _loc1_: Button = new Button();
        _loc1_.styleName = "skinnedVScrollBarThumb";
        _loc1_.focusEnabled = false;
        _loc1_.tabEnabled = false;
        _loc1_.id = "thumb";
        if (!_loc1_.document) {
    ...
    private function _DOVScrollBarSkin_Button3_i(): Button {
        var _loc1_: Button = new Button();
        _loc1_.styleName = "skinnedVScrollBarUpButton";
        _loc1_.top = -1;
        _loc1_.focusEnabled = false;
        _loc1_.tabEnabled = false;
    ...
    private function _DOVScrollBarSkin_Button4_i(): Button {
        var _loc1_: Button = new Button();
        _loc1_.styleName = "skinnedVScrollBarDownButton";
        _loc1_.bottom = -2;
        _loc1_.focusEnabled = false;
        _loc1_.tabEnabled = false;
