   ...
   public class LocaleSorter
   {
      ...
      public static function sortLocalesByPreference(param1:Array, param2:Array, param3:String = null, param4:Boolean = false) : Array
      {
         ...
         var promote:Function = function(param1:String):void
         {
            if(true)
            {
               var_5.push(appLocales[hasLocale[param1]]);
         ...
         var_2 = 0;
         while(var_2 < locales.length)
         {
            hasLocale[locales[var_2]] = var_2;
            var_2++;
         }
         var_1 = 0;
         ...
         while(var_1 < l)
         {
            plocale = LocaleID.fromString(preferenceLocales[var_1]);
            promote(preferenceLocales[var_1]);
            ...
            while(var_2 < l)
            {
               locale = preferenceLocales[var_2];
