...
public class UIDUtil {
    ...
    public static function getUID(param1: Object): String {
        ...
        if (item is IUID) {
            var_5 = IUID(item).uid;
            if (var_5 == null || var_5.length == 0) {
                var_5 = createUID();
                IUID(item).uid = var_5;
            }
        } else if (item is IPropertyChangeNotifier && !(item is IUIComponent)) {
            var_5 = IPropertyChangeNotifier(item).uid;
            if (var_5 == null || var_5.length == 0) {
                var_5 = createUID();
                IPropertyChangeNotifier(item).uid = var_5;
            }
        } else {
            if (item is String) {
            ...
            try {
                ...
                if (item is XML) {
                    ...
                    if (notificationFunction["uid"] == undefined) {
                        var_5 = notificationFunction["uid"] = createUID();
                    }
                    var_5 = notificationFunction["uid"];
                } else {
                    ...
                    if (!var_5) {
                        var_5 = createUID();
                        try {
                            item.mx_internal_uid = var_5;
                        } catch (e: Error) {
                            uidDictionary[item] = var_5;
                        }
                    }
                }
            } catch (e: Error) {
