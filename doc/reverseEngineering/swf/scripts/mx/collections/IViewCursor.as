...
public interface IViewCursor extends IEventDispatcher {
    ...
    [Bindable("cursorUpdate")] function get afterLast(): Boolean;

    [Bindable("cursorUpdate")] function get beforeFirst(): Boolean;

    [Bindable("cursorUpdate")] function get bookmark(): CursorBookmark;

    [Bindable("cursorUpdate")] function get current(): Object;
