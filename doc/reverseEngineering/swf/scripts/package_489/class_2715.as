package package_489
{
   ...
   public class class_2715 extends DefaultItemDataAssigner
   {
      ...
      {
         var _loc2_:class_2267 = param1 as class_2267;
      ...
      private function method_1108(param1:class_2267) : String
      {
      ...
      {
         var _loc1_:Container = getChildByName(class_2515.const_214) as Container;
         this.var_2058 = _loc1_.getChildByName(class_2515.const_2881) as Coreponent;
         this.var_135 = _loc1_.getChildByName(class_2515.const_2460) as Label;
         this.var_1625 = _loc1_.getChildByName(class_2515.const_601) as ProgressBar;
      }
   }
}
