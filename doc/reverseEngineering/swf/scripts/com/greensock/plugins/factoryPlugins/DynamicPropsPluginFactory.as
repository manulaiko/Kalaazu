package com.greensock.plugins.factoryPlugins
{
   import com.greensock.TweenLite;
   import com.greensock.plugins.TweenPlugin;
   
   public class DynamicPropsPluginFactory extends TweenPlugin
   {
      
      public static const API:Number = 1;
      
      private static const _lookup:Object = getMethods();
      ...
      public function DynamicPropsPluginFactory()
      {
         super();
         this.propName = "dynamicPropsFactory";
         this.overwriteProps = [];
         this._props = [];
      }
      
      private static function getMethods() : Object
      {
         var _loc1_:* = {};
         _loc1_["random"] = getRandomCount;
         return _loc1_;
      }
      
      private static function getRandomCount(param1:Number, param2:Number) : Number
      {
      ...
      override public function onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         for(_loc5_ in param2)
         {
            if(_loc5_ != "params")
            {
               this._props[this._props.length] = new DynamicProperty(this._target[_loc5_],_loc5_,_lookup[param2[_loc5_]] as Function,_loc4_[_loc5_]);
