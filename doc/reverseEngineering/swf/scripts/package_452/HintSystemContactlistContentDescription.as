package package_452
{
   ...
   public class HintSystemContactlistContentDescription extends class_2266
   {
      
      private static const const_40:String = "HintSystemContactlistContentDescription";
       
      
      public function HintSystemContactlistContentDescription(param1:String)
      {
         super(param1);
      }
      ...
      override public function get content() : class_2514
      {
         ...
         if(_content == null)
         {
            _title = "targeted_hintwindow_title_contactlist";
            _message = "targeted_hintwindow_message_contactlist";
