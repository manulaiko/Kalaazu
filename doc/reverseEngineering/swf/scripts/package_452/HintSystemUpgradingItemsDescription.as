package package_452
{
   ...
   public class HintSystemUpgradingItemsDescription extends class_2266
   {
      
      private static const const_40:String = "HintSystemUpgradingItemsDescription";
       
      
      public function HintSystemUpgradingItemsDescription(param1:String)
      {
         super(param1);
      }
      ...
      override public function get content() : class_2514
      {
         ...
         if(_content == null)
         {
            _title = "targeted_hintwindow_title_upgradingitems";
            _message = "targeted_hintwindow_message_upgradingitems";
            _content = method_3960();
            _loc1_ = new class_227("internalItemUpgradeSystem","seo_title_standard");
            _loc1_.method_2070 = "";
