package package_452
{
   ...
   public class HintSystemSecondConfigurationDescription extends class_2266
   {
      
      private static const const_40:String = "HintSystemSecondConfigurationDescription";
       
      
      public function HintSystemSecondConfigurationDescription(param1:String)
      {
         super(param1);
      }
      ...
      override public function get content() : class_2514
      {
         ...
         if(_content == null)
         {
            _title = "targeted_hintwindow_title_secondconfiguration";
            _message = "targeted_hintwindow_message_secondconfiguration";
            _content = method_3960();
            _loc1_ = new class_227("internalDock","seo_title_standard","internalDockEquipment");
            _loc1_.method_2070 = "";
