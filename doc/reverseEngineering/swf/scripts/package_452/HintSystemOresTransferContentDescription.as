...
public class HintSystemOresTransferContentDescription extends class_2266 {

    private static const const_40: String = "HintSystemOresTransferContentDescription";


    public function HintSystemOresTransferContentDescription(param1: String) {
        super(param1);
    }
    ...
    override public function get content(): class_2514 {
        var _loc1_: * = null;
        if (_content == null) {
            _title = "targeted_hintwindow_title_orestransfer";
            _message = "targeted_hintwindow_message_orestransfer";
            _content = method_3960();
            _loc1_ = new class_227("internalSkylab", "seo_title_skylab");
            _loc1_.method_2070 = "";
