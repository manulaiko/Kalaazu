package package_452
{
   ...
   public class HintSystemAuctionHouseContentDescription extends class_2266
   {
      
      private static const const_40:String = "HintSystemAuctionHouseContentDescription";
       
      
      public function HintSystemAuctionHouseContentDescription(param1:String)
      {
         super(param1);
      }
      ...
      override public function get content() : class_2514
      {
         ...
         if(_content == null)
         {
            _title = "targeted_hintwindow_title_auction_house";
            _message = "targeted_hintwindow_message_auction_house";
            _content = method_3960();
            _loc1_ = new class_227("internalAuction","seo_title_standard");
            _loc1_.method_2070 = "";
