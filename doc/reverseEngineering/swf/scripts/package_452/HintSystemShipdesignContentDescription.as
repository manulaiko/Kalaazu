...
public class HintSystemShipdesignContentDescription extends class_2266 {

    private static const const_40: String = "HintSystemShipdesignContentDescription";


    public function HintSystemShipdesignContentDescription(param1: String) {
        super(param1);
    }
    ...
    override public function get content(): class_2514 {
        var _loc1_: * = null;
        if (_content == null) {
            _title = "targeted_hintwindow_title_shipdesign";
            _message = "targeted_hintwindow_message_shipdesign";
            _content = method_3960();
            _loc1_ = new class_227("internalDock", "seo_title_shop", "internalDockShipModel");
            _loc1_.method_2070 = "";
