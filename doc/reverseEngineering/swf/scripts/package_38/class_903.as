...
public class class_903 implements ICommand {

    public static const ID: int = 17857;


    public var var_2917: Vector.<class_712>;

    public function class_903(param1: Vector.<class_712> = null) {
        super();
        if (param1 == null) {
