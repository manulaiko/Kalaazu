package package_38
{
   ...
   public class class_457 implements ICommand
   {
      
      public static const ID:int = 5503;
      ...
      public function class_457(param1:Boolean = false, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false)
      {
         super();
