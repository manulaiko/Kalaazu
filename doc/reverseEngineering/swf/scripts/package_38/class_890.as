package package_38
{
   ...
   public class class_890 implements ICommand
   {
      
      public static const ID:int = 2586;
      ...
      public function class_890(param1:int = 0, param2:int = 0, param3:Vector.<int> = null)
      {
         super();
      ...
      public function read(param1:IDataInput) : void
      {
         ...
         this.var_2632 = Number(this.var_2632) << 14 | Number(this.var_2632) >>> 18;
         var _loc2_:Number = 0;
         var _loc3_:* = 0;
      ...
      {
         var _loc2_:int = 0;
         param1.writeInt(Number(this.var_2632) >>> 14 | Number(this.var_2632) << 18);
