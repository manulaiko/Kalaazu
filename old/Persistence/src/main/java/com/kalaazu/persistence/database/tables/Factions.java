...
import com.kalaazu.persistence.database.records.FactionsRecord;
import org.jooq.*;
...
public class Factions extends TableImpl<FactionsRecord> {
     ...
     */
    public final TableField<FactionsRecord, Byte> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<FactionsRecord, String> NAME = createField(
            DSL.name("name"),
     ...
     */
    public final TableField<FactionsRecord, String> TAG = createField(
            DSL.name("tag"),
     ...
     */
    public final TableField<FactionsRecord, String> DESCRIPTION = createField(
     ...
     */
    public final TableField<FactionsRecord, Byte> IS_PUBLIC = createField(
            DSL.name("is_public"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
     ...
     */
    public final TableField<FactionsRecord, Byte> LOW_MAPS_ID = createField(
            DSL.name("low_maps_id"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false),
            this,
            ""
    );
     ...
     */
    public final TableField<FactionsRecord, Long> LOW_MAPS_POSITION = createField(
            DSL.name("low_maps_position"),
     ...
     */
    public final TableField<FactionsRecord, Byte> HIGH_MAPS_ID = createField(
            DSL.name("high_maps_id"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false),
            this,
            ""
    );
     ...
     */
    public final TableField<FactionsRecord, Long> HIGH_MAPS_POSITION = createField(
            DSL.name("high_maps_position"),
            org.jooq.impl.SQLDataType.BIGINT.nullable(false)
                                            .defaultValue(org.jooq.impl.DSL.field(
                                                    "0",
                                                    org.jooq.impl.SQLDataType.BIGINT
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.FACTIONS_FACTIONS_HIGH_MAPS,
                Indexes.FACTIONS_FACTIONS_LOW_MAPS,
                Indexes.FACTIONS_FACTIONS_NAME_IDX,
                Indexes.FACTIONS_FACTIONS_TAG_IDX,
                Indexes.FACTIONS_PRIMARY
        );
    }
    ...
    public List<UniqueKey<FactionsRecord>> getKeys() {
        return Arrays.<UniqueKey<FactionsRecord>>asList(
                Keys.KEY_FACTIONS_PRIMARY,
                Keys.KEY_FACTIONS_FACTIONS_NAME_IDX,
                Keys.KEY_FACTIONS_FACTIONS_TAG_IDX
        );
    }
