...
import com.kalaazu.persistence.database.records.NpcsRecord;
import org.jooq.*;
...
public class Npcs extends TableImpl<NpcsRecord> {
     ...
     */
    public final TableField<NpcsRecord, Byte> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<NpcsRecord, String> NAME = createField(
            DSL.name("name"),
     ...
     */
    public final TableField<NpcsRecord, Integer> HEALTH = createField(
            DSL.name("health"),
     ...
     */
    public final TableField<NpcsRecord, Integer> SHIELD = createField(
            DSL.name("shield"),
            org.jooq.impl.SQLDataType.INTEGER.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
     ...
     */
    public final TableField<NpcsRecord, Byte> SHIELD_ABSORPTION = createField(
            DSL.name("shield_absorption"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
     ...
     */
    public final TableField<NpcsRecord, Integer> DAMAGE = createField(
            DSL.name("damage"),
            org.jooq.impl.SQLDataType.INTEGER.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
     ...
     */
    public final TableField<NpcsRecord, Short> SPEED = createField(
            DSL.name("speed"),
     ...
     */
    public final TableField<NpcsRecord, Byte> GFX = createField(
            DSL.name("gfx"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
     ...
     */
    public final TableField<NpcsRecord, Byte> AI = createField(
            DSL.name("ai"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
