...
import com.kalaazu.persistence.database.records.SkilltreeUnlocksRecord;
import org.jooq.*;
...
public class SkilltreeUnlocks extends TableImpl<SkilltreeUnlocksRecord> {
     ...
     */
    public final TableField<SkilltreeUnlocksRecord, Short> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<SkilltreeUnlocksRecord, Short> UPGRADE_SKILLTREE_LEVELS_ID = createField(
            DSL.name("upgrade_skilltree_levels_id"),
     ...
     */
    public final TableField<SkilltreeUnlocksRecord, Short> REQUIRED_SKILLTREE_LEVELS_ID = createField(
            DSL.name("required_skilltree_levels_id"),
            org.jooq.impl.SQLDataType.SMALLINT.nullable(false),
            this,
            "Required skill level to upgrade."
    );
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.SKILLTREE_UNLOCKS_PRIMARY,
                Indexes.SKILLTREE_UNLOCKS_SKILLTREE_UNLOCKS_REQUIRED_SKILLTREE_LEVELS_ID_IDX,
                Indexes.SKILLTREE_UNLOCKS_SKILLTREE_UNLOCKS_UPGRADE_SKILLTREE_LEVELS_ID_IDX
        );
    }
    ...
    public List<ForeignKey<SkilltreeUnlocksRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<SkilltreeUnlocksRecord, ?>>asList(
                Keys.SKILLTREE_UNLOCKS_UPGRADE_SKILLTREE_LEVELS,
                Keys.SKILLTREE_UNLOCKS_REQUIRED_SKILLTREE_LEVELS
        );
    }
