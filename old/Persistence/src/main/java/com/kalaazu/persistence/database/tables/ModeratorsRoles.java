...
import com.kalaazu.persistence.database.records.ModeratorsRolesRecord;
import org.jooq.*;
...
public class ModeratorsRoles extends TableImpl<ModeratorsRolesRecord> {
     ...
     */
    public final TableField<ModeratorsRolesRecord, Byte> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ModeratorsRolesRecord, String> NAME = createField(
            DSL.name("name"),
     ...
     */
    public final TableField<ModeratorsRolesRecord, Byte> MODERATORS_ROLES_ID = createField(DSL.name(
            "moderators_roles_id"), org.jooq.impl.SQLDataType.TINYINT, this, "Parent role.");
    /**
     * The column <code>kalaazu.moderators_roles.priority</code>.
     */
    public final TableField<ModeratorsRolesRecord, Byte> PRIORITY = createField(
            DSL.name("priority"),
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.MODERATORS_ROLES_MODERATORS_ROLES_NAME_IDX,
                Indexes.MODERATORS_ROLES_PRIMARY
        );
    }
