...
import com.kalaazu.persistence.database.records.InvitationCodesRecord;
import org.jooq.*;
...
public class InvitationCodes extends TableImpl<InvitationCodesRecord> {
     ...
     */
    public final TableField<InvitationCodesRecord, Short> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<InvitationCodesRecord, String> CODE = createField(
            DSL.name("code"),
     ...
     */
    public final TableField<InvitationCodesRecord, Byte> LIMIT = createField(
            DSL.name("limit"),
            ...
            this,
            "Amount of times the code can be used."
    );
    ...
    private InvitationCodes(Name alias, Table<InvitationCodesRecord> aliased, Field<?>[] parameters) {
        super(
                ...
                aliased,
                parameters,
                DSL.comment("Contains the invitation codes that can be used for registering.")
        );
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.INVITATION_CODES_INVITATION_CODES_CODE_IDX,
                Indexes.INVITATION_CODES_INVITATION_CODES_ID_IDX,
                Indexes.INVITATION_CODES_PRIMARY
        );
    }
    ...
    public List<UniqueKey<InvitationCodesRecord>> getKeys() {
        return Arrays.<UniqueKey<InvitationCodesRecord>>asList(
                Keys.KEY_INVITATION_CODES_PRIMARY,
                Keys.KEY_INVITATION_CODES_INVITATION_CODES_ID_IDX,
                Keys.KEY_INVITATION_CODES_INVITATION_CODES_CODE_IDX
        );
    }
