...
import com.kalaazu.persistence.database.records.ModeratorsRecord;
import org.jooq.*;
...
public class Moderators extends TableImpl<ModeratorsRecord> {
     ...
     */
    public final TableField<ModeratorsRecord, Byte> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ModeratorsRecord, Integer> ACCOUNTS_ID = createField(
     ...
     */
    public final TableField<ModeratorsRecord, Byte> MODERATORS_ROLES_ID = createField(
            DSL.name("moderators_roles_id"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
     ...
     */
    public final TableField<ModeratorsRecord, Timestamp> DATE = createField(
            DSL.name("date"),
            ...
            this,
            "Date when the account become a moderator."
    );
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.MODERATORS_MODERATORS_ACCOUNTS_ID_IDX,
                Indexes.MODERATORS_MODERATORS_MODERATORS_ROLES_ID_IDX,
                Indexes.MODERATORS_PRIMARY
        );
    }
    ...
    public List<ForeignKey<ModeratorsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ModeratorsRecord, ?>>asList(
                Keys.MODERATORS_ACCOUNTS,
                Keys.MODERATORS_MODERATORS_ROLES
        );
    }
