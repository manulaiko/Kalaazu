...
import com.kalaazu.persistence.database.records.RewardsNpcsRecord;
import org.jooq.*;
...
public class RewardsNpcs extends TableImpl<RewardsNpcsRecord> {
     ...
     */
    public final TableField<RewardsNpcsRecord, Short> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<RewardsNpcsRecord, Byte> NPCS_ID = createField(
            DSL.name("npcs_id"),
     ...
     */
    public final TableField<RewardsNpcsRecord, Short> REWARDS_ID = createField(
            DSL.name("rewards_id"),
            org.jooq.impl.SQLDataType.SMALLINT.nullable(false),
            this,
            "Reward to award."
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.REWARDS_NPCS_PRIMARY,
                Indexes.REWARDS_NPCS_REWARDS_NPCS_NPCS_ID_IDX,
                Indexes.REWARDS_NPCS_REWARDS_NPCS_REWARDS_ID_IDX
        );
    }
