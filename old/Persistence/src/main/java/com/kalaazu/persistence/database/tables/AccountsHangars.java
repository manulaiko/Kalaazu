...
import com.kalaazu.persistence.database.records.AccountsHangarsRecord;
import org.jooq.*;
...
public class AccountsHangars extends TableImpl<AccountsHangarsRecord> {
     ...
     */
    public final TableField<AccountsHangarsRecord, Integer> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<AccountsHangarsRecord, Integer> ACCOUNTS_ID = createField(
     ...
     */
    public final TableField<AccountsHangarsRecord, Integer> ACCOUNTS_SHIPS_ID = createField(
            DSL.name("accounts_ships_id"),
            org.jooq.impl.SQLDataType.INTEGER,
            this,
            "Ship available in the hangar."
    );
    /**
     * The column <code>kalaazu.accounts_hangars.accounts_configurations_id</code>. Equipped configuration.
     */
    public final TableField<AccountsHangarsRecord, Integer> ACCOUNTS_CONFIGURATIONS_ID = createField(DSL.name(
            "accounts_configurations_id"), org.jooq.impl.SQLDataType.INTEGER, this, "Equipped configuration.");
    /**
     * The column <code>kalaazu.accounts_hangars.name</code>.
     */
    public final TableField<AccountsHangarsRecord, String> NAME = createField(
            DSL.name("name"),
     ...
     */
    public final TableField<AccountsHangarsRecord, Byte> PRIORITY = createField(
            DSL.name("priority"),
            org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.field(
                    "-1",
                    org.jooq.impl.SQLDataType.TINYINT
            )),
            this,
            "Order priority, null = not ordered."
    );
    /**
     * The column <code>kalaazu.accounts_hangars.date</code>.
     */
    public final TableField<AccountsHangarsRecord, Timestamp> DATE = createField(
            DSL.name("date"),
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.ACCOUNTS_HANGARS_ACCOUNTS_HANGARS_ACCOUNTS_ACCOUNTS_ID_IDX,
                Indexes.ACCOUNTS_HANGARS_ACCOUNTS_HANGARS_ACCOUNTS_SHIPS_ID_IDX,
                Indexes.ACCOUNTS_HANGARS_PRIMARY
        );
    }
    ...
    public List<ForeignKey<AccountsHangarsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsHangarsRecord, ?>>asList(
                Keys.ACCOUNTS_HANGARS_ACCOUNTS,
                Keys.ACCOUNTS_HANGARS_ACCOUNTS_SHIPS
        );
    }
