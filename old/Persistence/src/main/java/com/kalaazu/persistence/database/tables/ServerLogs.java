...
import com.kalaazu.persistence.database.records.ServerLogsRecord;
import org.jooq.*;
...
public class ServerLogs extends TableImpl<ServerLogsRecord> {
     ...
     */
    public final TableField<ServerLogsRecord, Integer> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ServerLogsRecord, Timestamp> DATE = createField(
            DSL.name("date"),
     ...
     */
    public final TableField<ServerLogsRecord, String> LEVEL = createField(
            DSL.name("level"),
     ...
     */
    public final TableField<ServerLogsRecord, String> TYPE = createField(
            DSL.name("type"),
            org.jooq.impl.SQLDataType.VARCHAR(255)
                                     .nullable(false)
                                     .defaultValue(org.jooq.impl.DSL.field(
     ...
     */
    public final TableField<ServerLogsRecord, String> CONTEXT = createField(
            DSL.name("context"),
