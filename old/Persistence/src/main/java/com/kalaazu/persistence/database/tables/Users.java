...
import com.kalaazu.persistence.database.records.UsersRecord;
import org.jooq.*;
...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, Timestamp> DATE = createField(
            DSL.name("date"),
     ...
     */
    public final TableField<UsersRecord, Short> INVITATION_CODES_ID = createField(
            DSL.name("invitation_codes_id"),
     ...
     */
    public final TableField<UsersRecord, String> PASSWORD = createField(
            DSL.name("password"),
            org.jooq.impl.SQLDataType.VARCHAR(255)
                                     .nullable(false)
                                     .defaultValue(org.jooq.impl.DSL.field(
     ...
     */
    public final TableField<UsersRecord, String> EMAIL_VERIFICATION_CODE = createField(
            DSL.name("email_verification_code"),
     ...
     */
    public final TableField<UsersRecord, Timestamp> EMAIL_VERIFICATION_DATE = createField(
            DSL.name("email_verification_date"),
            org.jooq.impl.SQLDataType.TIMESTAMP,
            this,
            "Date when the user verified its email."
    );
    /**
     * The column <code>kalaazu.users.ip</code>. Registration IP.
     */
    public final TableField<UsersRecord, String> IP = createField(
            DSL.name("ip"),
            org.jooq.impl.SQLDataType.VARCHAR(45)
                                     .nullable(false)
                                     .defaultValue(org.jooq.impl.DSL.field(
                                             "",
                                             org.jooq.impl.SQLDataType.VARCHAR
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.USERS_PRIMARY,
                Indexes.USERS_USERS_EMAIL_VERIFICATION_CODE_IDX,
                Indexes.USERS_USERS_ID_IDX,
                Indexes.USERS_USERS_INVITATION_CODES,
                Indexes.USERS_USERS_NAME_IDX
        );
    }
    ...
    public List<UniqueKey<UsersRecord>> getKeys() {
        return Arrays.<UniqueKey<UsersRecord>>asList(
                ...
                Keys.KEY_USERS_USERS_ID_IDX,
                Keys.KEY_USERS_USERS_NAME_IDX,
                Keys.KEY_USERS_USERS_EMAIL_VERIFICATION_CODE_IDX
        );
    }
