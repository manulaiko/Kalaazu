...
import com.kalaazu.persistence.database.records.AccountsTechfactoryItemsRecord;
import org.jooq.*;
...
public class AccountsTechfactoryItems extends TableImpl<AccountsTechfactoryItemsRecord> {
     ...
     */
    public final TableField<AccountsTechfactoryItemsRecord, Integer> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<AccountsTechfactoryItemsRecord, Integer> ACCOUNTS_ID = createField(
     ...
     */
    public final TableField<AccountsTechfactoryItemsRecord, Byte> TECHFACTORY_ITEMS_ID = createField(DSL.name(
            "techfactory_items_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "Item ID.");
    /**
     * The column <code>kalaazu.accounts_techfactory_items.amount</code>. Amount of build items.
     */
    public final TableField<AccountsTechfactoryItemsRecord, Short> AMOUNT = createField(
            DSL.name("amount"),
            ...
            this,
            "Amount of build items."
    );
    /**
     * The column <code>kalaazu.accounts_techfactory_items.date</code>. Date when the item started building.
     */
    public final TableField<AccountsTechfactoryItemsRecord, Timestamp> DATE = createField(
            DSL.name("date"),
            org.jooq.impl.SQLDataType.TIMESTAMP,
            this,
            "Date when the item started building."
    );
    ...
    public <O extends Record> AccountsTechfactoryItems(
            Table<O> child, ForeignKey<O, AccountsTechfactoryItemsRecord> key
    ) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.ACCOUNTS_TECHFACTORY_ITEMS_ACCOUNTS_TECHFACTORY_ITEMS_ACCOUNTS_ID_IDX,
                Indexes.ACCOUNTS_TECHFACTORY_ITEMS_ACCOUNTS_TECHFACTORY_ITEMS_TECHFACTORY_ITEMS_ID_IDX,
                Indexes.ACCOUNTS_TECHFACTORY_ITEMS_PRIMARY
        );
    }
    ...
    public List<ForeignKey<AccountsTechfactoryItemsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsTechfactoryItemsRecord, ?>>asList(
                Keys.ACCOUNTS_TECHFACTORY_ITEMS_ACCOUNTS,
                Keys.ACCOUNTS_TECHFACTORY_ITEMS_TECHFACTORY_ITEMS
        );
    }
