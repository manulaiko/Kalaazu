...
INSERT INTO `items` (`id`, `name`, `loot_id`, `category`, `description`, `price`, `type`, `cooldown`, `is_elite`,
                     `is_event`, `is_buyable`, `bonus`)
VALUES (1, 'Credits', 'currency_credits', 0, 'Credits item.', 0, 1, 1000, 1, 0, 0, 0),
       (2, 'Uridium', 'currency_uridium', 0, 'Uridium item.', 0, 1, 1000, 1, 0, 0, 0),
       (3, 'Jackpot', 'currency_jackpot', 0, 'Jackpot item.', 0, 1, 1000, 1, 0, 0, 0),
       (4, 'Experience', 'stats_experience', 0, 'Experience item.', 0, 1, 1000, 1, 0, 0, 0),
       (5, 'Honor', 'stats_honor', 0, 'Honor item.', 0, 1, 1000, 1, 0, 0, 0),
       (6, 'Jump Voucher', 'voucher_jump-vouhcer', 0, 'Jump voucher item.', 0, 2, 1000, 0, 0, 0, 0),
       (7, 'Repair Voucher', 'voucher_repair-voucher', 0, 'Repair voucher item.', 0, 2, 1000, 0, 0, 0, 0),
       (8, 'GalaxyGate Voucher', 'voucher_galaxygate-voucher', 0, 'GalaxyGate voucher item.', 0, 2, 1000, 0, 0, 0, 0),
       ...
       (15, 'Nostromo', 'ship_nostromo', 1,
        ...
        195000, 30, 1000, 0, 0, 1, 0),
       (16, 'Vengeance', 'ship_vengeance', 1,
        'Vengeance\n\nThe best Star Hunter: you\'ll have (almost) nothing to fear in this ship!', 30000, 30, 1000, 1, 0,
        1, 0),
       (17, 'BigBoy', 'ship_bigboy', 1,
        ...
        285000, 30, 1000, 1, 0, 1, 0),
       (18, 'Goliath', 'ship_goliath', 1,
        'Goliath\n\nThe ultimate battlecruiser: hot-shot pilots accept no substitutes!', 80000, 30, 1000, 1, 0, 1, 0),
       ...
       (29, 'Goliath Enforcer', 'ship_g-enforcer', 1,
        ...
        80000, 6, 1000, 1, 0, 1, 0),
       (30, 'Goliath Centaur', 'ship_g-centaur', 1, 'No description available.', 80000, 6, 1000, 1, 0, 1, 0),
       (31, 'Goliath Saturn', 'ship_g-saturn', 1, 'No description available.', 80000, 6, 1000, 1, 0, 1, 0),
       ...
       (41, 'Referee', 'ship_g-referee', 1,
        ...
        80000, 6, 1000, 1, 0, 1, 0),
       (42, 'Soverign', 'ship_g-soverign', 1, 'No description available.', 80000, 6, 1000, 1, 0, 1, 0),
       (43, 'Peacemaker', 'ship_g-pacemaker', 1, 'No description available.', 80000, 6, 1000, 1, 0, 1, 0),
       (44, 'Vanquisher', 'ship_g-vanquisher', 1,
        ...
        80000, 6, 1000, 1, 0, 1, 0),
       (45, 'Ignite', 'ship_g-ignite', 1, 'No description available.', 80000, 6, 1000, 1, 0, 1, 0),
       (46, 'Surgeon', 'ship_g-surgeon', 1, 'No description available.', 80000, 6, 1000, 1, 0, 1, 0),
       ...
       (52, 'Avenger', 'ship_v-avenger', 1,
        ...
        80000, 7, 1000, 1, 0, 1, 0),
       (53, 'Police', 'ship_police', 1, 'No description available.', 0, 30, 1000, 0, 0, 1, 0),
       (54, 'FWX-L', 'ammunition_firework_fwx-l', 2, 'No description available.', 25, 8, 1000, 1, 0, 1, 0),
       (55, 'FWX-M', 'ammunition_firework_fwx-m', 2, 'No description available.', 10, 8, 1000, 1, 0, 1, 0),
       (56, 'FWX-S', 'ammunition_firework_fwx-s', 2, 'No description available.', 250, 8, 1000, 0, 0, 1, 0),
       (57, 'FWX-COM-EIC', 'ammunition_firework_fwx-com-eic', 2, 'No description available.', 250, 8, 1000, 0, 0, 1, 0),
       (58, 'FWX-COM-MMO', 'ammunition_firework_fwx-com-mmo', 2, 'No description available.', 250, 8, 1000, 0, 0, 1, 0),
       (59, 'FWX-COM-VRU', 'ammunition_firework_fwx-com-vru', 2, 'No description available.', 250, 8, 1000, 0, 0, 1, 0),
       (60, 'FWX-RZ', 'ammunition_firework_fwx-rz', 2, 'No description available.', 250, 8, 1000, 0, 0, 1, 0),
       (61, 'Astral CPU', 'ammunition_ggportal_astral-cpu', 2, 'No description available.', 0, 0, 1000, 1, 0, 0, 0),
       (62, 'Eternal Blacklight CPU', 'ammunition_ggportal_eternal-blacklight-cpu', 2, 'No description available.', 0,
        0, 1000, 1, 0, 0, 0),
       (63, 'Permafrost Fissure CPU', 'ammunition_ggportal_permafrost-fissure-cpu', 2, 'No description available.', 0,
        0, 1000, 1, 0, 0, 0),
       (64, 'Permafrost Fissure CPU', 'ammunition_ggportal_permafrost-fissure-cpu', 2, 'No description available.', 0,
        0, 1000, 1, 0, 0, 0),
       (65, 'Quarantine Zone CPU', 'ammunition_ggportal_quarantine-zone-cpu', 2, 'No description available.', 0, 0,
        1000, 1, 0, 0, 0),
       (66, 'CBO-100', 'ammunition_laser_cbo-100', 2,
        ...
        5, 9, 1000, 1, 1, 1, 0),
       (67, 'A-BL', 'ammunition_laser_a-bl', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (68, 'EMAA-20', 'ammunition_laser_emaa-20', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (69, 'IDB-125', 'ammunition_laser_idb-125', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (70, 'JOB-100', 'ammunition_laser_job-100', 2,
        ...
        10, 9, 1000, 1, 1, 1, 0),
       (71, 'LCB-10', 'ammunition_laser_lcb-10', 2, 'LCB-10\n\nLow efficiency for a low price.', 10, 9, 1000, 0, 0, 1,
        1),
       (72, 'MCB-25', 'ammunition_laser_mcb-25', 2, 'MCB-25\n\nMore bang for your buck: x2 laser damage per round.', 0,
        9, 1000, 1, 0, 1, 2),
       (73, 'MCB-50', 'ammunition_laser_mcb-50', 2,
        'MCB-50\n\nThe best standard laser ammo: x3 laser damage per round.', 1, 9, 1000, 1, 0, 1, 3),
       (74, 'PIB-100', 'ammunition_laser_pib-100', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (75, 'RB-214', 'ammunition_laser_rb-214', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (76, 'RCB-140', 'ammunition_laser_rcb-140', 2, 'No description available.', 5, 9, 3000, 1, 1, 0, 0),
       (77, 'RSB-75', 'ammunition_laser_rsb-75', 2,
        'RSB-75\n\nOne type of ammo you just can\'t do without: Rain death on your enemies when you fire off a rapid laser salvo.',
        5, 9, 3000, 1, 0, 1, 6),
       (78, 'SBL-100', 'ammunition_laser_sbl-100', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (79, 'SAB-50', 'ammunition_laser_sab-50', 2,
        'SAB-50\n\nSpecial ammunition that reinforces your Shield, strengthening it by tapping into enemy shields (Shield Leech).',
        1, 9, 1000, 1, 0, 1, 2),
       (80, 'Group A', 'ammunition_laser_spacecup_group-a', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (81, 'Group B', 'ammunition_laser_spacecup_group-b', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (82, 'Group C', 'ammunition_laser_spacecup_group-c', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (83, 'Group D', 'ammunition_laser_spacecup_group-d', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (84, 'Group E', 'ammunition_laser_spacecup_group-e', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (85, 'Group F', 'ammunition_laser_spacecup_group-f', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (86, 'Group G', 'ammunition_laser_spacecup_group-g', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (87, 'Group H', 'ammunition_laser_spacecup_group-h', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (88, 'UCB-100', 'ammunition_laser_ucb-100', 2, 'No description available.', 3, 9, 1000, 1, 0, 1, 4),
       (89, 'VB-142', 'ammunition_laser_vb-142', 2, 'No description available.', 5, 9, 1000, 1, 1, 0, 0),
       (90, 'ACM-01', 'ammunition_mine_acm-01', 2, 'ACM-1\n\nProximity mine: 20% damage upon detonation.', 100, 10,
        1000, 1, 0, 1, 20),
       (91, 'AGL-M01', 'ammunition_mine_agl-m01', 2, 'No description available', 100, 10, 1000, 1, 0, 0, 0),
       (92, 'DDM-01', 'ammunition_mine_ddm-01', 2,
        'Direct-damage mine\n\nProximity mine:\n20% direct damage calculated from ship\'s base HP and pilot-bio upgrades - powerful enough to destroy enemy ships entirely!',
        250, 10, 1000, 1, 1, 1, 20),
       (93, 'EMPM-01', 'ammunition_mine_empm-01', 2,
        'Anti-cloaking mine\n\nProximity mine: 100% uncloaking upon detonation', 250, 10, 1000, 1, 1, 1, 0),
       (94, 'IM-01', 'ammunition_mine_im-01', 2, 'No description available', 100, 10, 1000, 1, 0, 0, 0),
       (95, 'SABM-01', 'ammunition_mine_sabm-01', 2,
        'Anti-shield mine\n\nProximity mine:\n50% shield damage upon detonation; combinable with other mine types.',
        250, 10, 1000, 1, 1, 1, 50),
       (96, 'RB-02', 'ammunition_mine_rb-02', 2, 'No description available.', 1500, 10, 1000, 0, 0, 1, 0),
       (97, 'RB-E01', 'ammunition_mine_rb-e01', 2, 'No description available.', 300, 10, 1000, 1, 0, 1, 0),
       (98, 'RB-E02', 'ammunition_mine_rb-e02', 2, 'No description available.', 2000, 10, 1000, 0, 0, 1, 0),
       (99, 'SL-01', 'equipment_weapon_laser_sl-01', 2,
        'Slowdown Mine\n\nSlows your opponent for 5 seconds by 50%. Furthermore, it takes effect in just 1 second.',
        250, 10, 1000, 1, 1, 1, 50),
       (100, 'SLM-01', 'ammunition_mine_slm-01', 2,
        'Slowdown Mine\n\nSlows your opponent for 5 seconds by 50%. Furthermore, it takes effect in just 1 second.',
        250, 10, 1000, 1, 1, 1, 50),
       (101, 'AGT-500', 'ammunition_rocket_agt-500', 2, 'No description available.', 10, 12, 1000, 1, 1, 0, 6000),
       (102, 'BDR-1211', 'ammunition_rocket_bdr-1211', 2,
        ...
        10, 12, 1000, 1, 1, 1, 7500),
       (103, 'PLT-2021', 'ammunition_rocket_plt-2021', 2,
        'PLT-2021\n\nLong-range rocket: causes up to 4, 000 points per rocket fired.', 5, 12, 1000, 1, 0, 1, 4000),
       (104, 'PLT-2026', 'ammunition_rocket_plt-2026', 2,
        'PLT-2026\n\nMid-range rocket: causes up to 2, 000 damage points per rocket fired.', 500, 12, 1000, 0, 0, 1,
        2000),
       (105, 'PLT-3030', 'ammunition_rocket_plt-3030', 2,
        ...
        7, 12, 1000, 1, 0, 1, 6000),
       (106, 'R-310', 'ammunition_rocket_r-310', 2,
        'R310\n\nShort-range rocket: causes up to 1,000 damage points per rocket fired.', 100, 12, 1000, 0, 0, 1, 1000),
       (107, 'SR-5', 'ammunition_rocket_sr-5', 2, 'No description available.', 10, 12, 1000, 1, 1, 0, 6000),
       (108, 'BDR-1212', 'ammunition_rocketlauncher_bdr1212', 2, 'No description available.', 100, 11, 1000, 1, 1, 1,
        0),
       (109, 'CBR-100', 'ammunition_rocketlauncher_cbr', 2,
        ...
        30, 11, 1000, 1, 1, 1, 0),
       (110, 'ECO-10', 'ammunition_rocketlauncher_eco-10', 2,
        ...
        1500, 11, 1000, 0, 0, 1, 2000),
       (111, 'HSTRM-01', 'ammunition_rocketlauncher_hstrm-01', 2,
        ...
        25, 11, 1000, 1, 1, 1, 3000),
       (112, 'PIR-100', 'ammunition_rocketlauncher_pir-100', 2, 'No description available.', 25, 11, 1000, 1, 1, 0,
        3000),
       (113, 'SAR-01', 'ammunition_rocketlauncher_sar-01', 2,
        'SAR-01 rocket\n\nThe Hellstorm SAR-01, a Shield Leeching rocket, is fired from a rocket main. An especially good quick-strike weapon!',
        2000, 11, 1000, 0, 0, 1, 1000),
       (114, 'SAR-02', 'ammunition_rocketlauncher_sar-02', 2,
        'SAR-02 rocket\n\nThe Hellstorm SAR-02, a Shield Leeching rocket, is fired from a rocket main. An especially good quick-strike weapon!',
        10, 11, 1000, 1, 1, 1, 2000),
       (115, 'SHG-01', 'ammunition_rocketlauncher_shg-01', 2, 'No description available.', 2000, 11, 1000, 0, 0, 1, 0),
       (116, 'SHG-02', 'ammunition_rocketlauncher_shg-02', 2, 'No description available.', 25, 11, 1000, 1, 1, 1, 0),
       (117, 'UBR-100', 'ammunition_rocketlauncher_ubr-100', 2,
        ...
        30, 11, 1000, 1, 1, 1, 5000),
       (118, 'Alien CPU Common', 'ammunition_specialammo_alien-cpu-common', 2, 'No description available', 250, 13,
        1000, 1, 1, 0, 30),
       (119, 'Alien CPU Cubikon', 'ammunition_specialammo_alien-cpu-cubikon', 2, 'No description available', 250, 13,
        1000, 1, 1, 0, 30),
       (120, 'Alien CPU Legend', 'ammunition_specialammo_alien-cpu-legend', 2, 'No description available', 250, 13,
        1000, 1, 1, 0, 30),
       (121, 'Alien CPU Rare', 'ammunition_specialammo_alien-cpu-rare', 2, 'No description available', 250, 13, 1000, 1,
        1, 0, 30),
       ...
       (123, 'EMP-01', 'ammunition_specialammo_emp-01', 2,
        ...
        500, 13, 1000, 1, 1, 1, 0),
       (124, 'Ghostifier', 'ammunition_specialammo_ghostifier', 2, 'No description available', 250, 13, 1000, 1, 1, 0,
        30),
       (125, 'K-300M', 'ammunition_specialammo_k-300m', 2, 'No description available', 250, 13, 1000, 1, 1, 0, 30),
       (126, 'PLD-8', 'ammunition_specialammo_pld-8', 2,
        'PLD-8\n\nThis plasma charger causes a 40% reduction of your target\'s accuracy for 5 seconds.', 100, 13, 1000,
        1, 1, 1, 40),
       (127, 'R-IC3', 'ammunition_specialammo_r-ic3', 2, 'No description available', 250, 13, 1000, 1, 1, 0, 30),
       (128, 'RC-100', 'ammunition_specialammo_rc-100', 2, 'No description available', 250, 13, 1000, 1, 1, 0, 30),
       (129, 'SP-100x', 'ammunition_specialammo_sp-100x', 2, 'No description available', 250, 13, 1000, 1, 1, 0, 30),
       (130, 'SS-CPU', 'ammunition_specialammo_ss-cpu', 2, 'No description available', 250, 13, 1000, 1, 1, 0, 30),
       (131, 'WIZ-X', 'ammunition_specialammo_wiz-x', 2, 'No description available.', 100, 13, 1000, 1, 1, 1, 0),
       (132, 'AS-B01', 'booster_as-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (133, 'BB-01', 'booster_bb-01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (138, 'DMG-B02', 'booster_dmg-b02', 3,
        ...
        10000, 0, 1000, 1, 1, 1, 10),
       (139, 'DMG-DLB', 'booster_dmg-dlb', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (140, 'DMG-DLB2', 'booster_dmg-dlb2', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (141, 'DMG-H01', 'booster_dmg-h01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (142, 'DMG-PVP01', 'booster_dmg-pvp01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (143, 'DROPCH-B01', 'booster_ddropch-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (145, 'EP-B02', 'booster_ep-b02', 3,
        ...
        10000, 0, 1000, 1, 1, 1, 10),
       (146, 'EP-DLB', 'booster_ep-dlb', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (147, 'EPHON-1', 'booster_ephon-1', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (149, 'HON-B02', 'booster_hon-b02', 3,
        ...
        10000, 0, 1000, 1, 1, 1, 10),
       (150, 'HON-DLB', 'booster_hon-dlb', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (152, 'HP-B02', 'booster_hp-b02', 3,
        ...
        10000, 0, 1000, 1, 1, 1, 10),
       (153, 'HP-DLB', 'booster_hp-dlb', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (154, 'NPC-B01', 'booster_npc-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (155, 'NPC-B02', 'booster_npc-b02', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (156, 'P-EP-B01', 'booster_p-ep-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (157, 'PRC-B00', 'booster_prc-b00', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (158, 'PRC-B01', 'booster_prc-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (159, 'PRM-B00', 'booster_prm-b00', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (160, 'PRM-B01', 'booster_prm-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (161, 'QR-01', 'booster_qr-01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (162, 'RC-B00', 'booster_rc-b00', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (163, 'RC-B01', 'booster_rc-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (165, 'REP-B02', 'booster_rep-b02', 3,
        ...
        10000, 0, 1000, 1, 1, 1, 10),
       (166, 'REP-S01', 'booster_rep-s01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (168, 'RES-B02', 'booster_res-b02', 3,
        ...
        10000, 0, 1000, 1, 1, 1, 25),
       (169, 'RM-B00', 'booster_rm-b00', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (170, 'RM-B01', 'booster_rm-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       (171, 'RWRDDBL-B01', 'booster_rwrddbl-b01', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (173, 'SHD-B02', 'booster_shd-b02', 3,
        ...
        10000, 0, 1000, 1, 1, 1, 25),
       (174, 'SHD-DLB', 'booster_shd-dlb', 3, 'No description available.', 10000, 0, 1000, 1, 1, 0, 0),
       ...
       (208, 'FB-X', 'equipment_extra_cpu_fb-x', 4,
        ...
        5000, 19, 1000, 1, 0, 1, 10000),
       (209, 'G3X-AMRY-L', 'equipment_extra_cpu_g3x-amry-l', 4, 'No description available.', 0, 19, 1000, 0, 0, 0, 0),
       (210, 'G3X-AMRY-M', 'equipment_extra_cpu_g3x-amry-m', 4, 'No description available.', 0, 19, 1000, 0, 0, 0, 0),
       (211, 'G3X-AMRY-S', 'equipment_extra_cpu_g3x-amry-s', 4, 'No description available.', 0, 19, 1000, 0, 0, 0, 0),
       (212, 'G3X-CRGO-X', 'equipment_extra_cpu_g3x-crgo-x', 4,
        'Cargo bay expansion\n\nx2 cargo space thanks to molecular compression\n\nOnly one of these items is allowed per configuration.',
        10000, 19, 1000, 1, 0, 1, 2),
       ...
       (232, 'REP-1\r\n', 'equipment_extra_repbot_rep-1', 4,
        ...
        10000, 20, 1000, 0, 0, 1, 165),
       (233, 'REP-2', 'equipment_extra_repbot_rep-2', 4,
        'Repair Robot 2\n\nThis repair bot recovers your ship\'s hull in 120 seconds.\r\n\r\r\n\n\r\n\n\r\n\r\r\n\n\r\n\nOnly one of these items is allowed per configuration.',
        64000, 20, 1000, 0, 0, 1, 120),
       (234, 'REP-3\r\n', 'equipment_extra_repbot_rep-3', 4,
        'Repair Robot 3\r\n\r\r\n\n\r\n\n\r\n\r\r\n\n\r\n\nThis repair bot recovers your ship\r\n\r\r\n\n\r\n\'s hull in 105 seconds.\n\nOnly one of these items is allowed per configuration.',
        5000, 20, 1000, 1, 0, 1, 105),
       (235, 'REP-4', 'equipment_extra_repbot_rep-4', 4,
        'Repair robot 4\n\nThis repair bot recovers your ship\'s hull in 90 seconds.\r\n\r\r\n\n\r\n\n\r\n\r\r\n\n\r\n\nOnly one of these items is allowed per configuration.',
        20000, 20, 1000, 1, 0, 1, 90),
       (236, 'BOOTY-KEY', 'resource_booty-key', 5, 'No description available.', 10000, 0, 1000, 1, 1, 1, 0),
       (237, 'BOOTY-KEY-BLUE', 'resource_booty-key-blue', 5, 'No description available.', 10000, 0, 1000, 1, 1, 1, 0),
       (238, 'BOOTY-KEY-RED', 'resource_booty-key-red', 5, 'No description available.', 0, 0, 1000, 1, 1, 1, 0),
       (239, 'EXTRA-ENERGY', 'deal_extra-energy', 5, 'No description available.', 10000, 0, 1000, 1, 1, 1, 0),
       (240, 'JUMP-VOUCHERS', 'deal_jumpvoucher', 5, 'No description available.', 10000, 0, 1000, 1, 1, 1, 0),
       (241, 'LOGFILE', 'deal_logfile', 5, 'No description available.', 10000, 0, 1000, 1, 1, 1, 0),
       (242, 'PET', 'deal_pet', 5, 'No description available.', 10000, 0, 1000, 1, 1, 1, 0),
       (243, 'PET-10\r\n', 'pet_pet10', 6, 'No description available.', 50000, 0, 1000, 1, 0, 1, 0),
       (244, 'G-HP1', 'pet_upgrade-g-hp1', 6,
        'P.E.T. hull upgrade\r\n\r\r\n\n\r\n\n\r\n\r\r\n\n\r\n\nReinforces your P.E.T.\r\n\r\r\n\n\r\n\'s hull and increases its HP',
        5000, 0, 1000, 1, 0, 1, 0),
       (245, 'Fuel 100', 'pet_fuel-100', 6, 'P.E.T. fuel\n\nYour P.E.T. only runs when it\'s got fuel.', 1, 0, 1000, 1,
        0, 1, 0),
       ...
       (247, 'CGM-02\r\n', 'equipment_petgear_cgm-02', 6,
        ...
        20000, 21, 1000, 0, 0, 1, 0);
INSERT INTO `items` (`id`, `name`, `loot_id`, `category`, `description`, `price`, `type`, `cooldown`, `is_elite`,
                     `is_event`, `is_buyable`, `bonus`)
VALUES (248, 'G-AL1', 'equipment_petgear_g-al1', 6,
       ...
       (264, 'AI-ECO1', 'equipment_aiprotocol_ai-eco1', 6,
        ...
        5000, 22, 1000, 1, 0, 1, 0),
       (265, 'Havoc', 'drone_designs_havoc', 7, 'No description available.', 50000, 23, 1000, 1, 1, 1, 0),
       (266, 'Hercules', 'drone_designs_hercules', 7, 'No description available.', 75000, 23, 1000, 1, 1, 1, 0),
       ...
       (270, 'Zeus', 'drone_zeus', 7, 'Zeus\r\n\r\r\n\n\r\n\n\r\n\r\r\n\n\r\n\nZeus drone with two slots.', 1500000, 0,
        1000, 1, 0, 1, 0),
       (271, 'F-01-TU', 'drone_formation_f-01-tu', 7, '', 1000000, 24, 1000, 0, 0, 1, 0),
       (272, 'F-02-AR', 'drone_formation_f-02-ar', 7, '', 1000000, 24, 1000, 0, 0, 1, 0),
       (273, 'F-03-LA', 'drone_formation_f-03-la', 7, 'No description available.', 100000, 24, 1000, 1, 0, 0, 0),
       ...
       (296, 'Nano Case', 'resource_nano-case', 8,
        ...
        5000, 29, 1000, 1, 0, 1, 0),
       (297, 'LGF', 'resource_logfile', 8, 'Log-disks\n\nLog-disks can be exchanged for pilot points.', 300, 0, 1000, 1,
        0, 1, 0),
       (298, 'BK-100', 'resource_booty-key', 8,
        'Green Booty Key\n\nUsed to open pirate booty and collect the valuable treasure contained within.', 1500, 0,
        1000, 1, 0, 1, 0),
       (299, 'BK-101', 'resource_booty-key', 8, 'No description available.', 0, 0, 1000, 1, 0, 0, 0),
       (300, 'BK-102', 'resource_booty-key', 8, 'No description available.', 0, 0, 1000, 1, 0, 0, 0),
       (301, 'Lottery Euro', 'resource_lottery-euro', 8, 'No description available.', 0, 0, 1000, 1, 0, 0, 0),
       (302, 'Apis Part', 'resource_blueprint_apis-part', 8, 'No description available.', 0, 25, 1000, 1, 0, 0, 0),
       (303, 'Zeus Part', 'resource_blueprint_zeus-part', 8, 'No description available.', 0, 25, 1000, 1, 0, 0, 0),
       (304, 'Prometium', 'resource_ore_prometium', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (305, 'Endurium', 'resource_ore_endurium', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (306, 'Terbium', 'resource_ore_terbium', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (307, 'Prometid', 'resource_ore_prometid', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (308, 'Duranium', 'resource_ore_duranium', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (309, 'Xenomit', 'resource_ore_xenomit', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (310, 'Promerium', 'resource_ore_promerium', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (311, 'Seprom', 'resource_ore_seprom', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (312, 'Palladium', 'resource_ore_palladium', 8, 'No description available.', 0, 26, 1000, 0, 0, 0, 0),
       (313, 'A', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (314, 'B', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (315, 'C', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (316, 'D', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (317, 'E', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (318, 'F', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (319, 'G', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (320, 'H', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (321, 'I', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (322, 'K', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (323, 'L', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (324, 'N', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (325, 'O', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (326, 'P', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (327, 'R', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (328, 'S', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (329, 'T', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (330, 'W', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (331, 'Blank', '', 8, 'No description available.', 0, 27, 1000, 0, 0, 0, 0),
       (332, 'Prismatium', 'resource_collectable_prismatium', 8, 'No description available.', 0, 28, 1000, 0, 0, 0, 0),
       (333, 'Proxium', 'resource_collectable_proxium', 8, 'No description available.', 0, 28, 1000, 0, 0, 0, 0),
       (334, 'Quadrothrin', 'resource_collectable_quadrothrin', 8, 'No description available.', 0, 28, 1000, 0, 0, 0,
        0),
       (335, 'Schism', 'resource_collectable_schism', 8, 'No description available.', 0, 28, 1000, 0, 0, 0, 0),
       (336, 'Scrapium', 'resource_collectable_scrapium', 8, 'No description available.', 0, 28, 1000, 0, 0, 0, 0),
       (337, 'Tetrathrin', 'resource_collectable_tetrathrin', 8, 'No description available.', 0, 28, 1000, 0, 0, 0, 0),
       (338, 'Trittothrin', 'resource_collectable_trittothrin', 8, 'No description available.', 0, 28, 1000, 0, 0, 0,
        0),
       (339, 'Recipe Default', '', 8, 'No description available.', 0, 29, 1000, 0, 0, 0, 0),
       (340, 'REPM-1', 'module_repm-1', 9, 'Repairs Battle Stations over time.', 0, 0, 1000, 0, 0, 0, 0),
       ...
       (342, 'DEFM-1', 'module_defm-1', 9,
        ...
        0, 0, 1000, 0, 0, 0, 0),
       (343, 'DMGM-1', 'module_dmgm-1', 9, 'Increases damage from weapon modules', 0, 0, 1000, 0, 0, 0, 0),
       (344, 'HULM-1', 'module_hulm-1', 9,
        ...
        0, 0, 1000, 0, 0, 0, 0),
       (345, 'HONM-1', 'module_honm-1', 9, 'All Clan members receive more honor points', 0, 0, 1000, 0, 0, 0, 0),
       (346, 'LTM-LR', 'module_ltm-lr', 9, 'Laser Module with limited range.', 0, 0, 1000, 0, 0, 0, 0),
       (347, 'LTM-MR', 'module_ltm-mr', 9, 'Laser Module with average range.', 0, 0, 1000, 0, 0, 0, 0),
       (348, 'RAM-LA', 'module_ram-la', 9, 'Rocket Module with limited precision.', 0, 0, 1000, 0, 0, 0, 0),
       (349, 'RAM-MA', 'module_ram-ma', 9, 'Rocket Module with average precision.', 0, 0, 1000, 0, 0, 0, 0),
       (350, 'Alpha Part', '', 10, 'Alpha gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (351, 'Beta Part', '', 10, 'Beta gate part', 0, 0, 1000, 0, 0, 0, 0),
       (352, 'Gamma Part', '', 10, 'Gamma gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (353, 'Delta Part', '', 10, 'Delta gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (354, 'Epsilon Part', '', 10, 'Epsilon gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (355, 'Zeta Part', '', 10, 'Zeta gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (356, 'Kappa Part', '', 10, 'Kappa gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (357, 'Lambda Part', '', 10, 'Lambda gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (358, 'Hades Part', '', 10, 'Hades gate part.', 0, 0, 1000, 0, 0, 0, 0),
       (359, 'Kuiper Part', '', 10, 'Kuiper gate part.', 0, 0, 1000, 0, 0, 0, 0);
