...
import com.kalaazu.persistence.database.records.ClansApplicationsRecord;
import org.jooq.*;
...
public class ClansApplications extends TableImpl<ClansApplicationsRecord> {
     ...
     */
    public final TableField<ClansApplicationsRecord, Integer> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ClansApplicationsRecord, Integer> CLANS_ID = createField(
            DSL.name("clans_id"),
     ...
     */
    public final TableField<ClansApplicationsRecord, Integer> ACCOUNTS_ID = createField(
     ...
     */
    public final TableField<ClansApplicationsRecord, Timestamp> DATE = createField(
            DSL.name("date"),
     ...
     */
    public final TableField<ClansApplicationsRecord, String> TEXT = createField(
            DSL.name("text"),
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.CLANS_APPLICATIONS_CLANS_APPLICATIONS_ACCOUNTS_ID_IDX,
                Indexes.CLANS_APPLICATIONS_CLANS_APPLICATIONS_CLANS_ID_IDX,
                Indexes.CLANS_APPLICATIONS_PRIMARY
        );
    }
    ...
    public List<ForeignKey<ClansApplicationsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ClansApplicationsRecord, ?>>asList(
                Keys.CLANS_APPLICATIONS_CLANS,
                Keys.CLANS_APPLICATIONS_ACCOUNTS
        );
    }
