...
import com.kalaazu.persistence.database.records.MapsNpcsRecord;
import org.jooq.*;
...
public class MapsNpcs extends TableImpl<MapsNpcsRecord> {
     ...
     */
    public final TableField<MapsNpcsRecord, Byte> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<MapsNpcsRecord, Byte> MAPS_ID = createField(
            DSL.name("maps_id"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false),
            this,
            "Map ID."
     ...
     */
    public final TableField<MapsNpcsRecord, Byte> NPCS_ID = createField(
            DSL.name("npcs_id"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false),
            this,
            "NPC ID."
     ...
     */
    public final TableField<MapsNpcsRecord, Byte> AMOUNT = createField(
            DSL.name("amount"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.MAPS_NPCS_MAPS_NPCS_MAPS_ID_IDX,
                Indexes.MAPS_NPCS_MAPS_NPCS_NPCS_ID_IDX,
                Indexes.MAPS_NPCS_PRIMARY
        );
    }
