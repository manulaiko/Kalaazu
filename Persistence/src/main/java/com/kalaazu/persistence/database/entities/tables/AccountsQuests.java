...
public class AccountsQuests extends TableImpl<AccountsQuestsRecord> {
     ...
     */
    public final TableField<AccountsQuestsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_quests.quests_id</code>.
     */
    public final TableField<AccountsQuestsRecord, Short> QUESTS_ID = createField(DSL.name("quests_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_quests.accounts_id</code>.
     */
    public final TableField<AccountsQuestsRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_quests.is_completed</code>. Whether the quest has been completed or not.
     */
    public final TableField<AccountsQuestsRecord, Byte> IS_COMPLETED = createField(DSL.name("is_completed"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Whether the quest has been completed or not.");

    /**
     * The column <code>kalaazu.accounts_quests.date</code>. Date when the quest was accepted/completed.
     */
    public final TableField<AccountsQuestsRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "Date when the quest was accepted/completed.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_QUESTS_ACCOUNTS_QUESTS_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_QUESTS_ACCOUNTS_QUESTS_QUESTS_ID_IDX, Indexes.ACCOUNTS_QUESTS_PRIMARY);
    }
    ...
    public List<ForeignKey<AccountsQuestsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsQuestsRecord, ?>>asList(Keys.ACCOUNTS_QUESTS_QUESTS, Keys.ACCOUNTS_QUESTS_ACCOUNTS);
    }
