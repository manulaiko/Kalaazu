...
public class AccountsSkylabs extends TableImpl<AccountsSkylabsRecord> {
     ...
     */
    public final TableField<AccountsSkylabsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_skylabs.accounts_id</code>. Account ID.
     */
    public final TableField<AccountsSkylabsRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Account ID.");

    /**
     * The column <code>kalaazu.accounts_skylabs.skylab_modules_id</code>. Module ID.
     */
    public final TableField<AccountsSkylabsRecord, Byte> SKYLAB_MODULES_ID = createField(DSL.name("skylab_modules_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "Module ID.");

    /**
     * The column <code>kalaazu.accounts_skylabs.levels_id</code>. Module level.
     */
    public final TableField<AccountsSkylabsRecord, Byte> LEVELS_ID = createField(DSL.name("levels_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "Module level.");

    /**
     * The column <code>kalaazu.accounts_skylabs.space</code>. Used space.
     */
    public final TableField<AccountsSkylabsRecord, Integer> SPACE = createField(DSL.name("space"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Used space.");

    /**
     * The column <code>kalaazu.accounts_skylabs.upgrade</code>. Date when this module started upgrading.
     */
    public final TableField<AccountsSkylabsRecord, Timestamp> UPGRADE = createField(DSL.name("upgrade"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "Date when this module started upgrading.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_SKYLABS_ACCOUNTS_SKYLABS_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_SKYLABS_ACCOUNTS_SKYLABS_LEVELS, Indexes.ACCOUNTS_SKYLABS_ACCOUNTS_SKYLABS_SKYLAB_MODULES_ID_IDX, Indexes.ACCOUNTS_SKYLABS_PRIMARY);
    }
    ...
    public List<ForeignKey<AccountsSkylabsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsSkylabsRecord, ?>>asList(Keys.ACCOUNTS_SKYLABS_ACCOUNTS, Keys.ACCOUNTS_SKYLABS_SKYLAB_MODULES, Keys.ACCOUNTS_SKYLABS_LEVELS);
    }
