...
public class InvitationCodesRedeemLogs extends TableImpl<InvitationCodesRedeemLogsRecord> {
     ...
     */
    public final TableField<InvitationCodesRedeemLogsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.invitation_codes_redeem_logs.invitation_codes_id</code>. Invitation code ID.
     */
    public final TableField<InvitationCodesRedeemLogsRecord, Short> INVITATION_CODES_ID = createField(DSL.name("invitation_codes_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "Invitation code ID.");

    /**
     * The column <code>kalaazu.invitation_codes_redeem_logs.ip</code>. IP that redeemed the code.
     */
    public final TableField<InvitationCodesRedeemLogsRecord, String> IP = createField(DSL.name("ip"), org.jooq.impl.SQLDataType.VARCHAR(45).nullable(false), this, "IP that redeemed the code.");

    /**
     * The column <code>kalaazu.invitation_codes_redeem_logs.date</code>. Date when the code was redeemed.
     */
    public final TableField<InvitationCodesRedeemLogsRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "Date when the code was redeemed.");
    ...
    private InvitationCodesRedeemLogs(Name alias, Table<InvitationCodesRedeemLogsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Contains the redeem logs for the invitation codes."));
    }

    public <O extends Record> InvitationCodesRedeemLogs(Table<O> child, ForeignKey<O, InvitationCodesRedeemLogsRecord> key) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.INVITATION_CODES_REDEEM_LOGS_INVITATION_CODES_REDEEM_LOGS_INVITATION_CODES, Indexes.INVITATION_CODES_REDEEM_LOGS_PRIMARY);
    }
