...
public class AccountsHistory extends TableImpl<AccountsHistoryRecord> {
     ...
     */
    public final TableField<AccountsHistoryRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_history.accounts_id</code>.
     */
    public final TableField<AccountsHistoryRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_history.type</code>. Event type.
     */
    public final TableField<AccountsHistoryRecord, Byte> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Event type.");

    /**
     * The column <code>kalaazu.accounts_history.message</code>. Event message.
     */
    public final TableField<AccountsHistoryRecord, String> MESSAGE = createField(DSL.name("message"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "Event message.");

    /**
     * The column <code>kalaazu.accounts_history.amount</code>. For currency related events, the amount of currency.
     */
    public final TableField<AccountsHistoryRecord, Integer> AMOUNT = createField(DSL.name("amount"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "For currency related events, the amount of currency.");

    /**
     * The column <code>kalaazu.accounts_history.date</code>. Date when the event occurred.
     */
    public final TableField<AccountsHistoryRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "Date when the event occurred.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_HISTORY_ACCOUNTS_HISTORY_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_HISTORY_PRIMARY);
    }
    ...
    public List<UniqueKey<AccountsHistoryRecord>> getKeys() {
        return Arrays.<UniqueKey<AccountsHistoryRecord>>asList(Keys.KEY_ACCOUNTS_HISTORY_PRIMARY, Keys.KEY_ACCOUNTS_HISTORY_ACCOUNTS_HISTORY_ACCOUNTS_ID_IDX);
    }
