...
public class ClansBanksLogs extends TableImpl<ClansBanksLogsRecord> {
     ...
     */
    public final TableField<ClansBanksLogsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.clans_banks_logs.clans_banks_id</code>.
     */
    public final TableField<ClansBanksLogsRecord, Integer> CLANS_BANKS_ID = createField(DSL.name("clans_banks_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.clans_banks_logs.from_accounts_id</code>. Account that made the log.
     */
    public final TableField<ClansBanksLogsRecord, Integer> FROM_ACCOUNTS_ID = createField(DSL.name("from_accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Account that made the log.");

    /**
     * The column <code>kalaazu.clans_banks_logs.to_accounts_id</code>.
     */
    public final TableField<ClansBanksLogsRecord, Integer> TO_ACCOUNTS_ID = createField(DSL.name("to_accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.clans_banks_logs.date</code>.
     */
    public final TableField<ClansBanksLogsRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>kalaazu.clans_banks_logs.type</code>. Log type. 0 = withdraw, 1 = deposit, 2 = donation.
     */
    public final TableField<ClansBanksLogsRecord, Byte> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Log type. 0 = withdraw, 1 = deposit, 2 = donation.");

    /**
     * The column <code>kalaazu.clans_banks_logs.amount</code>. Amount of currency logged.
     */
    public final TableField<ClansBanksLogsRecord, Integer> AMOUNT = createField(DSL.name("amount"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Amount of currency logged.");

    /**
     * The column <code>kalaazu.clans_banks_logs.currency</code>. Currency of the amount. 0 = credits, 1 = uridium.
     */
    public final TableField<ClansBanksLogsRecord, Byte> CURRENCY = createField(DSL.name("currency"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Currency of the amount. 0 = credits, 1 = uridium.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CLANS_BANKS_LOGS_CLANS_BANKS_LOGS_CLANS_BANKS_ID_IDX, Indexes.CLANS_BANKS_LOGS_CLANS_BANKS_LOGS_FROM_ACCOUNTS_ID_IDX, Indexes.CLANS_BANKS_LOGS_CLANS_BANKS_LOGS_TO_ACCOUNTS_ID_IDX, Indexes.CLANS_BANKS_LOGS_PRIMARY);
    }
    ...
    public List<ForeignKey<ClansBanksLogsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ClansBanksLogsRecord, ?>>asList(Keys.CLANS_BANKS_LOGS_CLANS_BANKS, Keys.CLANS_BANKS_LOGS_FROM_ACCOUNTS, Keys.CLANS_BANKS_LOGS_TO_ACCOUNTS);
    }
