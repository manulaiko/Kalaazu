...
public class AccountsBanksRecord extends UpdatableRecordImpl<AccountsBanksRecord> implements Record6<Integer, Integer, Long, Long, Byte, Byte> {
    ...
    @Override
    public AccountsBanksRecord values(Integer value1, Integer value2, Long value3, Long value4, Byte value5, Byte value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsBanksRecord(Integer id, Integer accountsId, Long credits, Long uridium, Byte taxCredits, Byte taxUridium) {
        super(AccountsBanks.ACCOUNTS_BANKS);
