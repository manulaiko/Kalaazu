...
public class AccountsItems extends TableImpl<AccountsItemsRecord> {
     ...
     */
    public final TableField<AccountsItemsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_items.items_id</code>.
     */
    public final TableField<AccountsItemsRecord, Short> ITEMS_ID = createField(DSL.name("items_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_items.accounts_id</code>.
     */
    public final TableField<AccountsItemsRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_items.levels_id</code>.
     */
    public final TableField<AccountsItemsRecord, Byte> LEVELS_ID = createField(DSL.name("levels_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>kalaazu.accounts_items.date</code>.
     */
    public final TableField<AccountsItemsRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>kalaazu.accounts_items.amount</code>. Amount of items bough (for stackable items).
     */
    public final TableField<AccountsItemsRecord, Long> AMOUNT = createField(DSL.name("amount"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BIGINT)), this, "Amount of items bough (for stackable items).");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_ITEMS_ACCOUNTS_ITEMS_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_ITEMS_ACCOUNTS_ITEMS_ITEMS_ID_IDX, Indexes.ACCOUNTS_ITEMS_ACCOUNTS_ITEMS_LEVELS_ID_IDX, Indexes.ACCOUNTS_ITEMS_PRIMARY);
    }
    ...
    public List<ForeignKey<AccountsItemsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsItemsRecord, ?>>asList(Keys.ACCOUNTS_ITEMS_ITEMS, Keys.ACCOUNTS_ITEMS_ACCOUNTS, Keys.ACCOUNTS_ITEMS_LEVELS);
    }
