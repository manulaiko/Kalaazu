 ...
 * com.kalaazu.persistence.database.entities.items.Items}-interface.
 * <p>
...
public abstract class GeneratedItemsImpl implements Items {
    ...
    @Override
    public int getIsBuyable() {
        return isBuyable;
    }

    @Override
    public Items setId(short id) {
        this.id = id;
        return this;
    }
    ...
    @Override
    public Items setCategory(byte category) {
    ...
    @Override
    public Items setType(byte type) {
        this.type = type;
        return this;
    }

    @Override
    public Items setIsElite(int isElite) {
        this.isElite = isElite;
        return this;
    }

    @Override
    public Items setIsEvent(int isEvent) {
        this.isEvent = isEvent;
        return this;
    }

    @Override
    public Items setIsBuyable(int isBuyable) {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getId() != thatItems.getId()) {
            return false;
        }
        if (!Objects.equals(this.getName(), thatItems.getName())) {
            return false;
        }
        if (this.getCategory() != thatItems.getCategory()) {
            return false;
        }
        if (!Objects.equals(this.getDescription(), thatItems.getDescription())) {
            return false;
        }
        if (this.getPrice() != thatItems.getPrice()) {
            return false;
        }
        if (this.getType() != thatItems.getType()) {
            return false;
        }
        if (this.getIsElite() != thatItems.getIsElite()) {
            return false;
        }
        if (this.getIsEvent() != thatItems.getIsEvent()) {
            return false;
        }
        if (this.getIsBuyable() != thatItems.getIsBuyable()) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Byte.hashCode(getCategory());
        hash = 31 * hash + Objects.hashCode(getDescription());
        hash = 31 * hash + Integer.hashCode(getPrice());
        hash = 31 * hash + Byte.hashCode(getType());
        hash = 31 * hash + Integer.hashCode(getIsElite());
        hash = 31 * hash + Integer.hashCode(getIsEvent());
        hash = 31 * hash + Integer.hashCode(getIsBuyable());
        return hash;
    }
}