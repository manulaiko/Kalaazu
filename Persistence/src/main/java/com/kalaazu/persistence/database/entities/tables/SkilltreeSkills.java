...
public class SkilltreeSkills extends TableImpl<SkilltreeSkillsRecord> {
     ...
     */
    public final TableField<SkilltreeSkillsRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.skilltree_skills.name</code>. Skill name.
     */
    public final TableField<SkilltreeSkillsRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "Skill name.");

    /**
     * The column <code>kalaazu.skilltree_skills.description</code>. Skill description.
     */
    public final TableField<SkilltreeSkillsRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "Skill description.");

    /**
     * The column <code>kalaazu.skilltree_skills.type</code>. 0 = blue, 1 = purple, 2 = red.
     */
    public final TableField<SkilltreeSkillsRecord, Byte> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "0 = blue, 1 = purple, 2 = red.");

    /**
     * The column <code>kalaazu.skilltree_skills.is_advanced</code>. Whether it's an advanced skill or not.
     */
    public final TableField<SkilltreeSkillsRecord, Byte> IS_ADVANCED = createField(DSL.name("is_advanced"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Whether it's an advanced skill or not.");

    /**
     * The column <code>kalaazu.skilltree_skills.bonus_type</code>. Type of bonus the skill awards.
     */
    public final TableField<SkilltreeSkillsRecord, String> BONUS_TYPE = createField(DSL.name("bonus_type"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("health", org.jooq.impl.SQLDataType.VARCHAR)), this, "Type of bonus the skill awards.");

    /**
     * The column <code>kalaazu.skilltree_skills.bonus_amount</code>. Amount of bonus the skill awards.
     */
    public final TableField<SkilltreeSkillsRecord, Integer> BONUS_AMOUNT = createField(DSL.name("bonus_amount"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Amount of bonus the skill awards.");

    /**
     * The column <code>kalaazu.skilltree_skills.bonus_factor</code>. Factor the bonus increases with each upgrade.
     */
    public final TableField<SkilltreeSkillsRecord, Byte> BONUS_FACTOR = createField(DSL.name("bonus_factor"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("2", org.jooq.impl.SQLDataType.TINYINT)), this, "Factor the bonus increases with each upgrade.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SKILLTREE_SKILLS_PRIMARY, Indexes.SKILLTREE_SKILLS_SKILLTREE_SKILLS_BONUS_TYPE_IDX, Indexes.SKILLTREE_SKILLS_SKILLTREE_SKILLS_IS_ADVANCED_IDX, Indexes.SKILLTREE_SKILLS_SKILLTREE_SKILLS_NAME_IDX, Indexes.SKILLTREE_SKILLS_SKILLTREE_SKILLS_TYPE_IDX);
    }
