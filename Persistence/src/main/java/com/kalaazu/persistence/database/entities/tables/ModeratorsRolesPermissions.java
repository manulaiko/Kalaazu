...
public class ModeratorsRolesPermissions extends TableImpl<ModeratorsRolesPermissionsRecord> {
     ...
     */
    public final TableField<ModeratorsRolesPermissionsRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.moderators_roles_permissions.moderators_roles_id</code>.
     */
    public final TableField<ModeratorsRolesPermissionsRecord, Byte> MODERATORS_ROLES_ID = createField(DSL.name("moderators_roles_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.moderators_roles_permissions.permissions_id</code>.
     */
    public final TableField<ModeratorsRolesPermissionsRecord, Byte> PERMISSIONS_ID = createField(DSL.name("permissions_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.moderators_roles_permissions.is_enabled</code>. Enabled value, null = inherited
     */
    public final TableField<ModeratorsRolesPermissionsRecord, Byte> IS_ENABLED = createField(DSL.name("is_enabled"), org.jooq.impl.SQLDataType.TINYINT, this, "Enabled value, null = inherited");
    ...
    private ModeratorsRolesPermissions(Name alias, Table<ModeratorsRolesPermissionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Moderator roles' permissions"));
    }

    public <O extends Record> ModeratorsRolesPermissions(Table<O> child, ForeignKey<O, ModeratorsRolesPermissionsRecord> key) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MODERATORS_ROLES_PERMISSIONS_MODERATORS_ROLES_PERMISSIONS_MODERATORS_ROLES_ID_IDX, Indexes.MODERATORS_ROLES_PERMISSIONS_MODERATORS_ROLES_PERMISSIONS_PERMISSIONS_ID_IDX, Indexes.MODERATORS_ROLES_PERMISSIONS_PRIMARY);
    }
    ...
    public List<ForeignKey<ModeratorsRolesPermissionsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ModeratorsRolesPermissionsRecord, ?>>asList(Keys.MODERATORS_ROLES_PERMISSIONS_MODERATORS_ROLES, Keys.MODERATORS_ROLES_PERMISSIONS_PERMISSIONS);
    }
