...
public class AccountsConfigurations extends TableImpl<AccountsConfigurationsRecord> {
     ...
     */
    public final TableField<AccountsConfigurationsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_configurations.accounts_hangars_id</code>.
     */
    public final TableField<AccountsConfigurationsRecord, Integer> ACCOUNTS_HANGARS_ID = createField(DSL.name("accounts_hangars_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_configurations.configuration_id</code>. Configuration ID (1 or 2 (or 3)).
     */
    public final TableField<AccountsConfigurationsRecord, Byte> CONFIGURATION_ID = createField(DSL.name("configuration_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "Configuration ID (1 or 2 (or 3)).");

    /**
     * The column <code>kalaazu.accounts_configurations.name</code>.
     */
    public final TableField<AccountsConfigurationsRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>kalaazu.accounts_configurations.shield</code>. Shield available in the configuration.
     */
    public final TableField<AccountsConfigurationsRecord, Integer> SHIELD = createField(DSL.name("shield"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Shield available in the configuration.");

    /**
     * The column <code>kalaazu.accounts_configurations.speed</code>. Speed available in the configuration.
     */
    public final TableField<AccountsConfigurationsRecord, Short> SPEED = createField(DSL.name("speed"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "Speed available in the configuration.");

    /**
     * The column <code>kalaazu.accounts_configurations.damage</code>. Damage available in the configuration.
     */
    public final TableField<AccountsConfigurationsRecord, Integer> DAMAGE = createField(DSL.name("damage"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Damage available in the configuration.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_CONFIGURATIONS_ACCOUNTS_HANGARS_ID_IDX, Indexes.ACCOUNTS_CONFIGURATIONS_PRIMARY);
    }
