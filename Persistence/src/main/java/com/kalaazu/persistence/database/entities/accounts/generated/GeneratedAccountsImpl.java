 ...
 * com.kalaazu.persistence.database.entities.accounts.Accounts}-interface.
 * <p>
...
public abstract class GeneratedAccountsImpl implements Accounts {
    ...
    @Override
    public Accounts setAccountsHangarsId(int accountsHangarsId) {
        this.accountsHangarsId = accountsHangarsId;
        return this;
    }

    @Override
    public Accounts setClansId(int clansId) {
    ...
    public Optional<AccountsHangars> findAccountsHangarsId(Manager<AccountsHangars> foreignManager) {
        if (getAccountsHangarsId().isPresent()) {
            return foreignManager.stream()
                                 .filter(AccountsHangars.ID.equal(getAccountsHangarsId().get()))
                                 .findAny();
        } else {
            return Optional.empty();
        }
    ...
    public Optional<Clans> findClansId(Manager<Clans> foreignManager) {
        if (getClansId().isPresent()) {
            return foreignManager.stream()
                                 .filter(Clans.ID.equal(getClansId().get()))
                                 .findAny();
        } else {
            return Optional.empty();
        }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getAccountsHangarsId()));
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getClansId()));
        hash = 31 * hash + Byte.hashCode(getRanksId());
        hash = 31 * hash + Objects.hashCode(getName());
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getBanDate()));
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getPremiumDate()));
