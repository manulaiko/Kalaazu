...
public class ClansNews extends TableImpl<ClansNewsRecord> {
     ...
     */
    public final TableField<ClansNewsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.clans_news.accounts_id</code>. Author.
     */
    public final TableField<ClansNewsRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Author.");

    /**
     * The column <code>kalaazu.clans_news.clans_id</code>.
     */
    public final TableField<ClansNewsRecord, Integer> CLANS_ID = createField(DSL.name("clans_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.clans_news.date</code>. Creation date.
     */
    public final TableField<ClansNewsRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "Creation date.");

    /**
     * The column <code>kalaazu.clans_news.text</code>. News content.
     */
    public final TableField<ClansNewsRecord, String> TEXT = createField(DSL.name("text"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "News content.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CLANS_NEWS_CLANS_NEWS_ACCOUNTS_ID_IDX, Indexes.CLANS_NEWS_CLANS_NEWS_CLANS_ID_IDX, Indexes.CLANS_NEWS_PRIMARY);
    }
