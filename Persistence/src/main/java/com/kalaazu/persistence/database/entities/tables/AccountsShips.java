...
public class AccountsShips extends TableImpl<AccountsShipsRecord> {
     ...
     */
    public final TableField<AccountsShipsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_ships.accounts_id</code>.
     */
    public final TableField<AccountsShipsRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_ships.ships_id</code>.
     */
    public final TableField<AccountsShipsRecord, Byte> SHIPS_ID = createField(DSL.name("ships_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_ships.maps_id</code>.
     */
    public final TableField<AccountsShipsRecord, Byte> MAPS_ID = createField(DSL.name("maps_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_ships.position</code>. Position on map.
     */
    public final TableField<AccountsShipsRecord, Long> POSITION = createField(DSL.name("position"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "Position on map.");

    /**
     * The column <code>kalaazu.accounts_ships.health</code>. Health points.
     */
    public final TableField<AccountsShipsRecord, Integer> HEALTH = createField(DSL.name("health"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Health points.");

    /**
     * The column <code>kalaazu.accounts_ships.nanohull</code>. Nanohull points.
     */
    public final TableField<AccountsShipsRecord, Integer> NANOHULL = createField(DSL.name("nanohull"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Nanohull points.");

    /**
     * The column <code>kalaazu.accounts_ships.gfx</code>. Ship graphic (for WIZ-X).
     */
    public final TableField<AccountsShipsRecord, Byte> GFX = createField(DSL.name("gfx"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Ship graphic (for WIZ-X).");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_SHIPS_ACCOUNTS_SHIPS_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_SHIPS_ACCOUNTS_SHIPS_MAPS_ID_IDX, Indexes.ACCOUNTS_SHIPS_ACCOUNTS_SHIPS_SHIPS_ID_IDX, Indexes.ACCOUNTS_SHIPS_PRIMARY);
    }
    ...
    public List<ForeignKey<AccountsShipsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsShipsRecord, ?>>asList(Keys.ACCOUNTS_SHIPS_ACCOUNTS, Keys.ACCOUNTS_SHIPS_SHIPS, Keys.ACCOUNTS_SHIPS_MAPS);
    }
