...
public class Rewards extends TableImpl<RewardsRecord> {
     ...
     */
    public final TableField<RewardsRecord, Short> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.rewards.items_id</code>. Item to award.
     */
    public final TableField<RewardsRecord, Short> ITEMS_ID = createField(DSL.name("items_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "Item to award.");

    /**
     * The column <code>kalaazu.rewards.amount</code>. Amount of items to award.
     */
    public final TableField<RewardsRecord, Integer> AMOUNT = createField(DSL.name("amount"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Amount of items to award.");

    /**
     * The column <code>kalaazu.rewards.probability</code>. Probability of awarding this item
     */
    public final TableField<RewardsRecord, Double> PROBABILITY = createField(DSL.name("probability"), org.jooq.impl.SQLDataType.FLOAT.nullable(false).defaultValue(org.jooq.impl.DSL.field("100", org.jooq.impl.SQLDataType.FLOAT)), this, "Probability of awarding this item");

    /**
     * The column <code>kalaazu.rewards.comment</code>. Comment of the reward.
     */
    public final TableField<RewardsRecord, String> COMMENT = createField(DSL.name("comment"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "Comment of the reward.");
