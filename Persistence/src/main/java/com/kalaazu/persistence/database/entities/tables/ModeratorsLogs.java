...
public class ModeratorsLogs extends TableImpl<ModeratorsLogsRecord> {
     ...
     */
    public final TableField<ModeratorsLogsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.moderators_logs.moderators_id</code>.
     */
    public final TableField<ModeratorsLogsRecord, Byte> MODERATORS_ID = createField(DSL.name("moderators_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.moderators_logs.date</code>.
     */
    public final TableField<ModeratorsLogsRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>kalaazu.moderators_logs.type</code>.
     */
    public final TableField<ModeratorsLogsRecord, String> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>kalaazu.moderators_logs.text</code>.
     */
    public final TableField<ModeratorsLogsRecord, String> TEXT = createField(DSL.name("text"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MODERATORS_LOGS_MODERATORS_LOGS_MODERATORS_ID_IDX, Indexes.MODERATORS_LOGS_MODERATORS_LOGS_TYPE_IDX, Indexes.MODERATORS_LOGS_PRIMARY);
    }
