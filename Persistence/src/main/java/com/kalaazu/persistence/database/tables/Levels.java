...
import com.kalaazu.persistence.database.records.LevelsRecord;
import org.jooq.*;
...
public class Levels extends TableImpl<LevelsRecord> {
     ...
     */
    public final TableField<LevelsRecord, Byte> ID = createField(DSL.name("id"),
     ...
     */
    public final TableField<LevelsRecord, Long> ACCOUNT = createField(DSL.name("account"),
                                                                      ...
                                                                      this,
                                                                      "Experience needed for an account to reach this level."
    );
    /**
     * The column <code>kalaazu.levels.drone</code>. Experience needed for a drone to reach this level
     */
    public final TableField<LevelsRecord, Short> DRONE = createField(DSL.name("drone"),
                                                                     ...
                                                                     this,
                                                                     "Experience needed for a drone to reach this level"
    );
    /**
     * The column <code>kalaazu.levels.pet</code>. Experience needed for a PET to reach this level.
     */
    public final TableField<LevelsRecord, Integer> PET = createField(DSL.name("pet"),
                                                                     ...
                                                                     this,
                                                                     "Experience needed for a PET to reach this level."
    );
    /**
     * The column <code>kalaazu.levels.damage</code>. Damage bonus applied for an item at this level.
     */
    public final TableField<LevelsRecord, Double> DAMAGE = createField(DSL.name("damage"),
                                                                       ...
                                                                       this,
                                                                       "Damage bonus applied for an item at this level."
    );
    /**
     * The column <code>kalaazu.levels.shield</code>. Shield bonus applied to an item at this level.
     */
    public final TableField<LevelsRecord, Double> SHIELD = createField(DSL.name("shield"),
                                                                       org.jooq.impl.SQLDataType.FLOAT.nullable(false)
                                                                                                      .defaultValue(org.jooq.impl.DSL
                                                                                                                            .field(
                                                                                                                                    "0",
                                                                       ...
                                                                       this,
                                                                       "Shield bonus applied to an item at this level."
    );
