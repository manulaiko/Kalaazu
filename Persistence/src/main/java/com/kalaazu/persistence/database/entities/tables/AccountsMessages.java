...
public class AccountsMessages extends TableImpl<AccountsMessagesRecord> {
     ...
     */
    public final TableField<AccountsMessagesRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_messages.from_accounts_id</code>.
     */
    public final TableField<AccountsMessagesRecord, Integer> FROM_ACCOUNTS_ID = createField(DSL.name("from_accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>kalaazu.accounts_messages.from_status</code>. 0 = unread, 1 = read, 2 = deleted.
     */
    public final TableField<AccountsMessagesRecord, Byte> FROM_STATUS = createField(DSL.name("from_status"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "0 = unread, 1 = read, 2 = deleted.");

    /**
     * The column <code>kalaazu.accounts_messages.to_accounts_id</code>.
     */
    public final TableField<AccountsMessagesRecord, Integer> TO_ACCOUNTS_ID = createField(DSL.name("to_accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_messages.to_status</code>. 0 = unread, 1 = read, 2 = unread.
     */
    public final TableField<AccountsMessagesRecord, Byte> TO_STATUS = createField(DSL.name("to_status"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0 = unread, 1 = read, 2 = unread.");

    /**
     * The column <code>kalaazu.accounts_messages.date</code>.
     */
    public final TableField<AccountsMessagesRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>kalaazu.accounts_messages.title</code>.
     */
    public final TableField<AccountsMessagesRecord, String> TITLE = createField(DSL.name("title"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_messages.text</code>.
     */
    public final TableField<AccountsMessagesRecord, String> TEXT = createField(DSL.name("text"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_MESSAGES_ACCOUNTS_MESSAGES_FROM_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_MESSAGES_ACCOUNTS_MESSAGES_TO_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_MESSAGES_PRIMARY);
    }
    ...
    public List<ForeignKey<AccountsMessagesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsMessagesRecord, ?>>asList(Keys.ACCOUNTS_MESSAGES_FROM_ACCOUNTS, Keys.ACCOUNTS_MESSAGES_TO_ACCOUNTS);
    }
