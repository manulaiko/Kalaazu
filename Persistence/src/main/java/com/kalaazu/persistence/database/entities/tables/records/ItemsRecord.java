...
public class ItemsRecord extends UpdatableRecordImpl<ItemsRecord> implements Record9<Short, String, Byte, String, Integer, Byte, Byte, Byte, Byte> {
    ...
    @Override
    public ItemsRecord values(Short value1, String value2, Byte value3, String value4, Integer value5, Byte value6, Byte value7, Byte value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ItemsRecord(Short id, String name, Byte category, String description, Integer price, Byte type, Byte isElite, Byte isEvent, Byte isBuyable) {
        super(Items.ITEMS);
