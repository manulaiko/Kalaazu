...
public class AccountsSkills extends TableImpl<AccountsSkillsRecord> {
     ...
     */
    public final TableField<AccountsSkillsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_skills.accounts_id</code>. Account ID.
     */
    public final TableField<AccountsSkillsRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Account ID.");

    /**
     * The column <code>kalaazu.accounts_skills.skilltree_skills_id</code>. Skill ID.
     */
    public final TableField<AccountsSkillsRecord, Byte> SKILLTREE_SKILLS_ID = createField(DSL.name("skilltree_skills_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "Skill ID.");

    /**
     * The column <code>kalaazu.accounts_skills.skilltree_levels_id</code>. Skill level.
     */
    public final TableField<AccountsSkillsRecord, Short> SKILLTREE_LEVELS_ID = createField(DSL.name("skilltree_levels_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "Skill level.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_SKILLS_ACCOUNTS_SKILLS_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_SKILLS_ACCOUNTS_SKILLS_SKILLTREE_LEVELS, Indexes.ACCOUNTS_SKILLS_ACCOUNTS_SKILLS_SKILLTREE_SKILLS, Indexes.ACCOUNTS_SKILLS_PRIMARY);
    }
    ...
    public List<ForeignKey<AccountsSkillsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsSkillsRecord, ?>>asList(Keys.ACCOUNTS_SKILLS_ACCOUNTS, Keys.ACCOUNTS_SKILLS_SKILLTREE_SKILLS, Keys.ACCOUNTS_SKILLS_SKILLTREE_LEVELS);
    }
