...
public class MapsPortals extends TableImpl<MapsPortalsRecord> {
     ...
     */
    public final TableField<MapsPortalsRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.maps_portals.levels_id</code>.
     */
    public final TableField<MapsPortalsRecord, Byte> LEVELS_ID = createField(DSL.name("levels_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>kalaazu.maps_portals.maps_id</code>.
     */
    public final TableField<MapsPortalsRecord, Byte> MAPS_ID = createField(DSL.name("maps_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.maps_portals.position</code>. Position on map.
     */
    public final TableField<MapsPortalsRecord, Long> POSITION = createField(DSL.name("position"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "Position on map.");

    /**
     * The column <code>kalaazu.maps_portals.target_maps_id</code>.
     */
    public final TableField<MapsPortalsRecord, Byte> TARGET_MAPS_ID = createField(DSL.name("target_maps_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.maps_portals.target_position</code>. Target position.
     */
    public final TableField<MapsPortalsRecord, Long> TARGET_POSITION = createField(DSL.name("target_position"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "Target position.");

    /**
     * The column <code>kalaazu.maps_portals.is_visible</code>.
     */
    public final TableField<MapsPortalsRecord, Byte> IS_VISIBLE = createField(DSL.name("is_visible"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>kalaazu.maps_portals.is_working</code>.
     */
    public final TableField<MapsPortalsRecord, Byte> IS_WORKING = createField(DSL.name("is_working"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>kalaazu.maps_portals.gfx</code>.
     */
    public final TableField<MapsPortalsRecord, Byte> GFX = createField(DSL.name("gfx"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MAPS_PORTALS_MAPS_PORTALS_LEVELS_ID_IDX, Indexes.MAPS_PORTALS_MAPS_PORTALS_MAPS_ID_IDX, Indexes.MAPS_PORTALS_MAPS_PORTALS_TARGET_MAPS_ID_IDX, Indexes.MAPS_PORTALS_PRIMARY);
    }
