...
import com.kalaazu.persistence.database.records.ShipsRecord;
import org.jooq.*;
...
public class Ships extends TableImpl<ShipsRecord> {
     ...
     */
    public final TableField<ShipsRecord, Byte> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ShipsRecord, Short> ITEMS_ID = createField(
            DSL.name("items_id"),
     ...
     */
    public final TableField<ShipsRecord, Integer> HEALTH = createField(
            DSL.name("health"),
     ...
     */
    public final TableField<ShipsRecord, Short> SPEED = createField(
            DSL.name("speed"),
            org.jooq.impl.SQLDataType.SMALLINT.nullable(false)
                                              .defaultValue(org.jooq.impl.DSL.field(
                                                      "0",
     ...
     */
    public final TableField<ShipsRecord, Short> CARGO = createField(
            DSL.name("cargo"),
            org.jooq.impl.SQLDataType.SMALLINT.nullable(false)
                                              .defaultValue(org.jooq.impl.DSL.field(
                                                      "100",
     ...
     */
    public final TableField<ShipsRecord, Short> BATTERIES = createField(
            DSL.name("batteries"),
            org.jooq.impl.SQLDataType.SMALLINT.nullable(false)
                                              .defaultValue(org.jooq.impl.DSL.field(
                                                      "1000",
     ...
     */
    public final TableField<ShipsRecord, Short> ROCKETS = createField(
            DSL.name("rockets"),
            org.jooq.impl.SQLDataType.SMALLINT.nullable(false)
                                              .defaultValue(org.jooq.impl.DSL.field(
                                                      "100",
     ...
     */
    public final TableField<ShipsRecord, Byte> LASERS = createField(
            DSL.name("lasers"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
     ...
     */
    public final TableField<ShipsRecord, Byte> HELLSTORMS = createField(
            DSL.name("hellstorms"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
     ...
     */
    public final TableField<ShipsRecord, Byte> GENERATORS = createField(
            DSL.name("generators"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
     ...
     */
    public final TableField<ShipsRecord, Byte> EXTRAS = createField(
            DSL.name("extras"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
     ...
     */
    public final TableField<ShipsRecord, Byte> GFX = createField(
            DSL.name("gfx"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.SHIPS_PRIMARY,
                Indexes.SHIPS_SHIPS_GFX_IDX,
                Indexes.SHIPS_SHIPS_ITEMS_ID_IDX
        );
    }
