...
public class SkylabModules extends TableImpl<SkylabModulesRecord> {
     ...
     */
    public final TableField<SkylabModulesRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.skylab_modules.name</code>. Module name.
     */
    public final TableField<SkylabModulesRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "Module name.");

    /**
     * The column <code>kalaazu.skylab_modules.production_factor</code>. Production factor.
     */
    public final TableField<SkylabModulesRecord, Byte> PRODUCTION_FACTOR = createField(DSL.name("production_factor"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("20", org.jooq.impl.SQLDataType.TINYINT)), this, "Production factor.");

    /**
     * The column <code>kalaazu.skylab_modules.production_base</code>. Production base.
     */
    public final TableField<SkylabModulesRecord, Short> PRODUCTION_BASE = createField(DSL.name("production_base"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1000", org.jooq.impl.SQLDataType.SMALLINT)), this, "Production base.");

    /**
     * The column <code>kalaazu.skylab_modules.storage_factor</code>. Storage factor.
     */
    public final TableField<SkylabModulesRecord, Short> STORAGE_FACTOR = createField(DSL.name("storage_factor"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("50", org.jooq.impl.SQLDataType.SMALLINT)), this, "Storage factor.");

    /**
     * The column <code>kalaazu.skylab_modules.storage_base</code>. Storage base.
     */
    public final TableField<SkylabModulesRecord, Short> STORAGE_BASE = createField(DSL.name("storage_base"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("20000", org.jooq.impl.SQLDataType.SMALLINT)), this, "Storage base.");

    /**
     * The column <code>kalaazu.skylab_modules.upgrade_factor</code>. Upgrade costs factor.
     */
    public final TableField<SkylabModulesRecord, Byte> UPGRADE_FACTOR = createField(DSL.name("upgrade_factor"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("35", org.jooq.impl.SQLDataType.TINYINT)), this, "Upgrade costs factor.");

    /**
     * The column <code>kalaazu.skylab_modules.upgrade_base</code>. Upgrade costs base.
     */
    public final TableField<SkylabModulesRecord, Short> UPGRADE_BASE = createField(DSL.name("upgrade_base"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("5000", org.jooq.impl.SQLDataType.SMALLINT)), this, "Upgrade costs base.");

    /**
     * The column <code>kalaazu.skylab_modules.energy_factor</code>. Energy consumption factor.
     */
    public final TableField<SkylabModulesRecord, Byte> ENERGY_FACTOR = createField(DSL.name("energy_factor"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.TINYINT)), this, "Energy consumption factor.");

    /**
     * The column <code>kalaazu.skylab_modules.energy_base</code>. Energy consumption base.
     */
    public final TableField<SkylabModulesRecord, Byte> ENERGY_BASE = createField(DSL.name("energy_base"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.TINYINT)), this, "Energy consumption base.");
