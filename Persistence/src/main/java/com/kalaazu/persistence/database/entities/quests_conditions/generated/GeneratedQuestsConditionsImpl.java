...
public abstract class GeneratedQuestsConditionsImpl implements QuestsConditions {
    ...
    @Override
    public QuestsConditions setType(byte type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (this.getType() != thatQuestsConditions.getType()) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getQuestsConditionsId()));
