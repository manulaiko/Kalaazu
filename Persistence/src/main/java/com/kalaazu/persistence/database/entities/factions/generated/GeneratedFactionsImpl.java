...
public abstract class GeneratedFactionsImpl implements Factions {
    ...
    @Override
    public Factions setIsPublic(int isPublic) {
    ...
    @Override
    public Factions setLowMapsPosition(long lowMapsPosition) {
    ...
    @Override
    public Factions setHighMapsPosition(long highMapsPosition) {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getLowMapsPosition() != thatFactions.getLowMapsPosition()) {
            return false;
        }
        if (this.getHighMapsId() != thatFactions.getHighMapsId()) {
            return false;
        }
        if (this.getHighMapsPosition() != thatFactions.getHighMapsPosition()) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Long.hashCode(getLowMapsPosition());
        hash = 31 * hash + Byte.hashCode(getHighMapsId());
        hash = 31 * hash + Long.hashCode(getHighMapsPosition());
        return hash;
    }
}