...
public abstract class GeneratedClansBattlestationsImpl implements ClansBattlestations {
    ...
    @Override
    public ClansBattlestations setClansId(int clansId) {
    ...
    @Override
    public ClansBattlestations setPosition(long position) {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getPosition() != thatClansBattlestations.getPosition()) {
            return false;
        }
