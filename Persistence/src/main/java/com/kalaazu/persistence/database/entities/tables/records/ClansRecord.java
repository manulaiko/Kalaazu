...
public class ClansRecord extends UpdatableRecordImpl<ClansRecord> implements Record8<Integer, Integer, Byte, String, String, String, String, Byte> {
    ...
    @Override
    public ClansRecord values(Integer value1, Integer value2, Byte value3, String value4, String value5, String value6, String value7, Byte value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ClansRecord(Integer id, Integer accountsId, Byte factionsId, String tag, String name, String description, String logo, Byte status) {
        super(Clans.CLANS);
