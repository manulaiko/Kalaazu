...
import com.kalaazu.persistence.database.records.ItemsRecord;
import org.jooq.*;
...
public class Items extends TableImpl<ItemsRecord> {
     ...
     */
    public final TableField<ItemsRecord, Short> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ItemsRecord, String> NAME = createField(
            DSL.name("name"),
     ...
     */
    public final TableField<ItemsRecord, Byte> CATEGORY = createField(
            DSL.name("category"),
     ...
     */
    public final TableField<ItemsRecord, String> DESCRIPTION = createField(
     ...
     */
    public final TableField<ItemsRecord, Integer> PRICE = createField(
            DSL.name("price"),
     ...
     */
    public final TableField<ItemsRecord, Byte> TYPE = createField(
            DSL.name("type"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
     ...
     */
    public final TableField<ItemsRecord, Byte> IS_ELITE = createField(
            DSL.name("is_elite"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
     ...
     */
    public final TableField<ItemsRecord, Byte> IS_EVENT = createField(
            DSL.name("is_event"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "0",
     ...
     */
    public final TableField<ItemsRecord, Byte> IS_BUYABLE = createField(
            DSL.name("is_buyable"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
