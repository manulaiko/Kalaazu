...
import com.kalaazu.persistence.database.records.SkilltreeLevelsRecord;
import org.jooq.*;
...
public class SkilltreeLevels extends TableImpl<SkilltreeLevelsRecord> {
     ...
     */
    public final TableField<SkilltreeLevelsRecord, Short> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<SkilltreeLevelsRecord, Byte> SKILLTREE_SKILLS_ID = createField(DSL.name(
            "skilltree_skills_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "The skill.");
    /**
     * The column <code>kalaazu.skilltree_levels.levels_id</code>. Level to upgrade the skill.
     */
    public final TableField<SkilltreeLevelsRecord, Byte> LEVELS_ID = createField(
            DSL.name("levels_id"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false),
            this,
            "Level to upgrade the skill."
    );
    /**
     * The column <code>kalaazu.skilltree_levels.credits</code>. Credits needed to upgrade this skill.
     */
    public final TableField<SkilltreeLevelsRecord, Integer> CREDITS = createField(
            DSL.name("credits"),
            ...
            this,
            "Credits needed to upgrade this skill."
    );
    /**
     * The column <code>kalaazu.skilltree_levels.seprom</code>. Seprom needed to upgrade this skill.
     */
    public final TableField<SkilltreeLevelsRecord, Short> SEPROM = createField(
            DSL.name("seprom"),
            ...
            this,
            "Seprom needed to upgrade this skill."
    );
    /**
     * The column <code>kalaazu.skilltree_levels.points</code>. Research points needed to upgrade this skill.
     */
    public final TableField<SkilltreeLevelsRecord, Byte> POINTS = createField(
            DSL.name("points"),
            org.jooq.impl.SQLDataType.TINYINT.nullable(false)
                                             .defaultValue(org.jooq.impl.DSL.field(
                                                     "1",
            ...
            this,
            "Research points needed to upgrade this skill."
    );
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.SKILLTREE_LEVELS_PRIMARY,
                Indexes.SKILLTREE_LEVELS_SKILLTREE_LEVELS_LEVELS,
                Indexes.SKILLTREE_LEVELS_SKILLTREE_LEVELS_SKILLS
        );
    }
    ...
    public List<ForeignKey<SkilltreeLevelsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<SkilltreeLevelsRecord, ?>>asList(
                Keys.SKILLTREE_LEVELS_SKILLS,
                Keys.SKILLTREE_LEVELS_LEVELS
        );
    }
