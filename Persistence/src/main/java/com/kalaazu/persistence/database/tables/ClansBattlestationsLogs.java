...
import com.kalaazu.persistence.database.records.ClansBattlestationsLogsRecord;
import org.jooq.*;
...
public class ClansBattlestationsLogs extends TableImpl<ClansBattlestationsLogsRecord> {
     ...
     */
    public final TableField<ClansBattlestationsLogsRecord, Integer> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ClansBattlestationsLogsRecord, Integer> CLANS_ID = createField(
            DSL.name("clans_id"),
     ...
     */
    public final TableField<ClansBattlestationsLogsRecord, Byte> CLANS_BATTLESTATIONS_ID = createField(DSL.name(
            "clans_battlestations_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");
    /**
     * The column <code>kalaazu.clans_battlestations_logs.message</code>.
     */
    public final TableField<ClansBattlestationsLogsRecord, String> MESSAGE = createField(
            DSL.name("message"),
     ...
     */
    public final TableField<ClansBattlestationsLogsRecord, Timestamp> DATE = createField(
            DSL.name("date"),
    ...
    public <O extends Record> ClansBattlestationsLogs(
            Table<O> child, ForeignKey<O, ClansBattlestationsLogsRecord> key
    ) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.CLANS_BATTLESTATIONS_LOGS_CLANS_BATTLESTATIONS_LOGS_CLANS_BATTLESTATIONS_ID_IDX,
                Indexes.CLANS_BATTLESTATIONS_LOGS_CLANS_BATTLESTATIONS_LOGS_CLANS_ID_IDX,
                Indexes.CLANS_BATTLESTATIONS_LOGS_PRIMARY
        );
    }
    ...
    public List<ForeignKey<ClansBattlestationsLogsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ClansBattlestationsLogsRecord, ?>>asList(
                Keys.CLANS_BATTLESTATIONS_LOGS_CLANS,
                Keys.CLANS_BATTLESTATIONS_LOGS_CLANS_BATTLESTATIONS
        );
    }
