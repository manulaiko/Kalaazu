...
public class TechfactoryItems extends TableImpl<TechfactoryItemsRecord> {
     ...
     */
    public final TableField<TechfactoryItemsRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.techfactory_items.name</code>. Item name.
     */
    public final TableField<TechfactoryItemsRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "Item name.");

    /**
     * The column <code>kalaazu.techfactory_items.description</code>. Item description.
     */
    public final TableField<TechfactoryItemsRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "Item description.");

    /**
     * The column <code>kalaazu.techfactory_items.effect</code>. Effect description.
     */
    public final TableField<TechfactoryItemsRecord, String> EFFECT = createField(DSL.name("effect"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "Effect description.");

    /**
     * The column <code>kalaazu.techfactory_items.duration</code>. Seconds the effect is active.
     */
    public final TableField<TechfactoryItemsRecord, Short> DURATION = createField(DSL.name("duration"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("900", org.jooq.impl.SQLDataType.SMALLINT)), this, "Seconds the effect is active.");

    /**
     * The column <code>kalaazu.techfactory_items.cooldown</code>. Seconds the effect takes to cooldown.
     */
    public final TableField<TechfactoryItemsRecord, Short> COOLDOWN = createField(DSL.name("cooldown"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("900", org.jooq.impl.SQLDataType.SMALLINT)), this, "Seconds the effect takes to cooldown.");

    /**
     * The column <code>kalaazu.techfactory_items.time</code>. Seconds it takes to produce the item.
     */
    public final TableField<TechfactoryItemsRecord, Integer> TIME = createField(DSL.name("time"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Seconds it takes to produce the item.");

    /**
     * The column <code>kalaazu.techfactory_items.free_production</code>. Free production costs.
     */
    public final TableField<TechfactoryItemsRecord, Short> FREE_PRODUCTION = createField(DSL.name("free_production"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "Free production costs.");

    /**
     * The column <code>kalaazu.techfactory_items.instant_production</code>. Instant production costs.
     */
    public final TableField<TechfactoryItemsRecord, Short> INSTANT_PRODUCTION = createField(DSL.name("instant_production"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "Instant production costs.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TECHFACTORY_ITEMS_PRIMARY, Indexes.TECHFACTORY_ITEMS_TECHFACTORY_ITEMS_NAME_IDX);
    }
