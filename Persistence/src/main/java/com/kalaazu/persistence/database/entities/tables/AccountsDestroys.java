...
public class AccountsDestroys extends TableImpl<AccountsDestroysRecord> {
     ...
     */
    public final TableField<AccountsDestroysRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_destroys.accounts_id</code>.
     */
    public final TableField<AccountsDestroysRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_destroys.ships_id</code>.
     */
    public final TableField<AccountsDestroysRecord, Byte> SHIPS_ID = createField(DSL.name("ships_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_destroys.points</code>. Rank points received for destroying this ship.
     */
    public final TableField<AccountsDestroysRecord, Short> POINTS = createField(DSL.name("points"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "Rank points received for destroying this ship.");

    /**
     * The column <code>kalaazu.accounts_destroys.amount</code>. Times this ship has been destroyed
     */
    public final TableField<AccountsDestroysRecord, Short> AMOUNT = createField(DSL.name("amount"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "Times this ship has been destroyed");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_DESTROYS_ACCOUNTS_DESTROYS_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_DESTROYS_PRIMARY);
    }
    ...
    public List<UniqueKey<AccountsDestroysRecord>> getKeys() {
        return Arrays.<UniqueKey<AccountsDestroysRecord>>asList(Keys.KEY_ACCOUNTS_DESTROYS_PRIMARY, Keys.KEY_ACCOUNTS_DESTROYS_ACCOUNTS_DESTROYS_ACCOUNTS_ID_IDX);
    }
