...
public class AccountsRankings extends TableImpl<AccountsRankingsRecord> {
     ...
     */
    public final TableField<AccountsRankingsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_rankings.accounts_id</code>. Account ID.
     */
    public final TableField<AccountsRankingsRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Account ID.");

    /**
     * The column <code>kalaazu.accounts_rankings.points</code>. Points in the ranking.
     */
    public final TableField<AccountsRankingsRecord, Integer> POINTS = createField(DSL.name("points"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Points in the ranking.");

    /**
     * The column <code>kalaazu.accounts_rankings.best_points</code>. Biggest amount of rank points ever achieved.
     */
    public final TableField<AccountsRankingsRecord, Integer> BEST_POINTS = createField(DSL.name("best_points"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Biggest amount of rank points ever achieved.");

    /**
     * The column <code>kalaazu.accounts_rankings.destroyed_allies</code>. Destroyed allies.
     */
    public final TableField<AccountsRankingsRecord, Short> DESTROYED_ALLIES = createField(DSL.name("destroyed_allies"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "Destroyed allies.");

    /**
     * The column <code>kalaazu.accounts_rankings.destroyed_phoenix</code>. Destroyed phoenix.
     */
    public final TableField<AccountsRankingsRecord, Short> DESTROYED_PHOENIX = createField(DSL.name("destroyed_phoenix"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "Destroyed phoenix.");

    /**
     * The column <code>kalaazu.accounts_rankings.destroyed_times</code>. Amount of times the account has been destroyed.
     */
    public final TableField<AccountsRankingsRecord, Short> DESTROYED_TIMES = createField(DSL.name("destroyed_times"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "Amount of times the account has been destroyed.");
     ...
     */
    public final TableField<AccountsRankingsRecord, Short> DESTROYED_RADIATION = createField(DSL.name("destroyed_radiation"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "Amount of times the account has been destroyed by the radiation zone.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_RANKINGS_ACCOUNTS_RANKING_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_RANKINGS_PRIMARY);
    }
    ...
    public List<UniqueKey<AccountsRankingsRecord>> getKeys() {
        return Arrays.<UniqueKey<AccountsRankingsRecord>>asList(Keys.KEY_ACCOUNTS_RANKINGS_PRIMARY, Keys.KEY_ACCOUNTS_RANKINGS_ACCOUNTS_RANKING_ACCOUNTS_ID_IDX);
    }
