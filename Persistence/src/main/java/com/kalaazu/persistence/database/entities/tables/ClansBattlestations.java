...
public class ClansBattlestations extends TableImpl<ClansBattlestationsRecord> {
     ...
     */
    public final TableField<ClansBattlestationsRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.clans_battlestations.clans_id</code>. Owner of the CBS.
     */
    public final TableField<ClansBattlestationsRecord, Integer> CLANS_ID = createField(DSL.name("clans_id"), org.jooq.impl.SQLDataType.INTEGER, this, "Owner of the CBS.");

    /**
     * The column <code>kalaazu.clans_battlestations.maps_id</code>. Map of the CBS.
     */
    public final TableField<ClansBattlestationsRecord, Byte> MAPS_ID = createField(DSL.name("maps_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "Map of the CBS.");

    /**
     * The column <code>kalaazu.clans_battlestations.name</code>.
     */
    public final TableField<ClansBattlestationsRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>kalaazu.clans_battlestations.position</code>. Position on map.
     */
    public final TableField<ClansBattlestationsRecord, Long> POSITION = createField(DSL.name("position"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "Position on map.");

    /**
     * The column <code>kalaazu.clans_battlestations.date</code>. Date when the CBS was build.
     */
    public final TableField<ClansBattlestationsRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "Date when the CBS was build.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CLANS_BATTLESTATIONS_CLANS_BATTLESTATIONS_CLANS_ID_IDX, Indexes.CLANS_BATTLESTATIONS_CLANS_BATTLESTATIONS_MAPS_ID_IDX, Indexes.CLANS_BATTLESTATIONS_PRIMARY);
    }
    ...
    public List<ForeignKey<ClansBattlestationsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ClansBattlestationsRecord, ?>>asList(Keys.CLANS_BATTLESTATIONS_CLANS, Keys.CLANS_BATTLESTATIONS_MAPS);
    }
