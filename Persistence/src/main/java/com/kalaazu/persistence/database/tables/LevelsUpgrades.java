...
import com.kalaazu.persistence.database.records.LevelsUpgradesRecord;
import org.jooq.*;
...
public class LevelsUpgrades extends TableImpl<LevelsUpgradesRecord> {
     ...
     */
    public final TableField<LevelsUpgradesRecord, Integer> ID = createField(DSL.name("id"),
                                                                            org.jooq.impl.SQLDataType.INTEGER.nullable(
                                                                                    false).identity(true),
                                                                            this,
                                                                            "Primary Key."
    );
     ...
     */
    public final TableField<LevelsUpgradesRecord, Byte> LEVELS_ID = createField(DSL.name("levels_id"),
                                                                                org.jooq.impl.SQLDataType.TINYINT.nullable(
                                                                                        false),
                                                                                this,
                                                                                "The upgrade level."
    );
     ...
     */
    public final TableField<LevelsUpgradesRecord, Byte> PROBABILITY = createField(DSL.name("probability"),
                                                                                  org.jooq.impl.SQLDataType.TINYINT.nullable(
                                                                                          false)
                                                                                                                   .defaultValue(
                                                                                                                           org.jooq.impl.DSL
     ...
     */
    public final TableField<LevelsUpgradesRecord, Integer> CREDITS = createField(DSL.name("credits"),
                                                                                 org.jooq.impl.SQLDataType.INTEGER.nullable(
                                                                                         false)
                                                                                                                  .defaultValue(
                                                                                                                          org.jooq.impl.DSL
                                                                                 ...
                                                                                 this,
                                                                                 "Credits needed to upgrade to this level with given probability."
    );
    /**
     * The column <code>kalaazu.levels_upgrades.uridium</code>. Uridium needed to upgrade to this level with given probability.
     */
    public final TableField<LevelsUpgradesRecord, Short> URIDIUM = createField(DSL.name("uridium"),
                                                                               ...
                                                                               this,
                                                                               "Uridium needed to upgrade to this level with given probability."
    );
