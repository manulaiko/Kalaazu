...
public class AccountsTechfactoriesRecord extends UpdatableRecordImpl<AccountsTechfactoriesRecord> implements Record5<Integer, Integer, Integer, Byte, Byte> {
    ...
    @Override
    public AccountsTechfactoriesRecord values(Integer value1, Integer value2, Integer value3, Byte value4, Byte value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsTechfactoriesRecord(Integer id, Integer accountsId, Integer slotUnlockPrice, Byte slotUnlockFactor, Byte slots) {
        super(AccountsTechfactories.ACCOUNTS_TECHFACTORIES);
