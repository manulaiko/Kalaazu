...
public class Ranks extends TableImpl<RanksRecord> {
     ...
     */
    public final TableField<RanksRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.ranks.name</code>.
     */
    public final TableField<RanksRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>kalaazu.ranks.percentaje</code>.
     */
    public final TableField<RanksRecord, Double> PERCENTAJE = createField(DSL.name("percentaje"), org.jooq.impl.SQLDataType.FLOAT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.FLOAT)), this, "");

    /**
     * The column <code>kalaazu.ranks.is_public</code>.
     */
    public final TableField<RanksRecord, Byte> IS_PUBLIC = createField(DSL.name("is_public"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");
