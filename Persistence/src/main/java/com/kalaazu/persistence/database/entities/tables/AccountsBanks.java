...
public class AccountsBanks extends TableImpl<AccountsBanksRecord> {
     ...
     */
    public final TableField<AccountsBanksRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_banks.accounts_id</code>.
     */
    public final TableField<AccountsBanksRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.accounts_banks.credits</code>. Credits available in the bank.
     */
    public final TableField<AccountsBanksRecord, Long> CREDITS = createField(DSL.name("credits"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "Credits available in the bank.");

    /**
     * The column <code>kalaazu.accounts_banks.uridium</code>. Uridium available in the bank.
     */
    public final TableField<AccountsBanksRecord, Long> URIDIUM = createField(DSL.name("uridium"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "Uridium available in the bank.");

    /**
     * The column <code>kalaazu.accounts_banks.tax_credits</code>. Tax rate for credits.
     */
    public final TableField<AccountsBanksRecord, Byte> TAX_CREDITS = createField(DSL.name("tax_credits"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("5", org.jooq.impl.SQLDataType.TINYINT)), this, "Tax rate for credits.");

    /**
     * The column <code>kalaazu.accounts_banks.tax_uridium</code>. Tax rate for uridium.
     */
    public final TableField<AccountsBanksRecord, Byte> TAX_URIDIUM = createField(DSL.name("tax_uridium"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Tax rate for uridium.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_BANKS_ACCOUNTS_BANKS_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_BANKS_PRIMARY);
    }
    ...
    public List<UniqueKey<AccountsBanksRecord>> getKeys() {
        return Arrays.<UniqueKey<AccountsBanksRecord>>asList(Keys.KEY_ACCOUNTS_BANKS_PRIMARY, Keys.KEY_ACCOUNTS_BANKS_ACCOUNTS_BANKS_ACCOUNTS_ID_IDX);
    }
