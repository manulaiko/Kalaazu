...
public class AccountsSkylabsRecord extends UpdatableRecordImpl<AccountsSkylabsRecord> implements Record6<Integer, Integer, Byte, Byte, Integer, Timestamp> {
    ...
    @Override
    public AccountsSkylabsRecord values(Integer value1, Integer value2, Byte value3, Byte value4, Integer value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsSkylabsRecord(Integer id, Integer accountsId, Byte skylabModulesId, Byte levelsId, Integer space, Timestamp upgrade) {
        super(AccountsSkylabs.ACCOUNTS_SKYLABS);
