...
import com.kalaazu.persistence.database.entities.accounts.AccountsManager;
import com.kalaazu.persistence.database.entities.accounts_banks.AccountsBanksManager;
...
import com.kalaazu.persistence.database.entities.accounts_configurations.AccountsConfigurationsManager;
...
import com.kalaazu.persistence.database.entities.accounts_destroys.AccountsDestroysManager;
import com.kalaazu.persistence.database.entities.accounts_drones.AccountsDronesManager;
import com.kalaazu.persistence.database.entities.accounts_galaxygates.AccountsGalaxygatesManager;
import com.kalaazu.persistence.database.entities.accounts_hangars.AccountsHangarsManager;
import com.kalaazu.persistence.database.entities.accounts_history.AccountsHistoryManager;
import com.kalaazu.persistence.database.entities.accounts_items.AccountsItemsManager;
import com.kalaazu.persistence.database.entities.accounts_messages.AccountsMessagesManager;
...
import com.kalaazu.persistence.database.entities.accounts_rankings.AccountsRankingsManager;
import com.kalaazu.persistence.database.entities.accounts_ships.AccountsShipsManager;
...
import com.kalaazu.persistence.database.entities.accounts_techfactories.AccountsTechfactoriesManager;
import com.kalaazu.persistence.database.entities.accounts_techfactory_items.AccountsTechfactoryItemsManager;
...
import com.kalaazu.persistence.database.entities.clans_banks_logs.ClansBanksLogsManager;
import com.kalaazu.persistence.database.entities.clans_battlestations.ClansBattlestationsManager;
...
import com.kalaazu.persistence.database.entities.clans_news.ClansNewsManager;
import com.kalaazu.persistence.database.entities.clans_ranking.ClansRankingManager;
import com.kalaazu.persistence.database.entities.clans_roles.ClansRolesManager;
import com.kalaazu.persistence.database.entities.clans_roles_permissions.ClansRolesPermissionsManager;
import com.kalaazu.persistence.database.entities.collectables.CollectablesManager;
...
import com.kalaazu.persistence.database.entities.galaxygates.GalaxygatesManager;
import com.kalaazu.persistence.database.entities.galaxygates_gg_spins.GalaxygatesGgSpinsManager;
import com.kalaazu.persistence.database.entities.galaxygates_gg_waves.GalaxygatesGgWavesManager;
...
import com.kalaazu.persistence.database.entities.galaxygates_stages_spawns.GalaxygatesStagesSpawnsManager;
import com.kalaazu.persistence.database.entities.galaxygates_waves.GalaxygatesWavesManager;
import com.kalaazu.persistence.database.entities.invitation_codes.InvitationCodesManager;
import com.kalaazu.persistence.database.entities.invitation_codes_redeem_logs.InvitationCodesRedeemLogsManager;
import com.kalaazu.persistence.database.entities.items.ItemsManager;
import com.kalaazu.persistence.database.entities.levels.LevelsManager;
import com.kalaazu.persistence.database.entities.levels_upgrades.LevelsUpgradesManager;
import com.kalaazu.persistence.database.entities.maps.MapsManager;
import com.kalaazu.persistence.database.entities.maps_npcs.MapsNpcsManager;
import com.kalaazu.persistence.database.entities.maps_portals.MapsPortalsManager;
...
import com.kalaazu.persistence.database.entities.news.NewsManager;
import com.kalaazu.persistence.database.entities.npcs.NpcsManager;
...
import com.kalaazu.persistence.database.entities.rewards.RewardsManager;
...
import com.kalaazu.persistence.database.entities.rewards_ships.RewardsShipsManager;
...
import com.kalaazu.persistence.database.entities.ships.ShipsManager;
import com.kalaazu.persistence.database.entities.skilltree_levels.SkilltreeLevelsManager;
...
import com.kalaazu.persistence.database.entities.skylab_modules.SkylabModulesManager;
import com.kalaazu.persistence.database.entities.techfactory_costs.TechfactoryCostsManager;
import com.kalaazu.persistence.database.entities.techfactory_drones.TechfactoryDronesManager;
import com.kalaazu.persistence.database.entities.techfactory_items.TechfactoryItemsManager;
import com.kalaazu.persistence.database.entities.trade_items.TradeItemsManager;
...
import com.kalaazu.persistence.database.entities.vouchers_redeem_logs.VouchersRedeemLogsManager;
import com.kalaazu.persistence.database.generated.GeneratedKalaazuApplicationImpl;
