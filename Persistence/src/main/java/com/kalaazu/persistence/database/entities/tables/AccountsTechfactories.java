...
public class AccountsTechfactories extends TableImpl<AccountsTechfactoriesRecord> {
     ...
     */
    public final TableField<AccountsTechfactoriesRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_techfactories.accounts_id</code>. Account ID.
     */
    public final TableField<AccountsTechfactoriesRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Account ID.");

    /**
     * The column <code>kalaazu.accounts_techfactories.slot_unlock_price</code>. Price for unlocking a slot.
     */
    public final TableField<AccountsTechfactoriesRecord, Integer> SLOT_UNLOCK_PRICE = createField(DSL.name("slot_unlock_price"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("50000", org.jooq.impl.SQLDataType.INTEGER)), this, "Price for unlocking a slot.");

    /**
     * The column <code>kalaazu.accounts_techfactories.slot_unlock_factor</code>. Factor for unlocking a slot.
     */
    public final TableField<AccountsTechfactoriesRecord, Byte> SLOT_UNLOCK_FACTOR = createField(DSL.name("slot_unlock_factor"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("2", org.jooq.impl.SQLDataType.TINYINT)), this, "Factor for unlocking a slot.");

    /**
     * The column <code>kalaazu.accounts_techfactories.slots</code>. Unlocked slots.
     */
    public final TableField<AccountsTechfactoriesRecord, Byte> SLOTS = createField(DSL.name("slots"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "Unlocked slots.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_TECHFACTORIES_ACCOUNTS_TECHFACTORIES_ACCOUNTS, Indexes.ACCOUNTS_TECHFACTORIES_PRIMARY);
    }
