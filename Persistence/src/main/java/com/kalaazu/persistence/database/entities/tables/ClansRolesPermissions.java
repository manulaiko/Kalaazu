...
public class ClansRolesPermissions extends TableImpl<ClansRolesPermissionsRecord> {
     ...
     */
    public final TableField<ClansRolesPermissionsRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.clans_roles_permissions.clans_roles_id</code>.
     */
    public final TableField<ClansRolesPermissionsRecord, Integer> CLANS_ROLES_ID = createField(DSL.name("clans_roles_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.clans_roles_permissions.permissions_id</code>.
     */
    public final TableField<ClansRolesPermissionsRecord, Byte> PERMISSIONS_ID = createField(DSL.name("permissions_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>kalaazu.clans_roles_permissions.is_enabled</code>. Enabled value, null = inherited
     */
    public final TableField<ClansRolesPermissionsRecord, Byte> IS_ENABLED = createField(DSL.name("is_enabled"), org.jooq.impl.SQLDataType.TINYINT, this, "Enabled value, null = inherited");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CLANS_ROLES_PERMISSIONS_CLANS_ROLES_PERMISSIONS_CLANS_ROLES_ID_IDX, Indexes.CLANS_ROLES_PERMISSIONS_CLANS_ROLES_PERMISSIONS_PERMISSIONS_ID_IDX, Indexes.CLANS_ROLES_PERMISSIONS_PRIMARY);
    }
    ...
    public List<ForeignKey<ClansRolesPermissionsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ClansRolesPermissionsRecord, ?>>asList(Keys.CLANS_ROLES_PERMISSIONS_CLANS_ROLES, Keys.CLANS_ROLES_PERMISSIONS_PERMISSIONS);
    }
