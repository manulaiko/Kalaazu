...
public abstract class GeneratedAccountsMessagesImpl implements AccountsMessages {
    ...
    @Override
    public AccountsMessages setFromStatus(byte fromStatus) {
    ...
    @Override
    public AccountsMessages setToStatus(byte toStatus) {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getFromStatus() != thatAccountsMessages.getFromStatus()) {
            return false;
        }
        if (this.getToAccountsId() != thatAccountsMessages.getToAccountsId()) {
            return false;
        }
        if (this.getToStatus() != thatAccountsMessages.getToStatus()) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Byte.hashCode(getFromStatus());
        hash = 31 * hash + Integer.hashCode(getToAccountsId());
        hash = 31 * hash + Byte.hashCode(getToStatus());
