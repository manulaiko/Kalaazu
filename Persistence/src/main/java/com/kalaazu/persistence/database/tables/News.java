...
import com.kalaazu.persistence.database.records.NewsRecord;
import org.jooq.*;
...
public class News extends TableImpl<NewsRecord> {
     ...
     */
    public final TableField<NewsRecord, Short> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<NewsRecord, Timestamp> DATE = createField(
            DSL.name("date"),
     ...
     */
    public final TableField<NewsRecord, String> IMAGE = createField(
            DSL.name("image"),
     ...
     */
    public final TableField<NewsRecord, String> TITLE = createField(
            DSL.name("title"),
            org.jooq.impl.SQLDataType.VARCHAR(255)
                                     .nullable(false)
                                     .defaultValue(org.jooq.impl.DSL.field(
     ...
     */
    public final TableField<NewsRecord, String> TEASER = createField(
            DSL.name("teaser"),
            org.jooq.impl.SQLDataType.VARCHAR(255)
                                     .nullable(false)
                                     .defaultValue(org.jooq.impl.DSL.field(
     ...
     */
    public final TableField<NewsRecord, String> TEXT = createField(
            DSL.name("text"),
