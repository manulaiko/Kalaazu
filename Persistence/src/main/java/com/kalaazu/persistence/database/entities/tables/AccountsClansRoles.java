...
public class AccountsClansRoles extends TableImpl<AccountsClansRolesRecord> {
     ...
     */
    public final TableField<AccountsClansRolesRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.accounts_clans_roles.accounts_id</code>. Account ID.
     */
    public final TableField<AccountsClansRolesRecord, Integer> ACCOUNTS_ID = createField(DSL.name("accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Account ID.");

    /**
     * The column <code>kalaazu.accounts_clans_roles.clans_roles_id</code>. Role ID.
     */
    public final TableField<AccountsClansRolesRecord, Integer> CLANS_ROLES_ID = createField(DSL.name("clans_roles_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Role ID.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACCOUNTS_CLANS_ROLES_ACCOUNTS_CLANS_ROLES_ACCOUNTS_ID_IDX, Indexes.ACCOUNTS_CLANS_ROLES_ACCOUNTS_CLANS_ROLES_CLANS_ROLES_ID_IDX, Indexes.ACCOUNTS_CLANS_ROLES_PRIMARY);
    }
    ...
    public List<ForeignKey<AccountsClansRolesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsClansRolesRecord, ?>>asList(Keys.ACCOUNTS_CLANS_ROLES_ACCOUNTS, Keys.ACCOUNTS_CLANS_ROLES_CLANS_ROLES);
    }
