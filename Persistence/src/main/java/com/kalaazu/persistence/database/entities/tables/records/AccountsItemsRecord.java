...
public class AccountsItemsRecord extends UpdatableRecordImpl<AccountsItemsRecord> implements Record6<Integer, Short, Integer, Byte, Timestamp, Long> {
    ...
    @Override
    public AccountsItemsRecord values(Integer value1, Short value2, Integer value3, Byte value4, Timestamp value5, Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsItemsRecord(Integer id, Short itemsId, Integer accountsId, Byte levelsId, Timestamp date, Long amount) {
        super(AccountsItems.ACCOUNTS_ITEMS);
