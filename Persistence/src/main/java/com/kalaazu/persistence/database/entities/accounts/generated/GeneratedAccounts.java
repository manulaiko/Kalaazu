...
public interface GeneratedAccounts {
     ...
     */
    IntForeignKeyField<Accounts, Integer, AccountsHangars> ACCOUNTS_HANGARS_ID = IntForeignKeyField.create(
     ...
     * @return this Accounts instance
     */
    Accounts setAccountsHangarsId(int accountsHangarsId);
     ...
     * @return this Accounts instance
     */
    Accounts setClansId(int clansId);
