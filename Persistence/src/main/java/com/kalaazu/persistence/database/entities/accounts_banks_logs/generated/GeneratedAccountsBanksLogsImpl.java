...
public abstract class GeneratedAccountsBanksLogsImpl implements AccountsBanksLogs {
    ...
    @Override
    public AccountsBanksLogs setType(byte type) {
        this.type = type;
        return this;
    }
    ...
    @Override
    public AccountsBanksLogs setCurrency(byte currency) {
        this.currency = currency;
        return this;
    }

    @Override
    public AccountsBanksLogs setAccountsBanksId(int accountsBanksId) {
    ...
    public Optional<AccountsBanks> findAccountsBanksId(Manager<AccountsBanks> foreignManager) {
        if (getAccountsBanksId().isPresent()) {
            return foreignManager.stream()
                                 .filter(AccountsBanks.ID.equal(getAccountsBanksId().get()))
                                 .findAny();
        } else {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getType() != thatAccountsBanksLogs.getType()) {
            return false;
        }
        if (this.getAmount() != thatAccountsBanksLogs.getAmount()) {
            return false;
        }
        if (this.getCurrency() != thatAccountsBanksLogs.getCurrency()) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getAccountsBanksId()));
        return hash;
    }
}