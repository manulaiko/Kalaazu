...
public abstract class GeneratedClansMessagesImpl implements ClansMessages {
    ...
    @Override
    public ClansMessages setFromStatus(byte fromStatus) {
    ...
    @Override
    public ClansMessages setToStatus(byte toStatus) {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getFromStatus() != thatClansMessages.getFromStatus()) {
            return false;
        }
        if (!Objects.equals(this.getToAccountsId(), thatClansMessages.getToAccountsId())) {
            return false;
        }
        if (this.getToStatus() != thatClansMessages.getToStatus()) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getToAccountsId()));
