...
import com.kalaazu.persistence.database.records.ClansRecord;
import org.jooq.*;
...
public class Clans extends TableImpl<ClansRecord> {
     ...
     */
    public final TableField<ClansRecord, Integer> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<ClansRecord, Integer> ACCOUNTS_ID = createField(
     ...
     */
    public final TableField<ClansRecord, Byte> FACTIONS_ID = createField(
            DSL.name("factions_id"),
            org.jooq.impl.SQLDataType.TINYINT,
            this,
            "Clan affiliation faction."
    );
    /**
     * The column <code>kalaazu.clans.tag</code>. Name abbreviation.
     */
    public final TableField<ClansRecord, String> TAG = createField(
            DSL.name("tag"),
            org.jooq.impl.SQLDataType.VARCHAR(4)
                                     .nullable(false)
     ...
     */
    public final TableField<ClansRecord, String> NAME = createField(
            DSL.name("name"),
     ...
     */
    public final TableField<ClansRecord, String> DESCRIPTION = createField(
     ...
     */
    public final TableField<ClansRecord, String> LOGO = createField(
            DSL.name("logo"),
            org.jooq.impl.SQLDataType.VARCHAR(255)
                                     .nullable(false)
                                     .defaultValue(org.jooq.impl.DSL.field(
     ...
     */
    public final TableField<ClansRecord, Byte> STATUS = createField(
            DSL.name("status"),
            ...
            this,
            "0 = closed, 1 = recruiting, 2 = lvl10+, 3 = lvl16+, 4 = FE."
    );
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.CLANS_CLANS_ACCOUNTS_ID_IDX,
                Indexes.CLANS_CLANS_NAME_IDX,
                Indexes.CLANS_CLANS_TAG_IDX,
                Indexes.CLANS_PRIMARY
        );
    }
    ...
    public List<UniqueKey<ClansRecord>> getKeys() {
        return Arrays.<UniqueKey<ClansRecord>>asList(
                Keys.KEY_CLANS_PRIMARY,
                Keys.KEY_CLANS_CLANS_TAG_IDX,
                Keys.KEY_CLANS_CLANS_NAME_IDX
        );
    }
