...
public class AccountsMessagesRecord extends UpdatableRecordImpl<AccountsMessagesRecord> implements Record8<Integer, Integer, Byte, Integer, Byte, Timestamp, String, String> {
    ...
    @Override
    public AccountsMessagesRecord values(Integer value1, Integer value2, Byte value3, Integer value4, Byte value5, Timestamp value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsMessagesRecord(Integer id, Integer fromAccountsId, Byte fromStatus, Integer toAccountsId, Byte toStatus, Timestamp date, String title, String text) {
        super(AccountsMessages.ACCOUNTS_MESSAGES);
