...
public class Collectables extends TableImpl<CollectablesRecord> {
     ...
     */
    public final TableField<CollectablesRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.collectables.gfx</code>.
     */
    public final TableField<CollectablesRecord, Byte> GFX = createField(DSL.name("gfx"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>kalaazu.collectables.type</code>. 0 = box, 1 = ore, 2 = beacon, 3 = firework
     */
    public final TableField<CollectablesRecord, Byte> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0 = box, 1 = ore, 2 = beacon, 3 = firework");

    /**
     * The column <code>kalaazu.collectables.name</code>.
     */
    public final TableField<CollectablesRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
