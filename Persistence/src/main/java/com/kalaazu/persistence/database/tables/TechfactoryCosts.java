...
import com.kalaazu.persistence.database.records.TechfactoryCostsRecord;
import org.jooq.*;
...
public class TechfactoryCosts extends TableImpl<TechfactoryCostsRecord> {
     ...
     */
    public final TableField<TechfactoryCostsRecord, Byte> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<TechfactoryCostsRecord, Byte> TECHFACTORY_ITEMS_ID = createField(DSL.name(
            "techfactory_items_id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "Techfactory Item ID.");
    /**
     * The column <code>kalaazu.techfactory_costs.items_id</code>. Cost item ID.
     */
    public final TableField<TechfactoryCostsRecord, Short> ITEMS_ID = createField(
            DSL.name("items_id"),
     ...
     */
    public final TableField<TechfactoryCostsRecord, Integer> AMOUNT = createField(
            DSL.name("amount"),
            org.jooq.impl.SQLDataType.INTEGER.nullable(false),
            this,
            "Amount of items to build the techfactory item."
    );
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.TECHFACTORY_COSTS_PRIMARY,
                Indexes.TECHFACTORY_COSTS_TECHFACTORY_COSTS_ITEMS,
                Indexes.TECHFACTORY_COSTS_TECHFACTORY_COSTS_TECHFACTORY_ITEMS
        );
    }
    ...
    public List<ForeignKey<TechfactoryCostsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TechfactoryCostsRecord, ?>>asList(
                Keys.TECHFACTORY_COSTS_TECHFACTORY_ITEMS,
                Keys.TECHFACTORY_COSTS_ITEMS
        );
    }
