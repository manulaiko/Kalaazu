...
public class ClansMessages extends TableImpl<ClansMessagesRecord> {
     ...
     */
    public final TableField<ClansMessagesRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "Primary Key.");

    /**
     * The column <code>kalaazu.clans_messages.clans_id</code>. Clan where the message was created
     */
    public final TableField<ClansMessagesRecord, Integer> CLANS_ID = createField(DSL.name("clans_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Clan where the message was created");

    /**
     * The column <code>kalaazu.clans_messages.from_accounts_id</code>.
     */
    public final TableField<ClansMessagesRecord, Integer> FROM_ACCOUNTS_ID = createField(DSL.name("from_accounts_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>kalaazu.clans_messages.from_status</code>. 0 = unread, 1 = read, 2 = deleted.
     */
    public final TableField<ClansMessagesRecord, Byte> FROM_STATUS = createField(DSL.name("from_status"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "0 = unread, 1 = read, 2 = deleted.");

    /**
     * The column <code>kalaazu.clans_messages.to_accounts_id</code>.
     */
    public final TableField<ClansMessagesRecord, Integer> TO_ACCOUNTS_ID = createField(DSL.name("to_accounts_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>kalaazu.clans_messages.to_status</code>. 0 = unread, 1 = read, 2 = unread.
     */
    public final TableField<ClansMessagesRecord, Byte> TO_STATUS = createField(DSL.name("to_status"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0 = unread, 1 = read, 2 = unread.");

    /**
     * The column <code>kalaazu.clans_messages.title</code>.
     */
    public final TableField<ClansMessagesRecord, String> TITLE = createField(DSL.name("title"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>kalaazu.clans_messages.text</code>.
     */
    public final TableField<ClansMessagesRecord, String> TEXT = createField(DSL.name("text"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>kalaazu.clans_messages.date</code>.
     */
    public final TableField<ClansMessagesRecord, Timestamp> DATE = createField(DSL.name("date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CLANS_MESSAGES_CLANS_MESSAGES_CLANS_ID_IDX, Indexes.CLANS_MESSAGES_CLANS_MESSAGES_FROM_ACCOUNTS_ID_IDX, Indexes.CLANS_MESSAGES_CLANS_MESSAGES_TO_ACCOUNTS_ID_IDX, Indexes.CLANS_MESSAGES_PRIMARY);
    }
    ...
    public List<ForeignKey<ClansMessagesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ClansMessagesRecord, ?>>asList(Keys.CLANS_MESSAGES_CLANS, Keys.CLANS_MESSAGES_FROM_ACCOUNTS, Keys.CLANS_MESSAGES_TO_ACCOUNTS);
    }
