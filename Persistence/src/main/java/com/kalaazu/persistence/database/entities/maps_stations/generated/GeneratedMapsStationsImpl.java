...
public abstract class GeneratedMapsStationsImpl implements MapsStations {
    ...
    @Override
    public MapsStations setPosition(long position) {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getPosition() != thatMapsStations.getPosition()) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getMapsId()));
