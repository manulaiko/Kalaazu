...
import com.kalaazu.persistence.database.records.AccountsConfigurationsAccountsItemsRecord;
import org.jooq.*;
...
public class AccountsConfigurationsAccountsItems extends TableImpl<AccountsConfigurationsAccountsItemsRecord> {
     ...
     */
    public final TableField<AccountsConfigurationsAccountsItemsRecord, Integer> ID = createField(
            DSL.name("id"),
     ...
     */
    public final TableField<AccountsConfigurationsAccountsItemsRecord, Integer> ACCOUNTS_CONFIGURATIONS_ID = createField(
            DSL.name("accounts_configurations_id"),
            org.jooq.impl.SQLDataType.INTEGER.nullable(false),
            this,
            ""
    );
     ...
     */
    public final TableField<AccountsConfigurationsAccountsItemsRecord, Integer> ACCOUNTS_ITEMS_ID = createField(DSL.name(
            "accounts_items_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>kalaazu.accounts_configurations_accounts_items.accounts_drones_id</code>.
     */
    public final TableField<AccountsConfigurationsAccountsItemsRecord, Integer> ACCOUNTS_DRONES_ID = createField(DSL.name(
            "accounts_drones_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");
    /**
     * The column <code>kalaazu.accounts_configurations_accounts_items.accounts_pets_id</code>.
     */
    public final TableField<AccountsConfigurationsAccountsItemsRecord, Integer> ACCOUNTS_PETS_ID = createField(DSL.name(
            "accounts_pets_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    private AccountsConfigurationsAccountsItems(
            Name alias, Table<AccountsConfigurationsAccountsItemsRecord> aliased, Field<?>[] parameters
    ) {
        super(alias, null, aliased, parameters, DSL.comment("Items of the configuration."));
    }

    public <O extends Record> AccountsConfigurationsAccountsItems(
            Table<O> child, ForeignKey<O, AccountsConfigurationsAccountsItemsRecord> key
    ) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(
                Indexes.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_CONFIGURATIONS,
                Indexes.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_DRONES,
                Indexes.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_ITEMS,
                Indexes.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_PETS,
                Indexes.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_PRIMARY
        );
    }
    ...
    public List<ForeignKey<AccountsConfigurationsAccountsItemsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AccountsConfigurationsAccountsItemsRecord, ?>>asList(
                Keys.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_CONFIGURATIONS,
                Keys.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_ITEMS,
                Keys.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_DRONES,
                Keys.ACCOUNTS_CONFIGURATIONS_ACCOUNTS_ITEMS_ACCOUNTS_PETS
        );
    }
