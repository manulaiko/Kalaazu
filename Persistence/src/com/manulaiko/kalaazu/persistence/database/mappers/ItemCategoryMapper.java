 ...
 */
public class ItemCategoryMapper implements TypeMapper<Byte, ItemCategory> {
    /**
    ...
    public String getLabel() {
        return "Integer to Item category";
    }
     ...
     */
    @Override
    public ItemCategory toJavaType(Column column, Class<?> entityType, Byte value) {
        if (value == null) {
            return null;
        }
     ...
     */
    @Override
    public Byte toDatabaseType(ItemCategory value) {
        if (value == null) {
            return null;
        }
