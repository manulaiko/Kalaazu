 ...
 */
public class SkillTypeMapper implements TypeMapper<Byte, SkillType> {
    /**
     ...
     */
    @Override
    public SkillType toJavaType(Column column, Class<?> entityType, Byte value) {
        if (value == null) {
            return null;
        }
     ...
     */
    @Override
    public Byte toDatabaseType(SkillType value) {
        if (value == null) {
            return null;
        }
