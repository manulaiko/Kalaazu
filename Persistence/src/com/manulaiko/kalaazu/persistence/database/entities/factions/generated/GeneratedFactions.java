...
public interface GeneratedFactions {
     ...
     */
    IntField<Factions, Integer> ID = IntField.create(
        Identifier.ID,
        Factions::getId,
        Factions::setId,
     ...
     */
    BooleanField<Factions, Boolean> IS_PUBLIC = BooleanField.create(
     ...
     */
    IntForeignKeyField<Factions, Integer, Maps> LOW_MAPS_ID = IntForeignKeyField.create(
     ...
     */
    StringField<Factions, String> LOW_MAPS_POSITION = StringField.create(
     ...
     */
    IntForeignKeyField<Factions, Integer, Maps> HIGH_MAPS_ID = IntForeignKeyField.create(
     ...
     */
    StringField<Factions, String> HIGH_MAPS_POSITION = StringField.create(
     ...
     * @return          this Factions instance
     */
    Factions setLowMapsId(int lowMapsId);
     ...
     * @return                this Factions instance
     */
    Factions setLowMapsPosition(String lowMapsPosition);
     ...
     * @return           this Factions instance
     */
    Factions setHighMapsId(int highMapsId);
     ...
     * @return                 this Factions instance
     */
    Factions setHighMapsPosition(String highMapsPosition);
