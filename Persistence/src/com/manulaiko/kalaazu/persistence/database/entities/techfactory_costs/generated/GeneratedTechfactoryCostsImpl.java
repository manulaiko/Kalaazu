...
public abstract class GeneratedTechfactoryCostsImpl implements TechfactoryCosts {
    ...
    @Override
    public TechfactoryCosts setId(int id) {
        this.id = id;
        return this;
    }
    
    @Override
    public TechfactoryCosts setTechfactoryItemsId(int techfactoryItemsId) {
        this.techfactoryItemsId = techfactoryItemsId;
        return this;
    }
    
    @Override
    public TechfactoryCosts setItemsId(int itemsId) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof TechfactoryCosts)) { return false; }
        final TechfactoryCosts thatTechfactoryCosts = (TechfactoryCosts)that;
        if (this.getId() != thatTechfactoryCosts.getId()) {return false; }
        if (this.getTechfactoryItemsId() != thatTechfactoryCosts.getTechfactoryItemsId()) {return false; }
        if (this.getItemsId() != thatTechfactoryCosts.getItemsId()) {return false; }
        if (this.getAmount() != thatTechfactoryCosts.getAmount()) {return false; }
        return true;
    }
