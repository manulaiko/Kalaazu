...
public abstract class GeneratedAccountsRankingsSqlAdapter {
    ...
    protected AccountsRankings apply(ResultSet resultSet) throws SpeedmentException {
        ...
        try {
            ...
            entity.setDestroyedAllies(    resultSet.getInt(5) );
            entity.setDestroyedPhoenix(   resultSet.getInt(6) );
            entity.setDestroyedTimes(     resultSet.getInt(7) );
            entity.setDestroyedRadiation( resultSet.getInt(8) );
