...
public abstract class GeneratedAccountsConfigurationsAccountsItemsImpl implements AccountsConfigurationsAccountsItems {
    ...
    public AccountsConfigurations findAccountsConfigurationsId(Manager<AccountsConfigurations> foreignManager) {
        return foreignManager.stream().filter(AccountsConfigurations.ID.equal(getAccountsConfigurationsId())).findAny().orElse(null);
    }
    ...
    public Optional<AccountsDrones> findAccountsDronesId(Manager<AccountsDrones> foreignManager) {
        if (getAccountsDronesId().isPresent()) {
            return foreignManager.stream().filter(AccountsDrones.ID.equal(getAccountsDronesId().getAsInt())).findAny();
        } else {
    ...
    public Optional<AccountsPets> findAccountsPetsId(Manager<AccountsPets> foreignManager) {
        if (getAccountsPetsId().isPresent()) {
            return foreignManager.stream().filter(AccountsPets.ID.equal(getAccountsPetsId().getAsInt())).findAny();
        } else {
            return Optional.empty();
        }
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsConfigurationsAccountsItems)) { return false; }
        ...
        if (this.getId() != thatAccountsConfigurationsAccountsItems.getId()) {return false; }
        if (this.getAccountsConfigurationsId() != thatAccountsConfigurationsAccountsItems.getAccountsConfigurationsId()) {return false; }
        if (this.getAccountsItemsId() != thatAccountsConfigurationsAccountsItems.getAccountsItemsId()) {return false; }
        if (!Objects.equals(this.getAccountsDronesId(), thatAccountsConfigurationsAccountsItems.getAccountsDronesId())) {return false; }
        if (!Objects.equals(this.getAccountsPetsId(), thatAccountsConfigurationsAccountsItems.getAccountsPetsId())) {return false; }
        return true;
    }
