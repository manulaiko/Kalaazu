...
public abstract class GeneratedFactionsImpl implements Factions {
    ...
    private String lowMapsPosition;
    private int highMapsId;
    private String highMapsPosition;
    ...
    @Override
    public String getLowMapsPosition() {
    ...
    @Override
    public String getHighMapsPosition() {
        return highMapsPosition;
    }
    
    @Override
    public Factions setId(int id) {
        this.id = id;
        return this;
    }
    ...
    @Override
    public Factions setLowMapsId(int lowMapsId) {
        this.lowMapsId = lowMapsId;
        return this;
    }
    
    @Override
    public Factions setLowMapsPosition(String lowMapsPosition) {
        this.lowMapsPosition = lowMapsPosition;
        return this;
    }
    
    @Override
    public Factions setHighMapsId(int highMapsId) {
        this.highMapsId = highMapsId;
        return this;
    }
    
    @Override
    public Factions setHighMapsPosition(String highMapsPosition) {
    ...
    public Maps findLowMapsId(Manager<Maps> foreignManager) {
        return foreignManager.stream().filter(Maps.ID.equal(getLowMapsId())).findAny().orElse(null);
    }
    
    @Override
    public Maps findHighMapsId(Manager<Maps> foreignManager) {
        return foreignManager.stream().filter(Maps.ID.equal(getHighMapsId())).findAny().orElse(null);
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof Factions)) { return false; }
        final Factions thatFactions = (Factions)that;
        if (this.getId() != thatFactions.getId()) {return false; }
        if (!Objects.equals(this.getName(), thatFactions.getName())) {return false; }
        if (!Objects.equals(this.getTag(), thatFactions.getTag())) {return false; }
        if (!Objects.equals(this.getDescription(), thatFactions.getDescription())) {return false; }
        if (this.getIsPublic() != thatFactions.getIsPublic()) {return false; }
        if (this.getLowMapsId() != thatFactions.getLowMapsId()) {return false; }
        if (!Objects.equals(this.getLowMapsPosition(), thatFactions.getLowMapsPosition())) {return false; }
        if (this.getHighMapsId() != thatFactions.getHighMapsId()) {return false; }
        if (!Objects.equals(this.getHighMapsPosition(), thatFactions.getHighMapsPosition())) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getLowMapsId());
        hash = 31 * hash + Objects.hashCode(getLowMapsPosition());
        hash = 31 * hash + Integer.hashCode(getHighMapsId());
