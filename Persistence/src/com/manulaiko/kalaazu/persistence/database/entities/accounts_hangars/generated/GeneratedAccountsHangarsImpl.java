...
public abstract class GeneratedAccountsHangarsImpl implements AccountsHangars {
    ...
    public OptionalInt getPriority() {
        return OptionalUtil.ofNullable(priority);
    }
    ...
    @Override
    public AccountsHangars setAccountsShipsId(Integer accountsShipsId) {
        this.accountsShipsId = accountsShipsId;
        return this;
    }
    
    @Override
    public AccountsHangars setAccountsConfigurationsId(Integer accountsConfigurationsId) {
    ...
    @Override
    public AccountsHangars setPriority(Integer priority) {
        this.priority = priority;
        return this;
    }
    
    @Override
    public AccountsHangars setDate(Timestamp date) {
        this.date = date;
        return this;
    }
    ...
    public Optional<AccountsShips> findAccountsShipsId(Manager<AccountsShips> foreignManager) {
        if (getAccountsShipsId().isPresent()) {
            return foreignManager.stream().filter(AccountsShips.ID.equal(getAccountsShipsId().getAsInt())).findAny();
        } else {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsHangars)) { return false; }
        final AccountsHangars thatAccountsHangars = (AccountsHangars)that;
        if (this.getId() != thatAccountsHangars.getId()) {return false; }
        if (this.getAccountsId() != thatAccountsHangars.getAccountsId()) {return false; }
        if (!Objects.equals(this.getAccountsShipsId(), thatAccountsHangars.getAccountsShipsId())) {return false; }
        if (!Objects.equals(this.getAccountsConfigurationsId(), thatAccountsHangars.getAccountsConfigurationsId())) {return false; }
        if (!Objects.equals(this.getName(), thatAccountsHangars.getName())) {return false; }
        if (!Objects.equals(this.getPriority(), thatAccountsHangars.getPriority())) {return false; }
        if (!Objects.equals(this.getDate(), thatAccountsHangars.getDate())) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(getAccountsShipsId());
        hash = 31 * hash + Objects.hashCode(getAccountsConfigurationsId());
        hash = 31 * hash + Objects.hashCode(getName());
        hash = 31 * hash + Objects.hashCode(getPriority());
