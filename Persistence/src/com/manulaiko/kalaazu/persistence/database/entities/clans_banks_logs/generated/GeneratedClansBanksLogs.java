...
public interface GeneratedClansBanksLogs {
     ...
     */
    IntField<ClansBanksLogs, Integer> TYPE = IntField.create(
        Identifier.TYPE,
     ...
     */
    IntField<ClansBanksLogs, Integer> CURRENCY = IntField.create(
        Identifier.CURRENCY,
     ...
     * @return     this ClansBanksLogs instance
     */
    ClansBanksLogs setType(int type);
     ...
     * @return         this ClansBanksLogs instance
     */
    ClansBanksLogs setCurrency(int currency);
