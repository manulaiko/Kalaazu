...
import com.manulaiko.kalaazu.persistence.database.entities.accounts_banks_logs.AccountsBanksLogsImpl;
...
public abstract class GeneratedAccountsBanksLogsSqlAdapter {
    ...
    protected AccountsBanksLogs apply(ResultSet resultSet) throws SpeedmentException {
        ...
        try {
            ...
            entity.setType(            resultSet.getInt(5)       );
            entity.setAmount(          resultSet.getInt(6)       );
            entity.setCurrency(        resultSet.getInt(7)       );
