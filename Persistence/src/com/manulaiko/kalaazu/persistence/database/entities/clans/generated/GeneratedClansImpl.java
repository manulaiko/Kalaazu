...
public abstract class GeneratedClansImpl implements Clans {
    ...
    @Override
    public Clans setFactionsId(Integer factionsId) {
    ...
    @Override
    public Clans setStatus(int status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof Clans)) { return false; }
        final Clans thatClans = (Clans)that;
        if (this.getId() != thatClans.getId()) {return false; }
        if (this.getAccountsId() != thatClans.getAccountsId()) {return false; }
        if (!Objects.equals(this.getFactionsId(), thatClans.getFactionsId())) {return false; }
        if (!Objects.equals(this.getTag(), thatClans.getTag())) {return false; }
        if (!Objects.equals(this.getName(), thatClans.getName())) {return false; }
        if (!Objects.equals(this.getDescription(), thatClans.getDescription())) {return false; }
        if (!Objects.equals(this.getLogo(), thatClans.getLogo())) {return false; }
        if (this.getStatus() != thatClans.getStatus()) {return false; }
        return true;
    }
