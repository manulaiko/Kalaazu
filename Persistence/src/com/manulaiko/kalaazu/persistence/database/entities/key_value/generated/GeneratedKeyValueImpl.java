...
public abstract class GeneratedKeyValueImpl implements KeyValue {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof KeyValue)) { return false; }
        final KeyValue thatKeyValue = (KeyValue)that;
        if (!Objects.equals(this.getKey(), thatKeyValue.getKey())) {return false; }
        if (!Objects.equals(this.getValue(), thatKeyValue.getValue())) {return false; }
        return true;
    }
