...
import com.manulaiko.kalaazu.persistence.database.entities.galaxygates_waves.GalaxygatesWavesImpl;
...
public abstract class GeneratedGalaxygatesWavesSqlAdapter {
    ...
    protected GalaxygatesWaves apply(ResultSet resultSet) throws SpeedmentException {
        ...
        try {
            ...
            entity.setMapsId(  resultSet.getInt(2) );
            entity.setSeconds( resultSet.getInt(3) );
            entity.setNpcs(    resultSet.getInt(4) );
