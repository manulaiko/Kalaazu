...
public abstract class GeneratedAccountsHistoryImpl implements AccountsHistory {
    ...
    @Override
    public AccountsHistory setType(int type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsHistory)) { return false; }
        final AccountsHistory thatAccountsHistory = (AccountsHistory)that;
        if (this.getId() != thatAccountsHistory.getId()) {return false; }
        if (this.getAccountsId() != thatAccountsHistory.getAccountsId()) {return false; }
        if (this.getType() != thatAccountsHistory.getType()) {return false; }
        if (!Objects.equals(this.getMessage(), thatAccountsHistory.getMessage())) {return false; }
        if (this.getAmount() != thatAccountsHistory.getAmount()) {return false; }
        if (!Objects.equals(this.getDate(), thatAccountsHistory.getDate())) {return false; }
        return true;
    }
