...
public abstract class GeneratedClansRankingImpl implements ClansRanking {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof ClansRanking)) { return false; }
        final ClansRanking thatClansRanking = (ClansRanking)that;
        if (this.getId() != thatClansRanking.getId()) {return false; }
        if (this.getClansId() != thatClansRanking.getClansId()) {return false; }
        if (this.getPoints() != thatClansRanking.getPoints()) {return false; }
        if (this.getBestPoints() != thatClansRanking.getBestPoints()) {return false; }
        return true;
    }
