...
public abstract class GeneratedAccountsPetsImpl implements AccountsPets {
    ...
    @Override
    public AccountsPets setLevelsId(int levelsId) {
    ...
    @Override
    public AccountsPets setSlotsLasersTotal(int slotsLasersTotal) {
        this.slotsLasersTotal = slotsLasersTotal;
        return this;
    }
    
    @Override
    public AccountsPets setSlotsLasersAvailable(int slotsLasersAvailable) {
        this.slotsLasersAvailable = slotsLasersAvailable;
        return this;
    }
    
    @Override
    public AccountsPets setSlotsGeneratorsTotal(int slotsGeneratorsTotal) {
        this.slotsGeneratorsTotal = slotsGeneratorsTotal;
        return this;
    }
    
    @Override
    public AccountsPets setSlotsGeneratorsAvailable(int slotsGeneratorsAvailable) {
        this.slotsGeneratorsAvailable = slotsGeneratorsAvailable;
        return this;
    }
    
    @Override
    public AccountsPets setSlotsProtocolsTotal(int slotsProtocolsTotal) {
        this.slotsProtocolsTotal = slotsProtocolsTotal;
        return this;
    }
    
    @Override
    public AccountsPets setSlotsProtocolsAvailable(int slotsProtocolsAvailable) {
        this.slotsProtocolsAvailable = slotsProtocolsAvailable;
        return this;
    }
    
    @Override
    public AccountsPets setSlotsGearsTotal(int slotsGearsTotal) {
        this.slotsGearsTotal = slotsGearsTotal;
        return this;
    }
    
    @Override
    public AccountsPets setSlotsGearsAvailable(int slotsGearsAvailable) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsPets)) { return false; }
        final AccountsPets thatAccountsPets = (AccountsPets)that;
        if (this.getId() != thatAccountsPets.getId()) {return false; }
        if (this.getAccountsId() != thatAccountsPets.getAccountsId()) {return false; }
        if (this.getLevelsId() != thatAccountsPets.getLevelsId()) {return false; }
        if (!Objects.equals(this.getName(), thatAccountsPets.getName())) {return false; }
        if (this.getExperience() != thatAccountsPets.getExperience()) {return false; }
        if (this.getFuel() != thatAccountsPets.getFuel()) {return false; }
        if (this.getHealth() != thatAccountsPets.getHealth()) {return false; }
        if (this.getSlotsLasersTotal() != thatAccountsPets.getSlotsLasersTotal()) {return false; }
        if (this.getSlotsLasersAvailable() != thatAccountsPets.getSlotsLasersAvailable()) {return false; }
        if (this.getSlotsGeneratorsTotal() != thatAccountsPets.getSlotsGeneratorsTotal()) {return false; }
        if (this.getSlotsGeneratorsAvailable() != thatAccountsPets.getSlotsGeneratorsAvailable()) {return false; }
        if (this.getSlotsProtocolsTotal() != thatAccountsPets.getSlotsProtocolsTotal()) {return false; }
        if (this.getSlotsProtocolsAvailable() != thatAccountsPets.getSlotsProtocolsAvailable()) {return false; }
        if (this.getSlotsGearsTotal() != thatAccountsPets.getSlotsGearsTotal()) {return false; }
        if (this.getSlotsGearsAvailable() != thatAccountsPets.getSlotsGearsAvailable()) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getSlotsLasersTotal());
        hash = 31 * hash + Integer.hashCode(getSlotsLasersAvailable());
        hash = 31 * hash + Integer.hashCode(getSlotsGeneratorsTotal());
        hash = 31 * hash + Integer.hashCode(getSlotsGeneratorsAvailable());
        hash = 31 * hash + Integer.hashCode(getSlotsProtocolsTotal());
        hash = 31 * hash + Integer.hashCode(getSlotsProtocolsAvailable());
        hash = 31 * hash + Integer.hashCode(getSlotsGearsTotal());
        hash = 31 * hash + Integer.hashCode(getSlotsGearsAvailable());
        return hash;
    }
}