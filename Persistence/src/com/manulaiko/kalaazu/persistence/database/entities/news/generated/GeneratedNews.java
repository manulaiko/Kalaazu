 ...
 * com.manulaiko.kalaazu.persistence.database.entities.news.News}-interface representing
 * entities of the {@code news}-table in the database.
 * <p>
...
public interface GeneratedNews {
     ...
     */
    IntField<News, Integer> ID = IntField.create(
        Identifier.ID,
        News::getId,
        News::setId,
