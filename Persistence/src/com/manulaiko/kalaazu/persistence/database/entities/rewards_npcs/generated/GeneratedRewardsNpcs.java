...
public interface GeneratedRewardsNpcs {
     ...
     */
    IntField<RewardsNpcs, Integer> ID = IntField.create(
        Identifier.ID,
        RewardsNpcs::getId,
        RewardsNpcs::setId,
     ...
     */
    IntForeignKeyField<RewardsNpcs, Integer, Npcs> NPCS_ID = IntForeignKeyField.create(
        Identifier.NPCS_ID,
     ...
     */
    IntForeignKeyField<RewardsNpcs, Integer, Rewards> REWARDS_ID = IntForeignKeyField.create(
     ...
     * @return       this RewardsNpcs instance
     */
    RewardsNpcs setNpcsId(int npcsId);
     ...
     * @return          this RewardsNpcs instance
     */
    RewardsNpcs setRewardsId(int rewardsId);
