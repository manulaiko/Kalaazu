...
public interface GeneratedClans {
     ...
     */
    ComparableField<Clans, Integer, Integer> FACTIONS_ID = ComparableField.create(
     ...
     */
    IntField<Clans, Integer> STATUS = IntField.create(
        Identifier.STATUS,
        Clans::getStatus,
        Clans::setStatus,
        TypeMapper.primitive(),
     ...
     * @return           this Clans instance
     */
    Clans setFactionsId(Integer factionsId);
