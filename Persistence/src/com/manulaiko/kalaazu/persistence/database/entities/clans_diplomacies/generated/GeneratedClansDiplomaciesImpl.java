...
public abstract class GeneratedClansDiplomaciesImpl implements ClansDiplomacies {
    ...
    @Override
    public ClansDiplomacies setStatus(int status) {
        this.status = status;
        return this;
    }
    
    @Override
    public ClansDiplomacies setType(int type) {
        this.type = type;
        return this;
    }
    ...
    public Clans findFromClansId(Manager<Clans> foreignManager) {
        return foreignManager.stream().filter(Clans.ID.equal(getFromClansId())).findAny().orElse(null);
    }
    
    @Override
    public Clans findToClansId(Manager<Clans> foreignManager) {
        return foreignManager.stream().filter(Clans.ID.equal(getToClansId())).findAny().orElse(null);
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof ClansDiplomacies)) { return false; }
        final ClansDiplomacies thatClansDiplomacies = (ClansDiplomacies)that;
        if (this.getId() != thatClansDiplomacies.getId()) {return false; }
        if (this.getFromClansId() != thatClansDiplomacies.getFromClansId()) {return false; }
        if (this.getToClansId() != thatClansDiplomacies.getToClansId()) {return false; }
        if (!Objects.equals(this.getDate(), thatClansDiplomacies.getDate())) {return false; }
        if (!Objects.equals(this.getExpires(), thatClansDiplomacies.getExpires())) {return false; }
        if (this.getStatus() != thatClansDiplomacies.getStatus()) {return false; }
        if (this.getType() != thatClansDiplomacies.getType()) {return false; }
        return true;
    }
