...
public abstract class GeneratedTechfactoryDronesImpl implements TechfactoryDrones {
    ...
    @Override
    public TechfactoryDrones setId(int id) {
        this.id = id;
        return this;
    }
    ...
    @Override
    public TechfactoryDrones setTime(int time) {
        this.time = time;
        return this;
    }
    ...
    @Override
    public TechfactoryDrones setFactor(BigDecimal factor) {
        this.factor = factor;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof TechfactoryDrones)) { return false; }
        final TechfactoryDrones thatTechfactoryDrones = (TechfactoryDrones)that;
        if (this.getId() != thatTechfactoryDrones.getId()) {return false; }
        if (!Objects.equals(this.getName(), thatTechfactoryDrones.getName())) {return false; }
        if (!Objects.equals(this.getDescription(), thatTechfactoryDrones.getDescription())) {return false; }
        if (this.getTime() != thatTechfactoryDrones.getTime()) {return false; }
        if (this.getParts() != thatTechfactoryDrones.getParts()) {return false; }
        if (this.getPrice() != thatTechfactoryDrones.getPrice()) {return false; }
        if (!Objects.equals(this.getFactor(), thatTechfactoryDrones.getFactor())) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(getFactor());
        return hash;
    }
}