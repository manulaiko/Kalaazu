...
public abstract class GeneratedPermissionsImpl implements Permissions {
    ...
    @Override
    public Permissions setId(int id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof Permissions)) { return false; }
        final Permissions thatPermissions = (Permissions)that;
        if (this.getId() != thatPermissions.getId()) {return false; }
        if (!Objects.equals(this.getName(), thatPermissions.getName())) {return false; }
        if (!Objects.equals(this.getCategory(), thatPermissions.getCategory())) {return false; }
        return true;
    }
