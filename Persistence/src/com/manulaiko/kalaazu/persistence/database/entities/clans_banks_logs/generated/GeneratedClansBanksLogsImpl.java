...
public abstract class GeneratedClansBanksLogsImpl implements ClansBanksLogs {
    ...
    @Override
    public ClansBanksLogs setType(int type) {
        this.type = type;
        return this;
    }
    ...
    @Override
    public ClansBanksLogs setCurrency(int currency) {
    ...
    public ClansBanks findClansBanksId(Manager<ClansBanks> foreignManager) {
        return foreignManager.stream().filter(ClansBanks.ID.equal(getClansBanksId())).findAny().orElse(null);
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof ClansBanksLogs)) { return false; }
        final ClansBanksLogs thatClansBanksLogs = (ClansBanksLogs)that;
        if (this.getId() != thatClansBanksLogs.getId()) {return false; }
        if (this.getClansBanksId() != thatClansBanksLogs.getClansBanksId()) {return false; }
        if (this.getFromAccountsId() != thatClansBanksLogs.getFromAccountsId()) {return false; }
        if (this.getToAccountsId() != thatClansBanksLogs.getToAccountsId()) {return false; }
        if (!Objects.equals(this.getDate(), thatClansBanksLogs.getDate())) {return false; }
        if (this.getType() != thatClansBanksLogs.getType()) {return false; }
        if (this.getAmount() != thatClansBanksLogs.getAmount()) {return false; }
        if (this.getCurrency() != thatClansBanksLogs.getCurrency()) {return false; }
        return true;
    }
