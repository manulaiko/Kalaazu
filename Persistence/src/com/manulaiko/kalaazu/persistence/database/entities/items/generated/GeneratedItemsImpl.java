...
public abstract class GeneratedItemsImpl implements Items {
    ...
    @Override
    public Items setCategory(ItemCategory category) {
    ...
    @Override
    public Items setType(ItemType type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!Objects.equals(this.getCategory(), thatItems.getCategory())) {
            return false;
        }
        ...
        if (!Objects.equals(this.getType(), thatItems.getType())) {
            return false;
        }
