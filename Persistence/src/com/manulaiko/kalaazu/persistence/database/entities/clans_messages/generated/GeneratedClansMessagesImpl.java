...
public abstract class GeneratedClansMessagesImpl implements ClansMessages {
    ...
    @Override
    public ClansMessages setSubject(String subject) {
    ...
    public Optional<Accounts> findToAccountsId(Manager<Accounts> foreignManager) {
        if (getToAccountsId().isPresent()) {
            return foreignManager.stream().filter(Accounts.ID.equal(getToAccountsId().getAsInt())).findAny();
        } else {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof ClansMessages)) { return false; }
        final ClansMessages thatClansMessages = (ClansMessages)that;
        if (this.getId() != thatClansMessages.getId()) {return false; }
        if (this.getClansId() != thatClansMessages.getClansId()) {return false; }
        if (this.getFromAccountsId() != thatClansMessages.getFromAccountsId()) {return false; }
        if (!Objects.equals(this.getToAccountsId(), thatClansMessages.getToAccountsId())) {return false; }
        if (!Objects.equals(this.getSubject(), thatClansMessages.getSubject())) {return false; }
        if (!Objects.equals(this.getText(), thatClansMessages.getText())) {return false; }
        if (!Objects.equals(this.getDate(), thatClansMessages.getDate())) {return false; }
        return true;
    }
