...
public abstract class GeneratedClansBattlestationsLogsImpl implements ClansBattlestationsLogs {
    ...
    @Override
    public ClansBattlestationsLogs setClansBattlestationsId(int clansBattlestationsId) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof ClansBattlestationsLogs)) { return false; }
        final ClansBattlestationsLogs thatClansBattlestationsLogs = (ClansBattlestationsLogs)that;
        if (this.getId() != thatClansBattlestationsLogs.getId()) {return false; }
        if (this.getClansId() != thatClansBattlestationsLogs.getClansId()) {return false; }
        if (this.getClansBattlestationsId() != thatClansBattlestationsLogs.getClansBattlestationsId()) {return false; }
        if (!Objects.equals(this.getMessage(), thatClansBattlestationsLogs.getMessage())) {return false; }
        if (!Objects.equals(this.getDate(), thatClansBattlestationsLogs.getDate())) {return false; }
        return true;
    }
