...
public interface GeneratedQuestsConditions {
     ...
     */
    IntForeignKeyField<QuestsConditions, Integer, Quests> QUESTS_ID = IntForeignKeyField.create(
     ...
     */
    IntField<QuestsConditions, Integer> TYPE = IntField.create(
        Identifier.TYPE,
     ...
     * @return         this QuestsConditions instance
     */
    QuestsConditions setQuestsId(int questsId);
     ...
     * @return     this QuestsConditions instance
     */
    QuestsConditions setType(int type);
