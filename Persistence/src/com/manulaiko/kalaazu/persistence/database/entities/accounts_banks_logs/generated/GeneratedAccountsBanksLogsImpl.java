...
public abstract class GeneratedAccountsBanksLogsImpl implements AccountsBanksLogs {
    ...
    @Override
    public AccountsBanksLogs setType(int type) {
        this.type = type;
        return this;
    }
    ...
    @Override
    public AccountsBanksLogs setCurrency(int currency) {
    ...
    public Optional<AccountsBanks> findAccountsBanksId(Manager<AccountsBanks> foreignManager) {
        if (getAccountsBanksId().isPresent()) {
            return foreignManager.stream().filter(AccountsBanks.ID.equal(getAccountsBanksId().getAsInt())).findAny();
        } else {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsBanksLogs)) { return false; }
        final AccountsBanksLogs thatAccountsBanksLogs = (AccountsBanksLogs)that;
        if (this.getId() != thatAccountsBanksLogs.getId()) {return false; }
        if (this.getFromAccountsId() != thatAccountsBanksLogs.getFromAccountsId()) {return false; }
        if (this.getToAccountsId() != thatAccountsBanksLogs.getToAccountsId()) {return false; }
        if (!Objects.equals(this.getDate(), thatAccountsBanksLogs.getDate())) {return false; }
        if (this.getType() != thatAccountsBanksLogs.getType()) {return false; }
        if (this.getAmount() != thatAccountsBanksLogs.getAmount()) {return false; }
        if (this.getCurrency() != thatAccountsBanksLogs.getCurrency()) {return false; }
        if (!Objects.equals(this.getAccountsBanksId(), thatAccountsBanksLogs.getAccountsBanksId())) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getCurrency());
