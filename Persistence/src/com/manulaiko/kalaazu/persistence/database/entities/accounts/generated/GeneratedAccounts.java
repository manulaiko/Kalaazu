...
public interface GeneratedAccounts {
     ...
     */
    ComparableForeignKeyField<Accounts, Integer, Integer, Users> USERS_ID = ComparableForeignKeyField.create(
        Identifier.USERS_ID,
        Accounts::getUsersId,
        Accounts::setUsersId,
        Users.ID,
     ...
     */
    IntForeignKeyField<Accounts, Integer, Levels> LEVELS_ID = IntForeignKeyField.create(
     ...
     */
    ComparableForeignKeyField<Accounts, Integer, Integer, Factions> FACTIONS_ID = ComparableForeignKeyField.create(
     ...
     */
    IntForeignKeyField<Accounts, Integer, Ranks> RANKS_ID = IntForeignKeyField.create(
        Identifier.RANKS_ID,
        Accounts::getRanksId,
        Accounts::setRanksId,
        Ranks.ID,
     ...
     */
    IntField<Accounts, Integer> SKILL_POINTS_TOTAL = IntField.create(
     ...
     */
    IntField<Accounts, Integer> SKILL_POINTS_FREE = IntField.create(
     ...
     * @return        this Accounts instance
     */
    Accounts setUsersId(Integer usersId);
     ...
     * @return         this Accounts instance
     */
    Accounts setLevelsId(int levelsId);
     ...
     * @return           this Accounts instance
     */
    Accounts setFactionsId(Integer factionsId);
     ...
     * @return        this Accounts instance
     */
    Accounts setRanksId(int ranksId);
     ...
     * @return                 this Accounts instance
     */
    Accounts setSkillPointsTotal(int skillPointsTotal);
     ...
     * @return                this Accounts instance
     */
    Accounts setSkillPointsFree(int skillPointsFree);
