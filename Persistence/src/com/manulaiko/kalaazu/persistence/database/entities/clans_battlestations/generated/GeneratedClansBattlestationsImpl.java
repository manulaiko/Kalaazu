...
public abstract class GeneratedClansBattlestationsImpl implements ClansBattlestations {
    ...
    @Override
    public ClansBattlestations setId(int id) {
        this.id = id;
        return this;
    }
    ...
    @Override
    public ClansBattlestations setMapsId(int mapsId) {
        this.mapsId = mapsId;
        return this;
    }
    ...
    @Override
    public ClansBattlestations setPosition(String position) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof ClansBattlestations)) { return false; }
        final ClansBattlestations thatClansBattlestations = (ClansBattlestations)that;
        if (this.getId() != thatClansBattlestations.getId()) {return false; }
        if (!Objects.equals(this.getClansId(), thatClansBattlestations.getClansId())) {return false; }
        if (this.getMapsId() != thatClansBattlestations.getMapsId()) {return false; }
        if (!Objects.equals(this.getName(), thatClansBattlestations.getName())) {return false; }
        if (!Objects.equals(this.getPosition(), thatClansBattlestations.getPosition())) {return false; }
        if (!Objects.equals(this.getDate(), thatClansBattlestations.getDate())) {return false; }
        return true;
    }
