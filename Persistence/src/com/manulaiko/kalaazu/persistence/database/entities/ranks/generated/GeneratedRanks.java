...
public interface GeneratedRanks {
     ...
     */
    IntField<Ranks, Integer> ID = IntField.create(
        Identifier.ID,
        Ranks::getId,
        Ranks::setId,
     ...
     */
    ComparableField<Ranks, BigDecimal, BigDecimal> PERCENTAJE = ComparableField.create(
     ...
     */
    BooleanField<Ranks, Boolean> IS_PUBLIC = BooleanField.create(
     ...
     * @return           this Ranks instance
     */
    Ranks setPercentaje(BigDecimal percentaje);
