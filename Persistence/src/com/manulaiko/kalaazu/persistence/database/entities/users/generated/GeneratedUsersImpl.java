...
public abstract class GeneratedUsersImpl implements Users {
    ...
    @Override
    public OptionalInt getInvitationCodesId() {
        return OptionalUtil.ofNullable(invitationCodesId);
    }
    ...
    @Override
    public Users setInvitationCodesId(Integer invitationCodesId) {
    ...
    public Optional<InvitationCodes> findInvitationCodesId(Manager<InvitationCodes> foreignManager) {
        if (getInvitationCodesId().isPresent()) {
            return foreignManager.stream().filter(InvitationCodes.ID.equal(getInvitationCodesId().getAsInt())).findAny();
        } else {
    ...
    public boolean equals(Object that) {
        ...
        if (!Objects.equals(this.getDate(), thatUsers.getDate())) {return false; }
        if (!Objects.equals(this.getInvitationCodesId(), thatUsers.getInvitationCodesId())) {return false; }
        if (!Objects.equals(this.getName(), thatUsers.getName())) {return false; }
        ...
        if (!Objects.equals(this.getEmailVerificationCode(), thatUsers.getEmailVerificationCode())) {return false; }
        if (!Objects.equals(this.getEmailVerificationDate(), thatUsers.getEmailVerificationDate())) {return false; }
        if (!Objects.equals(this.getIp(), thatUsers.getIp())) {return false; }
        return true;
    }
