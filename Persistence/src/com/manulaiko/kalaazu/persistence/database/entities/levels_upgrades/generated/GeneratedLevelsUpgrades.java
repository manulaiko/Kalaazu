...
public interface GeneratedLevelsUpgrades {
     ...
     */
    IntForeignKeyField<LevelsUpgrades, Integer, Levels> LEVELS_ID = IntForeignKeyField.create(
     ...
     */
    IntField<LevelsUpgrades, Integer> URIDIUM = IntField.create(
        Identifier.URIDIUM,
     ...
     * @return         this LevelsUpgrades instance
     */
    LevelsUpgrades setLevelsId(int levelsId);
     ...
     * @return        this LevelsUpgrades instance
     */
    LevelsUpgrades setUridium(int uridium);
