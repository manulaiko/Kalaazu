...
public abstract class GeneratedNewsImpl implements News {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof News)) { return false; }
        final News thatNews = (News)that;
        if (this.getId() != thatNews.getId()) {return false; }
        if (!Objects.equals(this.getDate(), thatNews.getDate())) {return false; }
        if (!Objects.equals(this.getImage(), thatNews.getImage())) {return false; }
        if (!Objects.equals(this.getTitle(), thatNews.getTitle())) {return false; }
        if (!Objects.equals(this.getTeaser(), thatNews.getTeaser())) {return false; }
        if (!Objects.equals(this.getText(), thatNews.getText())) {return false; }
        return true;
    }
