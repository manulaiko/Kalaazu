...
public interface GeneratedGalaxygatesGgWaves {
     ...
     */
    IntField<GalaxygatesGgWaves, Integer> ID = IntField.create(
        Identifier.ID,
     ...
     * method.
     */
    IntForeignKeyField<GalaxygatesGgWaves, Integer, Galaxygates> GALAXYGATES_ID = IntForeignKeyField.create(
     ...
     * method.
     */
    IntForeignKeyField<GalaxygatesGgWaves, Integer, GalaxygatesWaves> GALAXYGATES_WAVES_ID = IntForeignKeyField.create(
     ...
     */
    GalaxygatesGgWaves setId(int id);
     ...
     * @return              this GalaxygatesGgWaves instance
     */
    GalaxygatesGgWaves setGalaxygatesId(int galaxygatesId);
     ...
     * @return                   this GalaxygatesGgWaves instance
     */
    GalaxygatesGgWaves setGalaxygatesWavesId(int galaxygatesWavesId);
