...
public interface GeneratedTechfactoryDrones {
     ...
     */
    IntField<TechfactoryDrones, Integer> ID = IntField.create(
        Identifier.ID,
     ...
     */
    IntField<TechfactoryDrones, Integer> TIME = IntField.create(
        Identifier.TIME,
     ...
     */
    ComparableField<TechfactoryDrones, BigDecimal, BigDecimal> FACTOR = ComparableField.create(
        Identifier.FACTOR,
     ...
     */
    TechfactoryDrones setId(int id);
     ...
     * @return     this TechfactoryDrones instance
     */
    TechfactoryDrones setTime(int time);
     ...
     * @return       this TechfactoryDrones instance
     */
    TechfactoryDrones setFactor(BigDecimal factor);
