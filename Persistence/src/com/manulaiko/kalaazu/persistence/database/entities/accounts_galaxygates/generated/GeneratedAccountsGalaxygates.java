...
public interface GeneratedAccountsGalaxygates {
     ...
     * method.
     */
    IntForeignKeyField<AccountsGalaxygates, Integer, Galaxygates> GALAXYGATES_ID = IntForeignKeyField.create(
     ...
     */
    IntField<AccountsGalaxygates, Integer> PARTS = IntField.create(
        Identifier.PARTS,
     ...
     */
    IntField<AccountsGalaxygates, Integer> LIFES = IntField.create(
        Identifier.LIFES,
     ...
     */
    IntField<AccountsGalaxygates, Integer> WAVE = IntField.create(
        Identifier.WAVE,
     ...
     */
    IntField<AccountsGalaxygates, Integer> TIMES = IntField.create(
        Identifier.TIMES,
    ...
    /**
     * This Field corresponds to the {@link AccountsGalaxygates} field that can
     * be obtained using the {@link AccountsGalaxygates#getIsCompleted()}
     * method.
     */
    BooleanField<AccountsGalaxygates, Boolean> IS_COMPLETED = BooleanField.create(
        Identifier.IS_COMPLETED,
        AccountsGalaxygates::getIsCompleted,
        AccountsGalaxygates::setIsCompleted,
        TypeMapper.primitive(),
        false
    );
    ...
    /**
     * Returns the isCompleted of this AccountsGalaxygates. The isCompleted
     * field corresponds to the database column
     * kalaazu.kalaazu.accounts_galaxygates.is_completed.
     * 
     * @return the isCompleted of this AccountsGalaxygates
     */
     ...
     * @return              this AccountsGalaxygates instance
     */
    AccountsGalaxygates setGalaxygatesId(int galaxygatesId);
     ...
     * @return      this AccountsGalaxygates instance
     */
    AccountsGalaxygates setParts(int parts);
     ...
     * @return      this AccountsGalaxygates instance
     */
    AccountsGalaxygates setLifes(int lifes);
     ...
     * @return     this AccountsGalaxygates instance
     */
    AccountsGalaxygates setWave(int wave);
     ...
     * @return      this AccountsGalaxygates instance
     */
    AccountsGalaxygates setTimes(int times);
    
    /**
     * Sets the isCompleted of this AccountsGalaxygates. The isCompleted field
     * corresponds to the database column
     * kalaazu.kalaazu.accounts_galaxygates.is_completed.
     * 
     * @param isCompleted to set of this AccountsGalaxygates
     * @return            this AccountsGalaxygates instance
     */
    AccountsGalaxygates setIsCompleted(boolean isCompleted);
