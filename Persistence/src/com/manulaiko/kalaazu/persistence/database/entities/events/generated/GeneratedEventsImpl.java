...
public abstract class GeneratedEventsImpl implements Events {
    ...
    public boolean equals(Object that) {
        ...
        if (this.getId() != thatEvents.getId()) {return false; }
        if (!Objects.equals(this.getName(), thatEvents.getName())) {return false; }
        if (!Objects.equals(this.getDescription(), thatEvents.getDescription())) {return false; }
        if (!Objects.equals(this.getStartDate(), thatEvents.getStartDate())) {return false; }
        if (!Objects.equals(this.getEndDate(), thatEvents.getEndDate())) {return false; }
        return true;
    }
