...
public abstract class GeneratedQuestsConditionsImpl implements QuestsConditions {
    ...
    @Override
    public QuestsConditions setQuestsId(int questsId) {
        this.questsId = questsId;
        return this;
    }
    
    @Override
    public QuestsConditions setType(int type) {
        this.type = type;
        return this;
    }
    ...
    public Optional<QuestsConditions> findQuestsConditionsId(Manager<QuestsConditions> foreignManager) {
        if (getQuestsConditionsId().isPresent()) {
            return foreignManager.stream().filter(QuestsConditions.ID.equal(getQuestsConditionsId().getAsInt())).findAny();
        } else {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof QuestsConditions)) { return false; }
        final QuestsConditions thatQuestsConditions = (QuestsConditions)that;
        if (this.getId() != thatQuestsConditions.getId()) {return false; }
        if (!Objects.equals(this.getQuestsConditionsId(), thatQuestsConditions.getQuestsConditionsId())) {return false; }
        if (this.getQuestsId() != thatQuestsConditions.getQuestsId()) {return false; }
        if (this.getType() != thatQuestsConditions.getType()) {return false; }
        if (!Objects.equals(this.getValue(), thatQuestsConditions.getValue())) {return false; }
        return true;
    }
