...
public interface GeneratedQuests {
     ...
     */
    IntField<Quests, Integer> ID = IntField.create(
        Identifier.ID,
        Quests::getId,
        Quests::setId,
     ...
     */
    IntForeignKeyField<Quests, Integer, Levels> LEVELS_ID = IntForeignKeyField.create(
     ...
     */
    ComparableForeignKeyField<Quests, Integer, Integer, Quests> QUESTS_ID = ComparableForeignKeyField.create(
     ...
     */
    ComparableForeignKeyField<Quests, Integer, Integer, Factions> FACTIONS_ID = ComparableForeignKeyField.create(
     ...
     * @return         this Quests instance
     */
    Quests setLevelsId(int levelsId);
     ...
     * @return         this Quests instance
     */
    Quests setQuestsId(Integer questsId);
     ...
     * @return           this Quests instance
     */
    Quests setFactionsId(Integer factionsId);
