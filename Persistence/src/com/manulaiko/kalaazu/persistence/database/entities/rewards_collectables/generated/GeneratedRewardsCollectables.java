...
public interface GeneratedRewardsCollectables {
     ...
     */
    IntField<RewardsCollectables, Integer> ID = IntField.create(
        Identifier.ID,
     ...
     * method.
     */
    IntForeignKeyField<RewardsCollectables, Integer, Collectables> COLLECTABLES_ID = IntForeignKeyField.create(
     ...
     */
    IntForeignKeyField<RewardsCollectables, Integer, Rewards> REWARDS_ID = IntForeignKeyField.create(
     ...
     */
    RewardsCollectables setId(int id);
     ...
     * @return               this RewardsCollectables instance
     */
    RewardsCollectables setCollectablesId(int collectablesId);
     ...
     * @return          this RewardsCollectables instance
     */
    RewardsCollectables setRewardsId(int rewardsId);
