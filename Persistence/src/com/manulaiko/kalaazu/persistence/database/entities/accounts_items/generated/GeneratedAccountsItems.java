...
public interface GeneratedAccountsItems {
     ...
     */
    IntForeignKeyField<AccountsItems, Integer, Items> ITEMS_ID = IntForeignKeyField.create(
        Identifier.ITEMS_ID,
     ...
     */
    IntForeignKeyField<AccountsItems, Integer, Levels> LEVELS_ID = IntForeignKeyField.create(
     ...
     */
    IntField<AccountsItems, Integer> AMOUNT = IntField.create(
        Identifier.AMOUNT,
     ...
     * @return        this AccountsItems instance
     */
    AccountsItems setItemsId(int itemsId);
     ...
     * @return         this AccountsItems instance
     */
    AccountsItems setLevelsId(int levelsId);
     ...
     * @return       this AccountsItems instance
     */
    AccountsItems setAmount(int amount);
