...
public interface GeneratedAccountsSkills {
     ...
     */
    IntForeignKeyField<AccountsSkills, Integer, SkilltreeSkills> SKILLTREE_SKILLS_ID = IntForeignKeyField.create(
     ...
     */
    IntForeignKeyField<AccountsSkills, Integer, SkilltreeLevels> SKILLTREE_LEVELS_ID = IntForeignKeyField.create(
     ...
     * @return                  this AccountsSkills instance
     */
    AccountsSkills setSkilltreeSkillsId(int skilltreeSkillsId);
     ...
     * @return                  this AccountsSkills instance
     */
    AccountsSkills setSkilltreeLevelsId(int skilltreeLevelsId);
