...
public interface GeneratedAccountsDestroys {
     ...
     */
    IntField<AccountsDestroys, Integer> SHIPS_ID = IntField.create(
        Identifier.SHIPS_ID,
     ...
     */
    IntField<AccountsDestroys, Integer> POINTS = IntField.create(
        Identifier.POINTS,
     ...
     */
    IntField<AccountsDestroys, Integer> AMOUNT = IntField.create(
        Identifier.AMOUNT,
     ...
     * @return        this AccountsDestroys instance
     */
    AccountsDestroys setShipsId(int shipsId);
     ...
     * @return       this AccountsDestroys instance
     */
    AccountsDestroys setPoints(int points);
     ...
     * @return       this AccountsDestroys instance
     */
    AccountsDestroys setAmount(int amount);
