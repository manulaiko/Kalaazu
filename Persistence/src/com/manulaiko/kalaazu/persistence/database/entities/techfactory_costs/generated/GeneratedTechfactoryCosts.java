...
public interface GeneratedTechfactoryCosts {
     ...
     */
    IntField<TechfactoryCosts, Integer> ID = IntField.create(
        Identifier.ID,
     ...
     * method.
     */
    IntForeignKeyField<TechfactoryCosts, Integer, TechfactoryItems> TECHFACTORY_ITEMS_ID = IntForeignKeyField.create(
     ...
     */
    IntForeignKeyField<TechfactoryCosts, Integer, Items> ITEMS_ID = IntForeignKeyField.create(
        Identifier.ITEMS_ID,
     ...
     * @return                   this TechfactoryCosts instance
     */
    TechfactoryCosts setTechfactoryItemsId(int techfactoryItemsId);
     ...
     * @return        this TechfactoryCosts instance
     */
    TechfactoryCosts setItemsId(int itemsId);
