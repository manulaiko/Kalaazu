...
public abstract class GeneratedAccountsBanksImpl implements AccountsBanks {
    ...
    @Override
    public AccountsBanks setTaxCredits(BigDecimal taxCredits) {
        this.taxCredits = taxCredits;
        return this;
    }
    
    @Override
    public AccountsBanks setTaxUridium(BigDecimal taxUridium) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsBanks)) { return false; }
        final AccountsBanks thatAccountsBanks = (AccountsBanks)that;
        if (this.getId() != thatAccountsBanks.getId()) {return false; }
        if (this.getAccountsId() != thatAccountsBanks.getAccountsId()) {return false; }
        if (this.getCredits() != thatAccountsBanks.getCredits()) {return false; }
        if (this.getUridium() != thatAccountsBanks.getUridium()) {return false; }
        if (!Objects.equals(this.getTaxCredits(), thatAccountsBanks.getTaxCredits())) {return false; }
        if (!Objects.equals(this.getTaxUridium(), thatAccountsBanks.getTaxUridium())) {return false; }
        return true;
    }
