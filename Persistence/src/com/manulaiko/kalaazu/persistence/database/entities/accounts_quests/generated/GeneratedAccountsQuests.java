...
public interface GeneratedAccountsQuests {
     ...
     */
    IntForeignKeyField<AccountsQuests, Integer, Quests> QUESTS_ID = IntForeignKeyField.create(
    ...
    /**
     * This Field corresponds to the {@link AccountsQuests} field that can be
     * obtained using the {@link AccountsQuests#getCompleted()} method.
     */
    BooleanField<AccountsQuests, Boolean> COMPLETED = BooleanField.create(
        Identifier.COMPLETED,
        AccountsQuests::getCompleted,
        AccountsQuests::setCompleted,
        TypeMapper.primitive(),
        false
    );
    /**
    ...
    /**
     * Returns the completed of this AccountsQuests. The completed field
     * corresponds to the database column
     * kalaazu.kalaazu.accounts_quests.completed.
     * 
     * @return the completed of this AccountsQuests
     */
     ...
     * @return         this AccountsQuests instance
     */
    AccountsQuests setQuestsId(int questsId);
    ...
    /**
     * Sets the completed of this AccountsQuests. The completed field
     * corresponds to the database column
     * kalaazu.kalaazu.accounts_quests.completed.
     * 
     * @param completed to set of this AccountsQuests
     * @return          this AccountsQuests instance
     */
    AccountsQuests setCompleted(boolean completed);
