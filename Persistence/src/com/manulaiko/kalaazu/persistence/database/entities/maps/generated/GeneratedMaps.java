 ...
 * com.manulaiko.kalaazu.persistence.database.entities.maps.Maps}-interface representing
 * entities of the {@code maps}-table in the database.
 * <p>
...
public interface GeneratedMaps {
     ...
     */
    IntField<Maps, Integer> ID = IntField.create(
        Identifier.ID,
        Maps::getId,
        Maps::setId,
     ...
     */
    ComparableForeignKeyField<Maps, Integer, Integer, Factions> FACTIONS_ID = ComparableForeignKeyField.create(
     ...
     */
    BooleanField<Maps, Boolean> IS_PVP = BooleanField.create(
        Identifier.IS_PVP,
        Maps::getIsPvp,
        Maps::setIsPvp,
        TypeMapper.primitive(),
     ...
     */
    BooleanField<Maps, Boolean> IS_STARTER = BooleanField.create(
     ...
     */
    StringField<Maps, String> LIMITS = StringField.create(
        Identifier.LIMITS,
        Maps::getLimits,
        Maps::setLimits,
        TypeMapper.identity(),
     ...
     * @return           this Maps instance
     */
    Maps setFactionsId(Integer factionsId);
