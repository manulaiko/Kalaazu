...
public interface GeneratedAccountsShips {
     ...
     */
    IntForeignKeyField<AccountsShips, Integer, Ships> SHIPS_ID = IntForeignKeyField.create(
        Identifier.SHIPS_ID,
     ...
     */
    IntForeignKeyField<AccountsShips, Integer, Maps> MAPS_ID = IntForeignKeyField.create(
        Identifier.MAPS_ID,
     ...
     */
    StringField<AccountsShips, String> POSITION = StringField.create(
        Identifier.POSITION,
    ...
    /**
     * This Field corresponds to the {@link AccountsShips} field that can be
     * obtained using the {@link AccountsShips#getShield()} method.
     */
    IntField<AccountsShips, Integer> SHIELD = IntField.create(
        Identifier.SHIELD,
        AccountsShips::getShield,
        AccountsShips::setShield,
        TypeMapper.primitive(),
        false
    );
    /**
     ...
     */
    IntField<AccountsShips, Integer> GFX = IntField.create(
        Identifier.GFX,
    ...
    /**
     * Returns the shield of this AccountsShips. The shield field corresponds to
     * the database column kalaazu.kalaazu.accounts_ships.shield.
     * 
     * @return the shield of this AccountsShips
     */
    int getShield();
     ...
     * @return        this AccountsShips instance
     */
    AccountsShips setShipsId(int shipsId);
     ...
     * @return       this AccountsShips instance
     */
    AccountsShips setMapsId(int mapsId);
     ...
     * @return         this AccountsShips instance
     */
    AccountsShips setPosition(String position);
    ...
    /**
     * Sets the shield of this AccountsShips. The shield field corresponds to
     * the database column kalaazu.kalaazu.accounts_ships.shield.
     * 
     * @param shield to set of this AccountsShips
     * @return       this AccountsShips instance
     */
    AccountsShips setShield(int shield);
