...
public abstract class GeneratedLevelsUpgradesImpl implements LevelsUpgrades {
    ...
    @Override
    public LevelsUpgrades setLevelsId(int levelsId) {
    ...
    @Override
    public LevelsUpgrades setUridium(int uridium) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof LevelsUpgrades)) { return false; }
        final LevelsUpgrades thatLevelsUpgrades = (LevelsUpgrades)that;
        if (this.getId() != thatLevelsUpgrades.getId()) {return false; }
        if (this.getLevelsId() != thatLevelsUpgrades.getLevelsId()) {return false; }
        if (this.getProbability() != thatLevelsUpgrades.getProbability()) {return false; }
        if (this.getCredits() != thatLevelsUpgrades.getCredits()) {return false; }
        if (this.getUridium() != thatLevelsUpgrades.getUridium()) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getUridium());
        return hash;
    }
}