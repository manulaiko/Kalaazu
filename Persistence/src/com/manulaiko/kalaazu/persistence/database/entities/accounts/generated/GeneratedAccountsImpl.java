...
public abstract class GeneratedAccountsImpl implements Accounts {
    ...
    @Override
    public Accounts setUsersId(Integer usersId) {
    ...
    @Override
    public Accounts setLevelsId(int levelsId) {
        this.levelsId = levelsId;
        return this;
    }
    
    @Override
    public Accounts setFactionsId(Integer factionsId) {
    ...
    @Override
    public Accounts setRanksId(int ranksId) {
    ...
    @Override
    public Accounts setSkillPointsTotal(int skillPointsTotal) {
        this.skillPointsTotal = skillPointsTotal;
        return this;
    }
    
    @Override
    public Accounts setSkillPointsFree(int skillPointsFree) {
    ...
    public Users findUsersId(Manager<Users> foreignManager) {
        return foreignManager.stream().filter(Users.ID.equal(getUsersId())).findAny().orElse(null);
    }
    ...
    public Optional<AccountsHangars> findAccountsHangarsId(Manager<AccountsHangars> foreignManager) {
        if (getAccountsHangarsId().isPresent()) {
            return foreignManager.stream().filter(AccountsHangars.ID.equal(getAccountsHangarsId().getAsInt())).findAny();
        } else {
            return Optional.empty();
        }
    }
    ...
    public Optional<Clans> findClansId(Manager<Clans> foreignManager) {
        if (getClansId().isPresent()) {
            return foreignManager.stream().filter(Clans.ID.equal(getClansId().getAsInt())).findAny();
        } else {
            return Optional.empty();
        }
    }
    ...
    public Ranks findRanksId(Manager<Ranks> foreignManager) {
        return foreignManager.stream().filter(Ranks.ID.equal(getRanksId())).findAny().orElse(null);
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof Accounts)) { return false; }
        final Accounts thatAccounts = (Accounts)that;
        if (this.getId() != thatAccounts.getId()) {return false; }
        if (!Objects.equals(this.getUsersId(), thatAccounts.getUsersId())) {return false; }
        if (!Objects.equals(this.getSessionId(), thatAccounts.getSessionId())) {return false; }
        if (this.getLevelsId() != thatAccounts.getLevelsId()) {return false; }
        if (!Objects.equals(this.getFactionsId(), thatAccounts.getFactionsId())) {return false; }
        if (!Objects.equals(this.getAccountsHangarsId(), thatAccounts.getAccountsHangarsId())) {return false; }
        if (!Objects.equals(this.getClansId(), thatAccounts.getClansId())) {return false; }
        if (this.getRanksId() != thatAccounts.getRanksId()) {return false; }
        if (!Objects.equals(this.getName(), thatAccounts.getName())) {return false; }
        if (!Objects.equals(this.getBanDate(), thatAccounts.getBanDate())) {return false; }
        if (!Objects.equals(this.getPremiumDate(), thatAccounts.getPremiumDate())) {return false; }
        if (!Objects.equals(this.getDate(), thatAccounts.getDate())) {return false; }
        if (!Objects.equals(this.getLastLogin(), thatAccounts.getLastLogin())) {return false; }
        if (this.getSkillPointsTotal() != thatAccounts.getSkillPointsTotal()) {return false; }
        if (this.getSkillPointsFree() != thatAccounts.getSkillPointsFree()) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(getUsersId());
        ...
        hash = 31 * hash + Integer.hashCode(getRanksId());
        ...
        hash = 31 * hash + Integer.hashCode(getSkillPointsTotal());
        hash = 31 * hash + Integer.hashCode(getSkillPointsFree());
        return hash;
    }
}