...
public abstract class GeneratedModeratorsLogsImpl implements ModeratorsLogs {
    ...
    @Override
    public ModeratorsLogs setModeratorsId(int moderatorsId) {
    ...
    public Moderators findModeratorsId(Manager<Moderators> foreignManager) {
        return foreignManager.stream().filter(Moderators.ID.equal(getModeratorsId())).findAny().orElse(null);
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof ModeratorsLogs)) { return false; }
        final ModeratorsLogs thatModeratorsLogs = (ModeratorsLogs)that;
        if (this.getId() != thatModeratorsLogs.getId()) {return false; }
        if (this.getModeratorsId() != thatModeratorsLogs.getModeratorsId()) {return false; }
        if (!Objects.equals(this.getDate(), thatModeratorsLogs.getDate())) {return false; }
        if (!Objects.equals(this.getType(), thatModeratorsLogs.getType())) {return false; }
        if (!Objects.equals(this.getText(), thatModeratorsLogs.getText())) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getModeratorsId());
