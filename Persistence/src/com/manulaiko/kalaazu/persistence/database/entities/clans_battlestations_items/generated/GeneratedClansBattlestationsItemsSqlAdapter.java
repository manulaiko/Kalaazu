...
import com.manulaiko.kalaazu.persistence.database.entities.clans_battlestations_items.ClansBattlestationsItemsImpl;
...
public abstract class GeneratedClansBattlestationsItemsSqlAdapter {
    ...
    protected ClansBattlestationsItems apply(ResultSet resultSet) throws SpeedmentException {
        ...
        try {
            ...
            entity.setClansBattlestationsId( resultSet.getInt(2)       );
            entity.setAccountsItemsId(       resultSet.getInt(3)       );
            entity.setSlot(                  resultSet.getInt(4)       );
