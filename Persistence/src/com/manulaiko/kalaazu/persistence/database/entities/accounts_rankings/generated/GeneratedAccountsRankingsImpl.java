...
public abstract class GeneratedAccountsRankingsImpl implements AccountsRankings {
    ...
    @Override
    public AccountsRankings setDestroyedAllies(int destroyedAllies) {
        this.destroyedAllies = destroyedAllies;
        return this;
    }
    
    @Override
    public AccountsRankings setDestroyedPhoenix(int destroyedPhoenix) {
        this.destroyedPhoenix = destroyedPhoenix;
        return this;
    }
    
    @Override
    public AccountsRankings setDestroyedTimes(int destroyedTimes) {
        this.destroyedTimes = destroyedTimes;
        return this;
    }
    
    @Override
    public AccountsRankings setDestroyedRadiation(int destroyedRadiation) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsRankings)) { return false; }
        final AccountsRankings thatAccountsRankings = (AccountsRankings)that;
        if (this.getId() != thatAccountsRankings.getId()) {return false; }
        if (this.getAccountsId() != thatAccountsRankings.getAccountsId()) {return false; }
        if (this.getPoints() != thatAccountsRankings.getPoints()) {return false; }
        if (this.getBestPoints() != thatAccountsRankings.getBestPoints()) {return false; }
        if (this.getDestroyedAllies() != thatAccountsRankings.getDestroyedAllies()) {return false; }
        if (this.getDestroyedPhoenix() != thatAccountsRankings.getDestroyedPhoenix()) {return false; }
        if (this.getDestroyedTimes() != thatAccountsRankings.getDestroyedTimes()) {return false; }
        if (this.getDestroyedRadiation() != thatAccountsRankings.getDestroyedRadiation()) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getDestroyedAllies());
        hash = 31 * hash + Integer.hashCode(getDestroyedPhoenix());
        hash = 31 * hash + Integer.hashCode(getDestroyedTimes());
        hash = 31 * hash + Integer.hashCode(getDestroyedRadiation());
        return hash;
    }
}