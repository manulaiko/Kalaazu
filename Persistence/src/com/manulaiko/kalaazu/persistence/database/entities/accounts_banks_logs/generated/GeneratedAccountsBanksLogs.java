...
public interface GeneratedAccountsBanksLogs {
     ...
     */
    IntField<AccountsBanksLogs, Integer> TYPE = IntField.create(
        Identifier.TYPE,
     ...
     */
    IntField<AccountsBanksLogs, Integer> CURRENCY = IntField.create(
        Identifier.CURRENCY,
     ...
     * @return     this AccountsBanksLogs instance
     */
    AccountsBanksLogs setType(int type);
     ...
     * @return         this AccountsBanksLogs instance
     */
    AccountsBanksLogs setCurrency(int currency);
