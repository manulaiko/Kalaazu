...
public abstract class GeneratedAccountsTechfactoryItemsImpl implements AccountsTechfactoryItems {
    ...
    @Override
    public AccountsTechfactoryItems setTechfactoryItemsId(int techfactoryItemsId) {
        this.techfactoryItemsId = techfactoryItemsId;
        return this;
    }
    
    @Override
    public AccountsTechfactoryItems setAmount(int amount) {
        this.amount = amount;
        return this;
    }
    ...
    public TechfactoryItems findTechfactoryItemsId(Manager<TechfactoryItems> foreignManager) {
        return foreignManager.stream().filter(TechfactoryItems.ID.equal(getTechfactoryItemsId())).findAny().orElse(null);
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsTechfactoryItems)) { return false; }
        final AccountsTechfactoryItems thatAccountsTechfactoryItems = (AccountsTechfactoryItems)that;
        if (this.getId() != thatAccountsTechfactoryItems.getId()) {return false; }
        if (this.getAccountsId() != thatAccountsTechfactoryItems.getAccountsId()) {return false; }
        if (this.getTechfactoryItemsId() != thatAccountsTechfactoryItems.getTechfactoryItemsId()) {return false; }
        if (this.getAmount() != thatAccountsTechfactoryItems.getAmount()) {return false; }
        if (!Objects.equals(this.getDate(), thatAccountsTechfactoryItems.getDate())) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getTechfactoryItemsId());
