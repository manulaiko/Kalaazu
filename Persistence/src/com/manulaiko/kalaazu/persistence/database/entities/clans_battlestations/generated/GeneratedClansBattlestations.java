...
public interface GeneratedClansBattlestations {
     ...
     */
    IntField<ClansBattlestations, Integer> ID = IntField.create(
        Identifier.ID,
     ...
     */
    IntForeignKeyField<ClansBattlestations, Integer, Maps> MAPS_ID = IntForeignKeyField.create(
        Identifier.MAPS_ID,
     ...
     */
    StringField<ClansBattlestations, String> POSITION = StringField.create(
        Identifier.POSITION,
     ...
     */
    ClansBattlestations setId(int id);
     ...
     * @return       this ClansBattlestations instance
     */
    ClansBattlestations setMapsId(int mapsId);
     ...
     * @return         this ClansBattlestations instance
     */
    ClansBattlestations setPosition(String position);
