...
public interface GeneratedRewardsVouchers {
     ...
     */
    IntField<RewardsVouchers, Integer> ID = IntField.create(
        Identifier.ID,
     ...
     */
    IntForeignKeyField<RewardsVouchers, Integer, Vouchers> VOUCHERS_ID = IntForeignKeyField.create(
     ...
     */
    IntForeignKeyField<RewardsVouchers, Integer, Rewards> REWARDS_ID = IntForeignKeyField.create(
     ...
     * @return           this RewardsVouchers instance
     */
    RewardsVouchers setVouchersId(int vouchersId);
     ...
     * @return          this RewardsVouchers instance
     */
    RewardsVouchers setRewardsId(int rewardsId);
