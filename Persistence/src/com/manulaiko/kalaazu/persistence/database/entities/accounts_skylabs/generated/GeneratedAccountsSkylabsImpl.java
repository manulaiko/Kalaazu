...
public abstract class GeneratedAccountsSkylabsImpl implements AccountsSkylabs {
    ...
    @Override
    public AccountsSkylabs setSkylabModulesId(int skylabModulesId) {
        this.skylabModulesId = skylabModulesId;
        return this;
    }
    
    @Override
    public AccountsSkylabs setLevelsId(int levelsId) {
    ...
    public SkylabModules findSkylabModulesId(Manager<SkylabModules> foreignManager) {
        return foreignManager.stream().filter(SkylabModules.ID.equal(getSkylabModulesId())).findAny().orElse(null);
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof AccountsSkylabs)) { return false; }
        final AccountsSkylabs thatAccountsSkylabs = (AccountsSkylabs)that;
        if (this.getId() != thatAccountsSkylabs.getId()) {return false; }
        if (this.getAccountsId() != thatAccountsSkylabs.getAccountsId()) {return false; }
        if (this.getSkylabModulesId() != thatAccountsSkylabs.getSkylabModulesId()) {return false; }
        if (this.getLevelsId() != thatAccountsSkylabs.getLevelsId()) {return false; }
        if (this.getSpace() != thatAccountsSkylabs.getSpace()) {return false; }
        if (!Objects.equals(this.getUpgrade(), thatAccountsSkylabs.getUpgrade())) {return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getSkylabModulesId());
