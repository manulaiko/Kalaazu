...
public abstract class GeneratedGalaxygatesStagesImpl implements GalaxygatesStages {
    ...
    @Override
    public GalaxygatesStages setGalaxygatesWavesId(int galaxygatesWavesId) {
    ...
    public boolean equals(Object that) {
        ...
        if (!(that instanceof GalaxygatesStages)) { return false; }
        final GalaxygatesStages thatGalaxygatesStages = (GalaxygatesStages)that;
        if (this.getId() != thatGalaxygatesStages.getId()) {return false; }
        if (this.getGalaxygatesWavesId() != thatGalaxygatesStages.getGalaxygatesWavesId()) {return false; }
        if (!Objects.equals(this.getComment(), thatGalaxygatesStages.getComment())) {return false; }
        return true;
    }
